object BKMFrm: TBKMFrm
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          'NO_REFF'#9'20'#9'NO_REFF/ KUITANSI'#9'F'
  ...
  object QNota: TOracleDataSet
    SQL.Strings = (
      'select * from pmtx02.vpiutang_sisa a'
      
        'where kd_perk_bayar=:kd_perk_bayar and a.kd_rekanan like :kd_rek' +
        'anan'
      'and sisa>0')
    Variables.Data = {
      03000000020000000B0000003A4B445F52454B414E414E050000000800000025
      31303033373900000000000E0000003A4B445F5045524B5F4241594152050000
      0008000000313130313230310000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QAwal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum((debet-kredit)*kurs) as saldo from pmtx99.jurnal_deta' +
        'il'
      'where kd_perk=:kd_perk and tanggal<:tanggal')
    Variables.Data = {
      0300000002000000080000003A4B445F5045524B050000000000000000000000
      080000003A54414E4747414C0C0000000000000000000000}
