unit BonPemakaianBengkeldanAlat;
...
type
  TBonPemakaianBengkeldanAlatFrm = class(TForm)
    Panel1: TPanel;
    ...
    QDetailQTY_PALET: TFloatField;
    QDetailQTY_KG_BOX: TFloatField;
    QDetailQTY_KG_KARUNG: TFloatField;
...
var
  BonPemakaianBengkeldanAlatFrm: TBonPemakaianBengkeldanAlatFrm;
...
procedure TBonPemakaianBengkeldanAlatFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  BonPemakaianBengkeldanAlatFrm:=Nil;
end;

procedure TBonPemakaianBengkeldanAlatFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TBonPemakaianBengkeldanAlatFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBonPemakaianBengkeldanAlatFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TBonPemakaianBengkeldanAlatFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TBonPemakaianBengkeldanAlatFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TBonPemakaianBengkeldanAlatFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPemakaianBengkeldanAlatFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TBonPemakaianBengkeldanAlatFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TBonPemakaianBengkeldanAlatFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TBonPemakaianBengkeldanAlatFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TBonPemakaianBengkeldanAlatFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TBonPemakaianBengkeldanAlatFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TBonPemakaianBengkeldanAlatFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TBonPemakaianBengkeldanAlatFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TBonPemakaianBengkeldanAlatFrm.ECariChange(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBonPemakaianBengkeldanAlatFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TBonPemakaianBengkeldanAlatFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBonPemakaianBengkeldanAlatFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TBonPemakaianBengkeldanAlatFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TBonPemakaianBengkeldanAlatFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBonPemakaianBengkeldanAlatFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TBonPemakaianBengkeldanAlatFrm.FormCloseQuery(Sender: TObject;
...
procedure TBonPemakaianBengkeldanAlatFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPemakaianBengkeldanAlatFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TBonPemakaianBengkeldanAlatFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TBonPemakaianBengkeldanAlatFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBonPemakaianBengkeldanAlatFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TBonPemakaianBengkeldanAlatFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TBonPemakaianBengkeldanAlatFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TBonPemakaianBengkeldanAlatFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TBonPemakaianBengkeldanAlatFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TBonPemakaianBengkeldanAlatFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TBonPemakaianBengkeldanAlatFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TBonPemakaianBengkeldanAlatFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TBonPemakaianBengkeldanAlatFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPemakaianBengkeldanAlatFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPemakaianBengkeldanAlatFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.LookMesinCloseUp(Sender: TObject;
...
begin
  ...
  begin
      ...
      begin
        ...
        QDetailNO_POLISI.AsString:='';
      end
        else
          if QLookMesinJENIS.AsString='KENDARAAN' then
          begin
            QDetailNO_POLISI.AsString:=QLookMesinKODE.AsString;
            QDetailKD_MESIN.AsString:='';
...
procedure TBonPemakaianBengkeldanAlatFrm.LookMesinEnter(Sender: TObject);
begin
  QLookMesin.Open;
end;

procedure TBonPemakaianBengkeldanAlatFrm.LookMesinUserButton1Click(
...
procedure TBonPemakaianBengkeldanAlatFrm.vTglAWAL2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TBonPemakaianBengkeldanAlatFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.vOperand2Click(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.cbTanggal2Click(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.BitBtn6Click(Sender: TObject);
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.LookBudgetEnter(Sender: TObject);
var
  vlok : string;
  vidb2: string;
begin
...
procedure TBonPemakaianBengkeldanAlatFrm.LookBudgetCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
{MAA}
...
procedure TBonPemakaianBengkeldanAlatFrm.QDetailCalcFields(
  DataSet: TDataSet);
begin
//  QDetailQTY.AsFloat:=(QDetailQTY_KG_BOX.AsFloat+QDetailQTY_KG_KARUNG.AsFloat)+QDetailQTY_KG_PALET.AsFloat;
end;

procedure TBonPemakaianBengkeldanAlatFrm.wwDBGrid2KeyPress(Sender: TObject;
  var Key: Char);
begin
  QDetailQTY.AsFloat:=(QDetailQTY_KG_BOX.AsFloat+QDetailQTY_KG_KARUNG.AsFloat)+QDetailQTY_KG_PALET.AsFloat;
end;
