...
type
  TFormulasiKemasanFrm = class(TForm)
    Panel1: TPanel;
    ...
    QTransaksiKD_KEMASAN: TStringField;
    QTransaksiKD_MERK: TStringField;
    QTransaksiMERK: TStringField;
    QTransaksiKEMASAN: TStringField;
    LookKemasan: TwwDBLookupComboDlg;
    Label1: TLabel;
    DBText7: TDBText;
    wwDBEdit1: TwwDBEdit;
    wwDBEdit2: TwwDBEdit;
    ...
    procedure LookMerkEnter(Sender: TObject);
    procedure LookMerkUserButton1Click(Sender: TObject;
      LookupTable: TDataSet);
    procedure LookKemasanEnter(Sender: TObject);
    procedure LookKemasanUserButton1Click(Sender: TObject;
      LookupTable: TDataSet);
...
var
  FormulasiKemasanFrm: TFormulasiKemasanFrm;
...
procedure TFormulasiKemasanFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  FormulasiKemasanFrm:=Nil;
end;

procedure TFormulasiKemasanFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TFormulasiKemasanFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TFormulasiKemasanFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TFormulasiKemasanFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TFormulasiKemasanFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TFormulasiKemasanFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TFormulasiKemasanFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TFormulasiKemasanFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
...
procedure TFormulasiKemasanFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TFormulasiKemasanFrm.TabSheet2Show(Sender: TObject);
begin
  QLookItem.Open;
...
procedure TFormulasiKemasanFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailOPR_INSERT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TFormulasiKemasanFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TFormulasiKemasanFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TFormulasiKemasanFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TFormulasiKemasanFrm.DBText2Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiID_FORMULASI.AsString);
end;

procedure TFormulasiKemasanFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TFormulasiKemasanFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TFormulasiKemasanFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TFormulasiKemasanFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TFormulasiKemasanFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TFormulasiKemasanFrm.ECariChange(Sender: TObject);
begin
...
procedure TFormulasiKemasanFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TFormulasiKemasanFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TFormulasiKemasanFrm.FormShow(Sender: TObject);
begin
  Height:=600;
  Width:=766;
...
procedure TFormulasiKemasanFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
//  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TFormulasiKemasanFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TFormulasiKemasanFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TFormulasiKemasanFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TFormulasiKemasanFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TFormulasiKemasanFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TFormulasiKemasanFrm.FormCloseQuery(Sender: TObject;
...
procedure TFormulasiKemasanFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TFormulasiKemasanFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TFormulasiKemasanFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TFormulasiKemasanFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TFormulasiKemasanFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TFormulasiKemasanFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=36;
  1 : vRecord.Value:=18;
...
procedure TFormulasiKemasanFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TFormulasiKemasanFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TFormulasiKemasanFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TFormulasiKemasanFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TFormulasiKemasanFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TFormulasiKemasanFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TFormulasiKemasanFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TFormulasiKemasanFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TFormulasiKemasanFrm.LookMerkEnter(Sender: TObject);
begin
  DMFrm.QMerk.Open;
end;

procedure TFormulasiKemasanFrm.LookMerkUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.QMerk.Close;
  DMFrm.QMerk.Open;
...
procedure TFormulasiKemasanFrm.LookKemasanEnter(Sender: TObject);
begin
  DMFrm.QKemasan.Open;
end;

procedure TFormulasiKemasanFrm.LookKemasanUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.QKemasan.Close;
  DMFrm.QKemasan.Open;
end;

procedure TFormulasiKemasanFrm.BitBtn2Click(Sender: TObject);
var
  vkd_merk, vkd_kemasan, vketerangan : String;
begin
  vkd_merk:=QTransaksiKD_MERK.AsString;
  vkd_kemasan:=QTransaksiKD_KEMASAN.AsString;
  ...
  try
      QTransaksi.Insert;
      QTransaksiKD_MERK.AsString:=vkd_merk;
      QTransaksiKD_KEMASAN.AsString:=vkd_kemasan;
