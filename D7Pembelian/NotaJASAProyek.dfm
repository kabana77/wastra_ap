object NotaJasaProyekFrm: TNotaJasaProyekFrm
  Left = 267
  Top = 86
  Width = 1028
  Height = 594
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KETERANGAN'#9'37'#9'DISKRIPSI ITEM JASA'#9'T'#9'DATA ORDER'
          'TGL_START'#9'12'#9'MULAI'#9'T'#9'DATA ORDER'
          'HARGA'#9'13'#9'HARGA'#9'T'#9'DATA ORDER'
          'QTY'#9'7'#9'JUMLAH'#9'T'#9'DATA ORDER'
          'TX'#9'10'#9'TAGIHAN'#9'F'
      ...
      object PanelTunggu8: TPanel
        ...
        object wwDBGrid5: TwwDBGrid
          ...
          ControlType.Strings = (
            'STATUS;CheckBox;1;0')
          Selected.Strings = (
            'NO_LPB'#9'15'#9'NO LPB /~BA JASA'#9'F'#9
            'NO_PO'#9'15'#9'NOMOR PO'#9'F'#9
            'TANGGAL'#9'11'#9'TANGGAL TERIMA~INVOICE'#9'F'#9
            'NAMA'#9'50'#9'NAMA SUPLIER'#9'F'#9
  ...
  object QTransaksi: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000260000000700000054414E4747414C010000000000070000004E4F5F
    ...
    object QTransaksiTERMIN: TStringField
      FieldName = 'TERMIN'
      Size = 1
    end
  ...
  object QDetail: TOracleDataSet
    ...
    Variables.Data = {
      ...
      000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000021000000070000004B445F4954454D01000000000005000000484152
      ...
      33010000000000020000005434010000000000020000005458010000000000}
    Master = QTransaksi
    ...
    object QDetailT1: TFloatField
      FieldName = 'T1'
    end
    object QDetailT2: TFloatField
      FieldName = 'T2'
    end
    object QDetailT3: TFloatField
      FieldName = 'T3'
    end
    object QDetailT4: TFloatField
      FieldName = 'T4'
    end
    object QDetailTX: TFloatField
      FieldName = 'TX'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
  end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      ...
      'from pmtx02.vhutang_jasa where kd_transaksi = '#39'506'#39')'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object QTotalBrowse: TOracleDataSet
    SQL.Strings = (
      'SELECT * FROM '
        ...
        'as sisa from pmtx02.vhutang_jasa WHERE kd_transaksi = '#39'506'#39')'
      ':myparam')
    Variables.Data = {
  ...
  object QCekINV: TOracleDataSet
    SQL.Strings = (
        ...
        'voice, no_faktur, tgl_insert from'
      
        '(select * from pmtx02.vjth_tmp_invoice_JASA where no_lpb=:no_not' +
        'a order by tanggal desc)')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F544105000000100000003330362D
      313730312D3050303030310000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000070000000700000054414E4747414C010000000000050000004E4F5F
  ...
  object QCari_NO_PO: TOracleDataSet
    ...
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F5441050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000002000000060000004E4F5F4C5042010000000000050000004E4F5F50
      4F010000000000}
    Cursor = crSQLWait
    QueryAllRecords = False
    CountAllRecords = True
