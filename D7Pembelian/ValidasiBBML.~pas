...
type
  TValidasiBBMLFrm = class(TForm)
    ...
    procedure LookItem2UserButton1Click(Sender: TObject;
      LookupTable: TDataSet);
    procedure LookItem2UserButton2Click(Sender: TObject;
      LookupTable: TDataSet);
...
var
  ValidasiBBMLFrm: TValidasiBBMLFrm;
...
procedure TValidasiBBMLFrm.FormClose(Sender: TObject;
...
procedure TValidasiBBMLFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TValidasiBBMLFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TValidasiBBMLFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TValidasiBBMLFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TValidasiBBMLFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TValidasiBBMLFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TValidasiBBMLFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
...
procedure TValidasiBBMLFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TValidasiBBMLFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TValidasiBBMLFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TValidasiBBMLFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TValidasiBBMLFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiBBMLFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TValidasiBBMLFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TValidasiBBMLFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TValidasiBBMLFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TValidasiBBMLFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TValidasiBBMLFrm.ECariChange(Sender: TObject);
begin
...
procedure TValidasiBBMLFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TValidasiBBMLFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TValidasiBBMLFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TValidasiBBMLFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TValidasiBBMLFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TValidasiBBMLFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TValidasiBBMLFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TValidasiBBMLFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TValidasiBBMLFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
     QRLTitle2.Caption:=UpperCase('Surat Jalan Retur');
  end
    else
     QRLTitle2.Caption:='DRAFT';
end;

procedure TValidasiBBMLFrm.FormCloseQuery(Sender: TObject;
...
procedure TValidasiBBMLFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiBBMLFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TValidasiBBMLFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TValidasiBBMLFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TValidasiBBMLFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TValidasiBBMLFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TValidasiBBMLFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TValidasiBBMLFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TValidasiBBMLFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TValidasiBBMLFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TValidasiBBMLFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TValidasiBBMLFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TValidasiBBMLFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TValidasiBBMLFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TValidasiBBMLFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TValidasiBBMLFrm.QLookLokasiBeforeOpen(DataSet: TDataSet);
begin
  QLookLokasi.SetVariable('kd_jns_item',QDetailKD_JNS_ITEM.AsString);
end;

procedure TValidasiBBMLFrm.LookLokasiCloseUp(Sender: TObject;
...
procedure TValidasiBBMLFrm.LookLokasiEnter(Sender: TObject);
begin
  QLookLokasi.Close;
  QLookLokasi.Open;
end;

procedure TValidasiBBMLFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TValidasiBBMLFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TValidasiBBMLFrm.LookMesinCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TValidasiBBMLFrm.LookMesinEnter(Sender: TObject);
begin
  QLookMesin.Open;
end;

procedure TValidasiBBMLFrm.LookMesinUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookMesin.Close;
  QLookMesin.Open;
...
procedure TValidasiBBMLFrm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TValidasiBBMLFrm.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TValidasiBBMLFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TValidasiBBMLFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
  DetailBand2.ForceNewPage:=(vrecord_ke>Round(vRecord.Value)-1);
...
procedure TValidasiBBMLFrm.LookItem2Enter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TValidasiBBMLFrm.LookItem2UserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TValidasiBBMLFrm.LookItem2UserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  if LookItem2.UserButton2Caption='Urut Kode' then
  begin
    LookItem2.UserButton2Caption:='Urut Nama';
    QLookItem.Close;
    ...
    begin
      LookItem2.UserButton2Caption:='Urut Kode';
      QLookItem.Close;
...
procedure TValidasiBBMLFrm.LookItem2CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TValidasiBBMLFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TValidasiBBMLFrm.LookMaklonEnter(Sender: TObject);
begin
  QLookMaklonRekanan.Close;
  QLookMaklonRekanan.OPEN;
end;

procedure TValidasiBBMLFrm.LookMaklonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
   QTransaksiKD_REKANAN.AsString:=QLookMaklonRekananKD_REKANAN.AsString;
   QTransaksiREKANAN.AsString:=QLookMaklonRekananNAMA_REKANAN.AsString;
end;

procedure TValidasiBBMLFrm.QDetailBeforePost(DataSet: TDataSet);
begin
  if QDetailQTY_STOK.AsFloat<QDetailQTY.AsFloat then
  begin
    ShowMessage('Jumlah yang diambil tidak boleh melebihi stok !');
    Abort;
  end;
end;

procedure TValidasiBBMLFrm.BitBtn3Click(Sender: TObject);
begin
  DMFrm.QDateTime.Close;
  DMFrm.QDateTime.Open;
  case PageControl1.ActivePageIndex of
