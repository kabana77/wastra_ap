...
var
  PAffalMasukFrm: TPAffalMasukFrm;
...
procedure TPAffalMasukFrm.FormClose(Sender: TObject;
...
procedure TPAffalMasukFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TPAffalMasukFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPAffalMasukFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TPAffalMasukFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TPAffalMasukFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TPAffalMasukFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TPAffalMasukFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TPAffalMasukFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TPAffalMasukFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPAffalMasukFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TPAffalMasukFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TPAffalMasukFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TPAffalMasukFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TPAffalMasukFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TPAffalMasukFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TPAffalMasukFrm.QLookItemBeforeOpen(DataSet: TDataSet);
{var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;}
begin
...
procedure TPAffalMasukFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TPAffalMasukFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPAffalMasukFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TPAffalMasukFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TPAffalMasukFrm.ECariChange(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TPAffalMasukFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TPAffalMasukFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TPAffalMasukFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TPAffalMasukFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TPAffalMasukFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TPAffalMasukFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TPAffalMasukFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TPAffalMasukFrm.FormCloseQuery(Sender: TObject;
...
procedure TPAffalMasukFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TPAffalMasukFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TPAffalMasukFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TPAffalMasukFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TPAffalMasukFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TPAffalMasukFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TPAffalMasukFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TPAffalMasukFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TPAffalMasukFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TPAffalMasukFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TPAffalMasukFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TPAffalMasukFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TPAffalMasukFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TPAffalMasukFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TPAffalMasukFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TPAffalMasukFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TPAffalMasukFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TPAffalMasukFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailQTY_STOK2.AsFloat:=QDetailQTY_STOK.AsFloat/cball2kg;
  QDetailQTY_BON2.AsFloat:=QDetailQTY_BON.AsFloat/cball2kg;
end;

procedure TPAffalMasukFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TPAffalMasukFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseQTY2.AsFloat:=QBrowseQTY.AsFloat/cball2kg;
  QBrowseQTY_VALIDASI2.AsFloat:=QBrowseQTY_VALIDASI.AsFloat/cball2kg;
end;

procedure TPAffalMasukFrm.QTotalBeforeOpen(DataSet: TDataSet);
begin
  QTotal.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TPAffalMasukFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TPAffalMasukFrm.vTglAWAL2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TPAffalMasukFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.vOperand2Click(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.cbTanggal2Click(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.BitBtn6Click(Sender: TObject);
begin
...
procedure TPAffalMasukFrm.LookBudgetEnter(Sender: TObject);
var
  vlok : string;
  vidb2: string;
begin
...
procedure TPAffalMasukFrm.LookBudgetCloseUp(Sender: TObject;
...
procedure TPAffalMasukFrm.wwDBGrid4CalcCellColors(Sender: TObject;
  Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
  ABrush: TBrush);
begin
  if not Highlight then
...
procedure TPAffalMasukFrm.wwDBGrid4DblClick(Sender: TObject);
var
  vnama_barang_org : String;
  vketerangan_org : String;
  vpos : Integer;
