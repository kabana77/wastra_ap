object ValidasiBonBenangFrm: TValidasiBonBenangFrm
  Left = 208
  Top = 144
  Width = 1083
  Height = 504
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'SATUAN'#9'10'#9'SATUAN'#9'T'#9'BARANG/ BAHAN'
          'QTY_STOK'#9'7'#9'STOK'#9'T'#9'JUMLAH'
          'QTY_BON'#9'6'#9'BON~Bulan ini (KG)'#9'T'#9'JUMLAH'
          'QTY_VALID'#9'11'#9'Sudah~diserahkan (KG)'#9'T'#9'JUMLAH'
          ...
          'QTY'#9'11'#9'JUMLAH~DISERAHKAN~(KG)'#9'T'
          'KD_SUB_LOKASI'#9'5'#9'KODE'#9'F'#9'DARI LOKASI'
          'LOKASI'#9'15'#9'NAMA'#9'T'#9'DARI LOKASI'
          'KD_PROYEK'#9'12'#9'KODE~PROYEK'#9'F')
        IniAttributes.Enabled = True
  ...
  object QTransaksi: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      000049535055534154010000000000}
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      ...
      '  insert into pmtx02.vbon_barang_detail'
        ...
        'ngan, qty_bon, qty_valid, qty_kg_box, qty_box, qty_kg_karung, qt' +
        'y_karung, qty_kg_palet, qty_palet, qty, id_bag, id_sub_bag, kd_l' +
        'okasi, kk, no_mesin_tenun) (select distinct'
      
        '  :no_reg_pemakaian, :tanggal, no_reg_bon, kd_item, mesin, nama_' +
        'item, qty, qty_validasi, (qty_kg_box-qty_vkgbox), (qty_box-qty_v' +
        'box), (qty_kg_karung-qty_vkgkarung), (qty_karung-qty_vkarung), (' +
        'qty_kg_palet-qty_vkgpalet), (qty_palet-qty_vpalet), (qty-qty_val' +
        'idasi), id_bag, id_sub_bag, '#39'0'#39'||kd_jns_item, kk, no_mesin_tenun'
  ...
  object QInsertBJ: TOracleQuery
    SQL.Strings = (
      'begin'
      '  pmtx02.proc_insert_stokbj(:no_reg_pemakaian);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000001000000110000003A4E4F5F5245475F50454D414B4149414E030000
