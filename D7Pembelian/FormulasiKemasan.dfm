object FormulasiKemasanFrm: TFormulasiKemasanFrm
  Left = 307
  Top = 154
  Width = 756
  Height = 611
  ActiveControl = GroupBox1
  Caption = 'Formulasi Bahan Kemasan'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          'NO_NOTA'#9'14'#9'NO FORMULA'#9'F'
          'TANGGAL'#9'11'#9'TANGGAL'#9'F'
          'ISPOST'#9'5'#9'POST'#9'F'
          'KETERANGAN'#9'31'#9'NAMA FORMULASI/ KETERANGAN'#9'F'
          'KD_MERK'#9'5'#9'KODE'#9'F'#9'MERK'
          'MERK'#9'17'#9'NAMA'#9'F'#9'MERK'
          'KD_KEMASAN'#9'5'#9'KODE'#9'F'#9'KEMASAN'
          'KEMASAN'#9'23'#9'KODE'#9'F'#9'KEMASAN')
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel5: TPanel
        ...
        object LookMerk: TwwDBLookupComboDlg
          ...
          OnUserButton1Click = LookMerkUserButton1Click
          Selected.Strings = (
            'MERK'#9'30'#9'MERK'#9'F'
            'KD_MERK'#9'3'#9'KODE'#9'F')
          DataField = 'KD_MERK'
          DataSource = dsQTransaksi
          LookupTable = DMFrm.QMerk
          LookupField = 'KD_MERK'
          ParentFont = False
          TabOrder = 0
          AutoDropDown = False
          ShowButton = True
          AllowClearKey = False
          OnEnter = LookMerkEnter
        end
        object LookKemasan: TwwDBLookupComboDlg
          Left = 64
          Top = 36
          Width = 57
          Height = 21
          ...
          MaxHeight = 209
          UserButton1Caption = '&Refresh'
          OnUserButton1Click = LookKemasanUserButton1Click
          Selected.Strings = (
            'KEMASAN'#9'30'#9'KEMASAN'#9'F'
            'KD_KEMASAN'#9'3'#9'KODE'#9'F')
          DataField = 'KD_KEMASAN'
          DataSource = dsQTransaksi
          LookupTable = DMFrm.QKemasan
          LookupField = 'KD_KEMASAN'
          TabOrder = 1
          AutoDropDown = True
          ShowButton = True
          AllowClearKey = False
          OnEnter = LookKemasanEnter
        end
  ...
  object QTransaksi: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      040000000C0000000700000054414E4747414C010000000000070000004E4F5F
    ...
    object QTransaksiKD_KEMASAN: TStringField
      FieldName = 'KD_KEMASAN'
      Size = 3
    end
    object QTransaksiKD_MERK: TStringField
      FieldName = 'KD_MERK'
      Size = 3
    end
    object QTransaksiMERK: TStringField
      FieldKind = fkLookup
      FieldName = 'MERK'
      LookupDataSet = DMFrm.QMerk
    ...
    object QTransaksiKEMASAN: TStringField
      FieldKind = fkLookup
      FieldName = 'KEMASAN'
      LookupDataSet = DMFrm.QKemasan
      LookupKeyFields = 'KD_KEMASAN'
      LookupResultField = 'KEMASAN'
      KeyFields = 'KD_KEMASAN'
      Size = 50
      Lookup = True
    end
  end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from pmtx01.vformulasi_kemasan'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000110000006F726465
      72206279204E4F5F4E4F54410000000000}
    QBEDefinition.QBEFieldDefs = {
      040000000C0000000C0000004B445F5452414E53414B53490100000000000700
      ...
      
      010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
