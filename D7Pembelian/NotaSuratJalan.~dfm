object NotaSuratJalanFrm: TNotaSuratJalanFrm
  Left = 250
  Top = 142
  Width = 1014
  Height = 590
  Caption = 'Nota Surat Jalan'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = '&Daftar Nota Surat Jalan'
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_BARANG'#9'35'#9'NAMA BARANG'#9'F'#9'BARANG/BAHAN'
          'QTY'#9'10'#9'Jumlah'#9'F'#9'QTY'
          'SATUAN'#9'10'#9'Satuan'#9'F'#9'QTY'
          'KETERANGAN'#9'35'#9'KETERANGAN'#9'T'#9'BARANG/BAHAN'
          'KD_REKANAN'#9'4'#9'KD_REKANAN'#9'F'#9'REKANAN'
          'KD_DASAR'#9'3'#9'KD_DASAR'#9'F'#9'DASAR PENGIRIMAN'
          'NAMA_DASAR'#9'25'#9'NAMA_DASAR'#9'T'#9'DASAR PENGIRIMAN'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'KD_DASAR;CustomEdit;LookDasar;F')
        PictureMasks.Strings = (
          'ID_BAG'#9'*2{#,&}'#9'T'#9'T'
          'KD_JNS_ITEM'#9'#,&'#9'T'#9'T'
          'KD_SATUAN'#9'#,&'#9'T'#9'T'
        ...
        Selected.Strings = (
          'KD_ITEM'#9'10'#9'KODE'#9'F'#9'BARANG/ BAHAN'
          'NAMA_BARANG'#9'35'#9'NAMA'#9'T'#9'BARANG/ BAHAN'
          'KETERANGAN'#9'30'#9'SPESIFIKASI'#9'F'#9'BARANG/ BAHAN'
          'SATUAN'#9'10'#9'SATUAN'#9'F'
          'QTY'#9'10'#9'JML'#9'F'
          'KD_DASAR'#9'3'#9'KD_DASAR'#9'F'#9'DASAR PENGIRIMAN'
          'NAMA_DASAR'#9'25'#9'KETERANGAN'#9'T'#9'DASAR PENGIRIMAN')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
      ...
      object LookDasar: TwwDBLookupComboDlg
        Left = 448
        Top = 296
        Width = 121
        Height = 21
        ...
        MaxHeight = 209
        Selected.Strings = (
          'KD_DASAR'#9'3'#9'KD_DASAR'#9'F'
          'NAMA_DASAR'#9'50'#9'NAMA_DASAR'#9'F')
        DataField = 'KD_DASAR'
        DataSource = dsQDetail
        LookupTable = QLookDasar
        LookupField = 'KD_DASAR'
        TabOrder = 7
        AutoDropDown = False
        ShowButton = True
        AllowClearKey = False
    ...
    object INRekanan: TTabSheet
      Caption = 'Input Rekanan'
      ImageIndex = 3
      OnShow = INRekananShow
      object DBGridRekanan: TwwDBGrid
        Left = 0
        Top = 49
        Width = 990
        Height = 280
        ControlType.Strings = (
          ...
          'ISAKTIF;CheckBox;1;0')
        Selected.Strings = (
          'KD_REKANAN'#9'8'#9'KODE~REKANAN'#9'T'
          'NAMA_REKANAN'#9'40'#9'NAMA~REKANAN'#9'F'
          'ALAMAT'#9'50'#9'ALAMAT'#9'F'
          'KOTA'#9'15'#9'KOTA'#9'F'
          'TELEPON'#9'15'#9'TELEPON'#9'F'
          'EMAIL'#9'25'#9'EMAIL'#9'F'
          'ISAKTIF'#9'8'#9'STATUS AKTIV'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
        ...
        TitleButtons = True
        UseTFields = False
        OnCalcCellColors = DBGridRekananCalcCellColors
        OnTitleButtonClick = DBGridRekananTitleButtonClick
        OnDblClick = wwDBGrid1DblClick
        PaintOptions.AlternatingRowColor = clMoneyGreen
        PaintOptions.ActiveRecordColor = clGreen
      end
      object Panel13: TPanel
        ...
        BevelInner = bvLowered
        TabOrder = 1
        object BtnUneditRek: TSpeedButton
          Left = 82
          Top = 16
          Width = 23
          Height = 25
          ...
          NumGlyphs = 2
          OnClick = BtnUneditRekClick
        end
        object BtnEditRekanan: TSpeedButton
          Left = 8
          Top = 16
          Width = 75
          Height = 25
    ...
    object INBarang: TTabSheet
      Caption = 'Input Barang'
      ImageIndex = 4
      OnShow = INBarangShow
      object DBGridBarang: TwwDBGrid
        Left = 0
        Top = 49
        Width = 998
        Height = 390
        ControlType.Strings = (
          'KD_KEL;CustomEdit;LookJenis;F'
          'KD_SATUAN;CustomEdit;DBLookSatuan;F'
          'ISAKTIF;CheckBox;1;0')
        Selected.Strings = (
          'KD_ITEM'#9'5'#9'KD~BARANG'#9'T'
          'NAMA_ITEM'#9'50'#9'NAMA~BARANG'#9'F'
          'KD_SATUAN'#9'2'#9'KODE~SATUAN'#9'F'
          'SATUAN'#9'20'#9'SATUAN'#9'T')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
        ...
        TitleButtons = True
        UseTFields = False
        OnCalcCellColors = DBGridBarangCalcCellColors
        OnTitleButtonClick = DBGridBarangTitleButtonClick
        OnDblClick = wwDBGrid1DblClick
        PaintOptions.AlternatingRowColor = clMoneyGreen
        PaintOptions.ActiveRecordColor = clGreen
      end
      object Panel14: TPanel
        ...
        BevelInner = bvLowered
        TabOrder = 1
        object BtnUneditBrg: TSpeedButton
          Left = 82
          Top = 16
          Width = 23
          Height = 25
          ...
          Glyph.Data = {
            ...
            3333333333777773333333333333333333333333333333333333}
          NumGlyphs = 2
          OnClick = BtnUneditBrgClick
        end
        object BtnEditBarang: TSpeedButton
          Left = 8
          Top = 16
          Width = 75
          Height = 25
      ...
      object DBLookSatuan: TwwDBLookupComboDlg
        Left = 240
        Top = 168
        Width = 121
        Height = 21
        ...
        ShowButton = True
        AllowClearKey = False
        OnCloseUp = DBLookSatuanCloseUp
        OnEnter = DBLookSatuanEnter
      end
    end
  end
  object QTransaksi: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.surat_jalan a'
      'where a.no_reg_sj=:no_reg_sj')
    ReadBuffer = 1
    Variables.Data = {
      03000000010000000A0000003A4E4F5F5245475F534A03000000000000000000
      0000}
    SequenceField.Field = 'NO_REG_SJ'
    SequenceField.Sequence = 'PMTX02.NO_REG_SJ1'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00000000000A0000004B445F52454B414E414E010000000000090000004E4F5F
      5245475F534A010000000000050000004E4F504F4C0100000000000700000052
      454B414E414E010000000000050000004A454E4953010000000000}
    ...
    object QTransaksiNO_REG_SJ: TIntegerField
      FieldName = 'NO_REG_SJ'
      Required = True
    end
    ...
    object QTransaksiNOPOL: TStringField
      FieldName = 'NOPOL'
      Size = 15
    end
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.surat_jalan_detail a'
      'where no_reg_sj = :no_reg_sj'
    ...
    Variables.Data = {
      ...
      0000}
    QBEDefinition.QBEFieldDefs = {
      040000000D000000070000004B445F4954454D0100000000000A0000004B4554
      ...
      
      050000004A454E4953010000000000}
    Master = QTransaksi
    MasterFields = 'NO_REG_SJ'
    DetailFields = 'NO_REG_SJ'
    QueryAllRecords = False
    CountAllRecords = True
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    Session = DMFrm.OS
    ...
    Left = 900
    Top = 72
    object QDetailNO_REG_SJ: TIntegerField
      FieldName = 'NO_REG_SJ'
      Required = True
    end
    ...
    object QDetailKD_DASAR: TStringField
      FieldName = 'KD_DASAR'
      Size = 3
    end
    object QDetailNAMA_DASAR: TStringField
      FieldKind = fkLookup
      FieldName = 'NAMA_DASAR'
      LookupDataSet = QLookDasar
      LookupKeyFields = 'KD_DASAR'
      LookupResultField = 'NAMA_DASAR'
      KeyFields = 'KD_DASAR'
      Size = 50
      Lookup = True
    end
  ...
  object QLookItem: TOracleDataSet
    ...
    Variables.Data = {
      ...
      30312E626172616E670000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000004000000050000004A454E4953010000000000060000005341545541
      4E010000000000070000004B445F4954454D010000000000090000004E414D41
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from (select * from pmtx02.vpermintaan_surat_jalan'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
    ...
    Left = 588
    Top = 17
    object QBrowseNO_REG_SJ: TIntegerField
      FieldName = 'NO_REG_SJ'
      Required = True
    end
    ...
    object QBrowseNAMA_BARANG: TStringField
      FieldName = 'NAMA_BARANG'
      Size = 255
    end
    ...
    object QBrowseKD_DASAR: TStringField
      FieldName = 'KD_DASAR'
      Required = True
      Size = 3
    end
    object QBrowseNAMA_DASAR: TStringField
      FieldName = 'NAMA_DASAR'
      Size = 50
    end
  ...
  object QLookDasar: TOracleDataSet
    SQL.Strings = (
      'select * from pmtx01.jns_dasar_sj')
    QBEDefinition.QBEFieldDefs = {
      0400000002000000080000004B445F44415341520100000000000A0000004E41
      4D415F4441534152010000000000}
    Session = DMFrm.OS
    BeforeOpen = QLookDasarBeforeOpen
    Left = 692
    Top = 17
    object QLookDasarKD_DASAR: TStringField
      DisplayWidth = 3
      FieldName = 'KD_DASAR'
      Required = True
      Size = 3
    end
    object QLookDasarNAMA_DASAR: TStringField
      DisplayWidth = 50
      FieldName = 'NAMA_DASAR'
      Size = 50
    end
  ...
  object QBrowse2: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      00000052454B414E414E010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    BeforeOpen = QBrowseBeforeOpen
    ...
    object QBrowse2TANGGAL_PO: TDateTimeField
  ...
  object dsQMasterRekanan: TwwDataSource
    DataSet = QMasterRekanan
    Left = 764
    Top = 193
  end
  object QMasterRekanan: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx01.rekanan_sj a'
      ':MYPARAM'
      '')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000140000006F726465
      72206279206B645F72656B616E616E0000000000}
    SequenceField.Field = 'KD_REKANAN'
    SequenceField.Sequence = 'pmtx01.kd_rekanan_sj'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      
    ...
    CachedUpdates = True
    Session = DMFrm.OS
    BeforeInsert = QMasterRekananBeforeInsert
    AfterPost = QMasterRekananAfterPost
    AfterDelete = QMasterRekananAfterDelete
    AfterScroll = QMasterRekananAfterScroll
    Left = 516
    Top = 129
    object QMasterRekananNAMA_REKANAN: TStringField
      FieldName = 'NAMA_REKANAN'
      Required = True
      Size = 50
    end
    object QMasterRekananALAMAT: TStringField
      FieldName = 'ALAMAT'
      Size = 50
    end
    object QMasterRekananKOTA: TStringField
      FieldName = 'KOTA'
      Required = True
      Size = 50
    end
    object QMasterRekananTELEPON: TStringField
      FieldName = 'TELEPON'
      Size = 50
    end
    object QMasterRekananEMAIL: TStringField
      FieldName = 'EMAIL'
      Size = 50
    end
    object QMasterRekananISAKTIF: TStringField
      FieldName = 'ISAKTIF'
      Required = True
      Size = 1
    end
    object QMasterRekananKD_REKANAN: TStringField
      FieldName = 'KD_REKANAN'
      Size = 8
    end
  end
  object QMasterBarang: TOracleDataSet
    SQL.Strings = (
      'select a.*,a.rowid from pmtx01.barang a'
      ':MYPARAM')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000110000006F726465
      72206279206B645F6974656D0000000000}
    SequenceField.Field = 'KD_ITEM'
    SequenceField.Sequence = 'pmtx01.kd_barang_sj'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      0400000005000000070000004B445F4954454D010000000000090000004E414D
      415F4954454D010000000000050000004A454E49530100000000000600000053
      415455414E010000000000090000004B445F53415455414E010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    CachedUpdates = True
    Session = DMFrm.OS
    AfterPost = QMasterBarangAfterPost
    AfterDelete = QMasterBarangAfterDelete
    AfterScroll = QMasterBarangAfterScroll
    Left = 668
    Top = 265
    object QMasterBarangKD_ITEM: TStringField
      FieldName = 'KD_ITEM'
      Required = True
      Size = 8
    end
    object QMasterBarangNAMA_ITEM: TStringField
      FieldName = 'NAMA_ITEM'
      Size = 255
    end
    object QMasterBarangSATUAN: TStringField
      FieldName = 'SATUAN'
    end
    object QMasterBarangKD_SATUAN: TStringField
      FieldName = 'KD_SATUAN'
      Size = 2
    end
    object QMasterBarangJENIS: TStringField
      FieldName = 'JENIS'
    end
  end
  object dsQMasterBarang: TwwDataSource
    DataSet = QMasterBarang
    Left = 804
    Top = 185
  end
  object QLookSatuan: TOracleDataSet
    SQL.Strings = (
        ...
        'select t.kd_satuan,t.sat1 as satuan from pmtx01.satuan t order b' +
        'y kd_satuan ')
    QBEDefinition.QBEFieldDefs = {
      0400000002000000090000004B445F53415455414E0100000000000600000053
    ...
    object QLookSatuanSATUAN: TStringField
      DisplayWidth = 12
      FieldName = 'SATUAN'
      Required = True
      Size = 12
