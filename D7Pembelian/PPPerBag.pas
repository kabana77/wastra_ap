...
procedure TPPPerBagFrm.FormClose(Sender: TObject;
...
procedure TPPPerBagFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TPPPerBagFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPPPerBagFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TPPPerBagFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TPPPerBagFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TPPPerBagFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TPPPerBagFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TPPPerBagFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TPPPerBagFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TPPPerBagFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TPPPerBagFrm.LookItemEnter(Sender: TObject);
begin
...
procedure TPPPerBagFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_kebutuhan',vkd_jns_kebutuhan);
end;

procedure TPPPerBagFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPPPerBagFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TPPPerBagFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TPPPerBagFrm.ECariChange(Sender: TObject);
begin
...
procedure TPPPerBagFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TPPPerBagFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
//    vorder:=' order by '+wwDBGrid1.Columns[0].FieldName;
    if QBrowse.Active then
      vorder:=' order by '+wwDBGrid1.Columns[0].FieldName
        ...
        vorder:=' order by bagian, sub_bagian, no_nota';
...
procedure TPPPerBagFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
end;

procedure TPPPerBagFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi','%');
end;

procedure TPPPerBagFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=Caption;
end;

procedure TPPPerBagFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TPPPerBagFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TPPPerBagFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TPPPerBagFrm.FormCloseQuery(Sender: TObject;
...
procedure TPPPerBagFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPPPerBagFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TPPPerBagFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TPPPerBagFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TPPPerBagFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TPPPerBagFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TPPPerBagFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TPPPerBagFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TPPPerBagFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TPPPerBagFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TPPPerBagFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TPPPerBagFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TPPPerBagFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TPPPerBagFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TPPPerBagFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TPPPerBagFrm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  Inc(vnomer);
...
procedure TPPPerBagFrm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vnomer:=0;
end;
