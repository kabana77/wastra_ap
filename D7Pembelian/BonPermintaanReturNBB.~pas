...
type
  TBonPermintaanReturNBBFrm = class(TForm)
    Panel1: TPanel;
    ...
    QLookLPB: TOracleDataSet;
    QBatasRetur: TOracleDataSet;
    QBatasReturTANGGAL: TDateTimeField;
    QLookLPBNO_NOTA: TStringField;
    QLookLPBREKANAN: TStringField;
    QLookLPBTANGGAL: TDateTimeField;
    LookLPB: TwwDBLookupComboDlg;
    QLookLPBHARGA: TFloatField;
    ...
    procedure QLookLPBBeforeOpen(DataSet: TDataSet);
    procedure LookLPBEnter(Sender: TObject);
    procedure LookLPBUserButton1Click(Sender: TObject;
      LookupTable: TDataSet);
    procedure LookLPBCloseUp(Sender: TObject; LookupTable,
      FillTable: TDataSet; modified: Boolean);
  private
  ...
  public
    { Public declarations }
    vkd_jns_item, vkd_bag, vkd_lpb : String;
    vhak_input : Boolean;
    vrecord_ke : Integer;
  end;

var
  BonPermintaanReturNBBFrm: TBonPermintaanReturNBBFrm;
...
procedure TBonPermintaanReturNBBFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  BonPermintaanReturNBBFrm:=Nil;
end;

procedure TBonPermintaanReturNBBFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TBonPermintaanReturNBBFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TBonPermintaanReturNBBFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBonPermintaanReturNBBFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TBonPermintaanReturNBBFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TBonPermintaanReturNBBFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TBonPermintaanReturNBBFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TBonPermintaanReturNBBFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TBonPermintaanReturNBBFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPermintaanReturNBBFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TBonPermintaanReturNBBFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TBonPermintaanReturNBBFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TBonPermintaanReturNBBFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPermintaanReturNBBFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TBonPermintaanReturNBBFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TBonPermintaanReturNBBFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TBonPermintaanReturNBBFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TBonPermintaanReturNBBFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TBonPermintaanReturNBBFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyear : word;
  vtgl_awal : TDate;
  vtgl,cy:string;
...
begin
  DecodeDate(wwDBDateTimePicker1.DateTime,vyear,vmm,vdd);
  vtgl_awal:=EncodeDate(vyear,1,1);
  //vy:=(vyear);

 //vtgl:=datetostr(vtgl_awal);
  //showmessage(vtgl);
  ...
  QLookItem.SetVariable('TAHUN',vyear);
...
procedure TBonPermintaanReturNBBFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TBonPermintaanReturNBBFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TBonPermintaanReturNBBFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TBonPermintaanReturNBBFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TBonPermintaanReturNBBFrm.ECariChange(Sender: TObject);
begin
...
procedure TBonPermintaanReturNBBFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBonPermintaanReturNBBFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TBonPermintaanReturNBBFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TBonPermintaanReturNBBFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBonPermintaanReturNBBFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TBonPermintaanReturNBBFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TBonPermintaanReturNBBFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TBonPermintaanReturNBBFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TBonPermintaanReturNBBFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBonPermintaanReturNBBFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TBonPermintaanReturNBBFrm.FormCloseQuery(Sender: TObject;
...
procedure TBonPermintaanReturNBBFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPermintaanReturNBBFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TBonPermintaanReturNBBFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TBonPermintaanReturNBBFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBonPermintaanReturNBBFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBonPermintaanReturNBBFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TBonPermintaanReturNBBFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TBonPermintaanReturNBBFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TBonPermintaanReturNBBFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TBonPermintaanReturNBBFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TBonPermintaanReturNBBFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TBonPermintaanReturNBBFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBonPermintaanReturNBBFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TBonPermintaanReturNBBFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBonPermintaanReturNBBFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TBonPermintaanReturNBBFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPermintaanReturNBBFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPermintaanReturNBBFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TBonPermintaanReturNBBFrm.LookBudgetCloseUp(Sender: TObject;
...
procedure TBonPermintaanReturNBBFrm.LookBudgetEnter(Sender: TObject);
begin
{MAA}
...
procedure TBonPermintaanReturNBBFrm.QLookLPBBeforeOpen(DataSet: TDataSet);
begin
  QLookLPB.SetVariable('range_tanggal',QBatasReturTANGGAL.AsDateTime);
  QLookLPB.SetVariable('kd_lpb',vkd_lpb);
  QLookLPB.SetVariable('kd_item',QLookItemKD_ITEM.AsString);
end;

procedure TBonPermintaanReturNBBFrm.LookLPBEnter(Sender: TObject);
begin
  QLookLPB.Close;
  QLookLPB.Open;
end;

procedure TBonPermintaanReturNBBFrm.LookLPBUserButton1Click(
...
procedure TBonPermintaanReturNBBFrm.LookLPBCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
    QDetailHARGA.AsFloat:=QLookLPBHARGA.AsFloat;
  end;
end;
