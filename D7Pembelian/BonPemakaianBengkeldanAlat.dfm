object BonPemakaianBengkeldanAlatFrm: TBonPemakaianBengkeldanAlatFrm
  Left = 250
  Top = 125
  Width = 992
  Height = 611
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'QTY_BON'#9'10'#9'BON~BLN INI (KG)'#9'T'
          'QTY_KG_BOX'#9'10'#9'Kg'#9'F'#9'BOX'
          'QTY_BOX'#9'10'#9'Jml~Box'#9'F'#9'BOX'
          'QTY_KG_KARUNG'#9'10'#9'Kg'#9'F'#9'KARUNG'
          'QTY_KARUNG'#9'10'#9'Jml~Karung'#9'F'#9'KARUNG'
          'QTY_KG_PALET'#9'10'#9'Kg'#9'F'#9'PALET'
          'QTY_PALET'#9'10'#9'Jml~Palet'#9'F'#9'PALET'
          'QTY'#9'8'#9'TOTAL JUMLAH~DIMINTA (KG)'#9'T'
  ...
  object QDetail: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00005154595F4B475F50414C4554010000000000}
    Master = QTransaksi
    ...
    object QDetailQTY_PALET: TFloatField
      FieldName = 'QTY_PALET'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
    object QDetailQTY_KG_BOX: TFloatField
      FieldName = 'QTY_KG_BOX'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
    object QDetailQTY_KG_KARUNG: TFloatField
      FieldName = 'QTY_KG_KARUNG'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      010000000000050000004D4553494E010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
  ...
  object QLookSubBagian: TOracleDataSet
    ...
    Variables.Data = {
      ...
      7265206B645F7472616E73616B73693D274B3137270000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QLookMesin: TOracleDataSet
    SQL.Strings = (
        ...
        'select no_polisi as kode,jenis||'#39' '#39'||kendaraan as mesin, '#39'KENDAR' +
        'AAN'#39' AS jenis from pmtx01.kendaraan'
      'union'
  ...
  object ODSTGL: TOracleDataSet
    ...
    Variables.Data = {
      03000000020000000D0000003A4B445F5452414E53414B534905000000040000
      004230370000000000080000003A4D59504152414D01000000110000006F7264
      6572206279204E4F5F4E4F54410000000000}
    QBEDefinition.QBEFieldDefs = {
