...
procedure TPOBenangFrm.FormClose(Sender: TObject;
...
procedure TPOBenangFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TPOBenangFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPOBenangFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TPOBenangFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TPOBenangFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TPOBenangFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TPOBenangFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TPOBenangFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
{azmi}
...
procedure TPOBenangFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
{azmi}
...
procedure TPOBenangFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TPOBenangFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPOBenangFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TPOBenangFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TPOBenangFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TPOBenangFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TPOBenangFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_kebutuhan',vkd_jns_kebutuhan);
end;

procedure TPOBenangFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TPOBenangFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TPOBenangFrm.ECariChange(Sender: TObject);
begin
...
procedure TPOBenangFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TPOBenangFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TPOBenangFrm.FormShow(Sender: TObject);
begin
...
procedure TPOBenangFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TPOBenangFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vnomer:=0;
...
procedure TPOBenangFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TPOBenangFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TPOBenangFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TPOBenangFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QCaraBayar.close;
  QCaraBayar.Open;
...
procedure TPOBenangFrm.FormCloseQuery(Sender: TObject;
...
procedure TPOBenangFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TPOBenangFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TPOBenangFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TPOBenangFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TPOBenangFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TPOBenangFrm.RadioGroup1Click(Sender: TObject);
begin
  {case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TPOBenangFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TPOBenangFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TPOBenangFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TPOBenangFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TPOBenangFrm.BtnExportClick(Sender: TObject);
begin
{  if QBrowse.Active then
  begin
...
procedure TPOBenangFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TPOBenangFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TPOBenangFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TPOBenangFrm.QDetailBeforePost(DataSet: TDataSet);
begin
  QDetailOPR_UPDATE.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TPOBenangFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TPOBenangFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TPOBenangFrm.LookSuplierCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
var
  vkota : string;
begin
...
procedure TPOBenangFrm.LookSuplierEnter(Sender: TObject);
begin
  QSuplier.Open;
end;

procedure TPOBenangFrm.LookSuplierUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QSuplier.Close;
  QSuplier.Open;
...
procedure TPOBenangFrm.LookMUEnter(Sender: TObject);
begin
  DMFrm.QMU.Open;
end;

procedure TPOBenangFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TPOBenangFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.SetVariable('no_reg_po',QTransaksiNO_REG_PO.AsInteger);
  QTotal.Open;
...
procedure TPOBenangFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiPPN.AsString='-' then
  begin
...
procedure TPOBenangFrm.SummaryBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPOBenangFrm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vdpp:=0;
  vppn:=0;
...
procedure TPOBenangFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPOBenangFrm.PageHeaderBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
//  vfirst_page:=False;
end;

procedure TPOBenangFrm.QBrowseDetailBeforeOpen(DataSet: TDataSet);
begin
//  QBrowseDetail.SetVariable('no_reg_po',QBrowseNO_REG_PO.AsInteger);
end;

procedure TPOBenangFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer);
...
procedure TPOBenangFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer2);
...
procedure TPOBenangFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  //QDetailQTY_PO2.AsFloat:=QDetailQTY_PO.AsFloat*cball2kg;
  QDetailQTY_PO2.AsFloat:=QDetailQTY_PO.AsFloat;
end;

procedure TPOBenangFrm.QSuplierBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPOBenangFrm.wwDBGrid1URLOpen(Sender: TObject;
...
procedure TPOBenangFrm.Vtglawal2Change(Sender: TObject);
begin
 vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TPOBenangFrm.Vtglakhir2Change(Sender: TObject);
begin
...
procedure TPOBenangFrm.Btn_filterClick(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TPOBenangFrm.dbcfield2Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TPOBenangFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TPOBenangFrm.cbotomatis2Click(Sender: TObject);
begin
...
procedure TPOBenangFrm.wwDBGrid3DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
...
procedure TPOBenangFrm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TPOBenangFrm.QBrowse2BeforeOpen(DataSet: TDataSet);
begin
  QBrowse2.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TPOBenangFrm.LookPPNEnter(Sender: TObject);
begin
...
procedure TPOBenangFrm.LookMUCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  QTransaksiKURS.AsInteger:=1;
...
procedure TPOBenangFrm.QDetailTGL_POChange(Sender: TField);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
      ShowMessage('Maaf, data sudah di-POSTING, tidak bisa diubah !');
...
procedure TPOBenangFrm.LookPPNChange(Sender: TObject);
begin
{azmi
if lookppn.ItemIndex=-1 then
...
if lookppn.Text='I11' then
wwcheckbox2.Checked:=true;

if lookppn.Text='E11' then
wwcheckbox2.Checked:=true;
{azmi}
end;

procedure TPOBenangFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
...
procedure TPOBenangFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
{azmi}
  QUM.Close;
...
procedure TPOBenangFrm.wwDBEdit7Exit(Sender: TObject);
begin
{azmi}
//    QTransaksiUM.AsFloat:=QTotalSUB_TOTAL.AsFloat*(QTransaksiPERSEN_UM.AsFloat/100);
              if (QTransaksiPPN.AsString='EXC') or (QTransaksiPPN.AsString='E11') then
...
procedure TPOBenangFrm.wwCheckBox1Click(Sender: TObject);
begin
{iwan}
...
procedure TPOBenangFrm.wwDBComboBox2CloseUp(Sender: TwwDBComboBox;
  Select: Boolean);
begin
...
procedure TPOBenangFrm.QCaraBayarBeforeQuery(Sender: TOracleDataSet);
begin
