object BonPermintaanReturNBBFrm: TBonPermintaanReturNBBFrm
  Left = 350
  Top = 127
  Width = 950
  Height = 611
  Caption = 'Permintaan Retur Non Bahan Baku'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = '&Daftar Permintaan Retur'
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'QTY'#9'7'#9'Retur'#9'F'#9'JUMLAH RETUR'
          'QTY_VALIDASI'#9'7'#9'SJ'#9'F'#9'JUMLAH RETUR'
    ...
    object TabSheet2: TTabSheet
      ...
      object LookLPB: TwwDBLookupComboDlg
        Left = 632
        Top = 248
        Width = 121
        Height = 21
        ...
        MaxHeight = 209
        UserButton1Caption = '&Refresh'
        OnUserButton1Click = LookLPBUserButton1Click
        Selected.Strings = (
        ...
        DataField = 'NO_LPB'
        DataSource = dsQDetail
        LookupTable = QLookLPB
        LookupField = 'NO_NOTA'
        TabOrder = 8
        AutoDropDown = False
        ShowButton = True
        AllowClearKey = False
        OnCloseUp = LookLPBCloseUp
        OnEnter = LookLPBEnter
      end
    end
  end
  ...
  object QDetail: TOracleDataSet
    ...
    Variables.Data = {
      ...
      000000}
    QBEDefinition.QBEFieldDefs = {
      0400000017000000070000004B445F4954454D0100000000000A0000004B4554
      ...
      004B445F4249415941010000000000020000004B4B010000000000060000004E
      4F5F4C5042010000000000050000004841524741010000000000}
    Master = QTransaksi
  ...
  object QLookItem: TOracleDataSet
    ...
    Variables.Data = {
      ...
      350000000000090000003A54474C5F4157414C0C000000070000007872010101
      0101000000000A0000003A54474C5F414B4849520C0000000700000078720A09
      01010100000000060000003A544148554E0300000004000000DE070000000000
  ...
  object QLookSubBagian: TOracleDataSet
    ...
    Variables.Data = {
      ...
      7265206B645F7472616E73616B73693D27523032270000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QLookLPB: TOracleDataSet
    SQL.Strings = (
      'select * from'
      
        '  (select t.NO_NOTA, t.rekanan, t.tanggal, j.kd_item, j.harga FR' +
        'OM pmtx02.lpb t, pmtx02.lpb_detail j'
      '   where t.no_reg_lpb = j.no_reg_lpb)'
      
        'where tanggal >= :range_tanggal and substr(no_nota,1,3) = :kd_lp' +
        'b and kd_item = :kd_item'
      'order by no_nota desc'
      '')
    Variables.Data = {
      03000000030000000E0000003A52414E47455F54414E4747414C0C0000000700
      00007874010101010100000000070000003A4B445F4C50420500000004000000
      3430340000000000080000003A4B445F4954454D050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000005000000070000004E4F5F4E4F54410100000000000700000052454B
      414E414E0100000000000700000054414E4747414C0100000000000900000054
      4148554E5F4C5042010000000000050000004841524741010000000000}
    Session = DMFrm.OS
    BeforeOpen = QLookLPBBeforeOpen
    Left = 540
    Top = 105
    object QLookLPBNO_NOTA: TStringField
      DisplayWidth = 15
      FieldName = 'NO_NOTA'
      Size = 15
    end
    object QLookLPBREKANAN: TStringField
      DisplayWidth = 40
      FieldName = 'REKANAN'
      Size = 255
    end
    object QLookLPBTANGGAL: TDateTimeField
      DisplayWidth = 18
      FieldName = 'TANGGAL'
      DisplayFormat = 'dd mmm yyyy'
    end
    object QLookLPBHARGA: TFloatField
      FieldName = 'HARGA'
      Visible = False
    end
  end
  object QBatasRetur: TOracleDataSet
    SQL.Strings = (
      'select * FROM PMTX02.BATAS_RETUR'
      '')
    QBEDefinition.QBEFieldDefs = {04000000010000000700000054414E4747414C010000000000}
    Session = DMFrm.OS
    Left = 596
    Top = 81
    object QBatasReturTANGGAL: TDateTimeField
      FieldName = 'TANGGAL'
    end
  end
end
