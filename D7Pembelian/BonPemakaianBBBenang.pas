...
type
  TBonPemakaianBBBenangFrm = class(TForm)
    Panel1: TPanel;
    ...
    QDetailQTY_STOK2: TFloatField;
    QDetailQTY_BON2: TFloatField;
    QBrowseQTY2: TFloatField;
    QBrowseQTY_VALIDASI2: TFloatField;
    QTotal: TOracleDataSet;
    QTotalQTY: TFloatField;
    QTotalQTY_VALIDASI: TFloatField;
    QRLabel8: TQRLabel;
    QRDBText8: TQRDBText;
    QRExpr3: TQRExpr;
    QRExpr4: TQRExpr;
...
var
  BonPemakaianBBBenangFrm: TBonPemakaianBBBenangFrm;
...
procedure TBonPemakaianBBBenangFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  BonPemakaianBBBenangFrm:=Nil;
end;

procedure TBonPemakaianBBBenangFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TBonPemakaianBBBenangFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TBonPemakaianBBBenangFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBonPemakaianBBBenangFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TBonPemakaianBBBenangFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TBonPemakaianBBBenangFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TBonPemakaianBBBenangFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBBBenangFrm.TabSheet2Show(Sender: TObject);
begin
  if copy(QJnsTransaksiKD_TRANSAKSI.AsString,1,1)='K' then
  begin
...
procedure TBonPemakaianBBBenangFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBBBenangFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBBBenangFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPemakaianBBBenangFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TBonPemakaianBBBenangFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TBonPemakaianBBBenangFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TBonPemakaianBBBenangFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TBonPemakaianBBBenangFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TBonPemakaianBBBenangFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TBonPemakaianBBBenangFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TBonPemakaianBBBenangFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
  ...
  begin
      ...
      QDetailQTY_STOK2.AsInteger:=0;
      QDetailQTY_BON2.AsInteger:=0;
      QDetailQTY2.AsInteger:=0;
      QDetailQTY_STOK_BISFA.AsInteger:=0;
      QDetailQTY_BON_BISFA.AsInteger:=0;
      QDetailQTY_BISFA.AsInteger:=0;
  end
  else
  begin //
  {azmi}
    QDetailQTY_STOK.AsFloat:=QLookItemSTOK.AsFloat;
    QDetailQTY_STOK_BISFA.AsFloat:=QLookItemSTOK_BISFA.AsFloat;
...
procedure TBonPemakaianBBBenangFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TBonPemakaianBBBenangFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TBonPemakaianBBBenangFrm.ECariChange(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBonPemakaianBBBenangFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
//    vorder:=' order by '+wwDBGrid1.Columns[0].FieldName;
  ...
  wwDBGrid1.ColumnByName('QTY_VALIDASI').FooterValue:=FormatFloat('#,##0.00;(#,##0.00);-',QTotalQTY_VALIDASI.AsFloat);
  wwDBGrid1.ColumnByName('QTY2').FooterValue:=FormatFloat('#,##0.0000;(#,##0.0000);-',QTotalQTY.AsFloat/cball2kg);
  wwDBGrid1.ColumnByName('QTY_VALIDASI2').FooterValue:=FormatFloat('#,##0.0000;(#,##0.0000);-',QTotalQTY_VALIDASI.AsFloat/cball2kg);

end;

procedure TBonPemakaianBBBenangFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TBonPemakaianBBBenangFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBonPemakaianBBBenangFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TBonPemakaianBBBenangFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TBonPemakaianBBBenangFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBonPemakaianBBBenangFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TBonPemakaianBBBenangFrm.FormCloseQuery(Sender: TObject;
...
procedure TBonPemakaianBBBenangFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPemakaianBBBenangFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TBonPemakaianBBBenangFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TBonPemakaianBBBenangFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBonPemakaianBBBenangFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TBonPemakaianBBBenangFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TBonPemakaianBBBenangFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TBonPemakaianBBBenangFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TBonPemakaianBBBenangFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TBonPemakaianBBBenangFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TBonPemakaianBBBenangFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBonPemakaianBBBenangFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TBonPemakaianBBBenangFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBonPemakaianBBBenangFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TBonPemakaianBBBenangFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPemakaianBBBenangFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPemakaianBBBenangFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TBonPemakaianBBBenangFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailQTY_STOK2.AsFloat:=QDetailQTY_STOK.AsFloat/cball2kg;
  QDetailQTY_BON2.AsFloat:=QDetailQTY_BON.AsFloat/cball2kg;
end;

procedure TBonPemakaianBBBenangFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBBBenangFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseQTY2.AsFloat:=QBrowseQTY.AsFloat/cball2kg;
  QBrowseQTY_VALIDASI2.AsFloat:=QBrowseQTY_VALIDASI.AsFloat/cball2kg;
end;

procedure TBonPemakaianBBBenangFrm.QTotalBeforeOpen(DataSet: TDataSet);
begin
  QTotal.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBonPemakaianBBBenangFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TBonPemakaianBBBenangFrm.vTglAWAL2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TBonPemakaianBBBenangFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.vOperand2Click(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.cbTanggal2Click(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.BitBtn6Click(Sender: TObject);
begin
...
procedure TBonPemakaianBBBenangFrm.LookBudgetEnter(Sender: TObject);
var
  vlok : string;
  vidb2: string;
begin
...
procedure TBonPemakaianBBBenangFrm.LookBudgetCloseUp(Sender: TObject;
...
procedure TBonPemakaianBBBenangFrm.wwDBGrid4CalcCellColors(Sender: TObject;
  Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
  ABrush: TBrush);
begin
  if not Highlight then
...
procedure TBonPemakaianBBBenangFrm.wwDBGrid4DblClick(Sender: TObject);
var
  vnama_barang_org : String;
  vketerangan_org : String;
  vpos : Integer;
...
procedure TBonPemakaianBBBenangFrm.LookLOTEnter(Sender: TObject);
begin
  DMFrm.QNoLot.Close;
  DMFrm.QNoLot.Open;
end;

procedure TBonPemakaianBBBenangFrm.QDetailQTYChange(Sender: TField);
begin
