...
type
  TBonPemakaianSparepartFrm = class(TForm)
    Panel1: TPanel;
...
procedure TBonPemakaianSparepartFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBonPemakaianSparepartFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TBonPemakaianSparepartFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TBonPemakaianSparepartFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TBonPemakaianSparepartFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TBonPemakaianSparepartFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TBonPemakaianSparepartFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TBonPemakaianSparepartFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPemakaianSparepartFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TBonPemakaianSparepartFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TBonPemakaianSparepartFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TBonPemakaianSparepartFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TBonPemakaianSparepartFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TBonPemakaianSparepartFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TBonPemakaianSparepartFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TBonPemakaianSparepartFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
  ...
  begin
      ...
      QDetailMESIN.AsString:='UMUM PRODUKSI';
...
procedure TBonPemakaianSparepartFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TBonPemakaianSparepartFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TBonPemakaianSparepartFrm.ECariChange(Sender: TObject);
begin
...
procedure TBonPemakaianSparepartFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBonPemakaianSparepartFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TBonPemakaianSparepartFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TBonPemakaianSparepartFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBonPemakaianSparepartFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TBonPemakaianSparepartFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TBonPemakaianSparepartFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TBonPemakaianSparepartFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TBonPemakaianSparepartFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBonPemakaianSparepartFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TBonPemakaianSparepartFrm.FormCloseQuery(Sender: TObject;
...
procedure TBonPemakaianSparepartFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPemakaianSparepartFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TBonPemakaianSparepartFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TBonPemakaianSparepartFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBonPemakaianSparepartFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBonPemakaianSparepartFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TBonPemakaianSparepartFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TBonPemakaianSparepartFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TBonPemakaianSparepartFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TBonPemakaianSparepartFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TBonPemakaianSparepartFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TBonPemakaianSparepartFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBonPemakaianSparepartFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TBonPemakaianSparepartFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBonPemakaianSparepartFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TBonPemakaianSparepartFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPemakaianSparepartFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPemakaianSparepartFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TBonPemakaianSparepartFrm.LookMesinCloseUp(Sender: TObject;
...
begin
  ...
  begin
      ...
      begin
        ...
        QDetailMESIN.AsString:=QLookMesinMESIN.AsString;
      end
        else
        begin
...
procedure TBonPemakaianSparepartFrm.LookMesinEnter(Sender: TObject);
begin
  QLookMesin.Open;
end;

procedure TBonPemakaianSparepartFrm.LookMesinUserButton1Click(
...
procedure TBonPemakaianSparepartFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TBonPemakaianSparepartFrm.QDetailBeforePost(DataSet: TDataSet);
begin
  ...
  begin
     ShowMessage('KODE BIAYA HARUS DIISI !');
     Abort;
  end
end;

procedure TBonPemakaianSparepartFrm.vTglAWAL2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TBonPemakaianSparepartFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TBonPemakaianSparepartFrm.vOperand2Click(Sender: TObject);
begin
...
procedure TBonPemakaianSparepartFrm.LookBudgetEnter(Sender: TObject);
begin
...
procedure TBonPemakaianSparepartFrm.LookBudgetCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
{MAA}
