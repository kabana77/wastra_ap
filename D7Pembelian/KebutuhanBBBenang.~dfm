object KebutuhanBBBenangFrm: TKebutuhanBBBenangFrm
  Left = 208
  Top = 215
  Width = 1566
  Height = 737
  ActiveControl = vHeight
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_ITEM'#9'24'#9'NAMA'#9'F'#9'ITEM BARANG'
          'TGL_KEBUTUHAN'#9'12'#9'TANGGAL~PP'#9'F'
          'QTY'#9'10'#9'Kebutuhan'#9'F'#9'JUMLAH (KG)'
          'QTY_PO'#9'10'#9'PO'#9'F'#9'JUMLAH (KG)'
          'QTY_LPB'#9'10'#9'LPB'#9'F'#9'JUMLAH (KG)'
          'ISPOST'#9'18'#9'APPROVE'#9'F'#9'DISETUJUI'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KETERANGAN'#9'38'#9'NAMA / SPESIFIKASI (AL)+(K)'#9'T'#9'BARANG/ BAHAN'
          'QTY'#9'12'#9'JUMLAH~(KG)'#9'F'
          'TGL_KEBUTUHAN'#9'15'#9'TANGGAL~DIBUTUHKAN'#9'F'
          'KD_JNS_KEBUTUHAN'#9'5'#9'KODE'#9'F'#9'PRIORITAS'
          'JNS_KEBUTUHAN'#9'10'#9'JENIS'#9'T'#9'PRIORITAS'
    ...
    object TabSheet4: TTabSheet
      ...
      object wwDBGrid200: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_ITEM'#9'30'#9'NAMA'#9'F'#9'ITEM BARANG'
          'NO_NOTA'#9'15'#9'NO PP'#9'F'#9'PP'
          'QTY_KBTHN'#9'8'#9'QTY'#9'F'#9'PP'
          'NO_PO'#9'15'#9'NO PO'#9'F'#9'PO'
          'QTY_PO'#9'8'#9'QTY'#9'F'#9'PO'
          'NO_LPB'#9'15'#9'NO LPB'#9'F'#9'LPB'
          'QTY_LPB'#9'8'#9'QTY'#9'F'#9'LPB'
          'TANGGAL'#9'12'#9'PP'#9'F'#9'TANGGAL'
    ...
    object TabSheet5: TTabSheet
      ...
      object wwDBGrid3: TwwDBGrid
        ...
        Selected.Strings = (
          'NO_NOTA'#9'15'#9'NO NOTA'#9'F'
          'TANGGAL'#9'11'#9'TANGGAL NOTA'#9'F'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from'
        ...
        ' (select no_reg_kebutuhan, no_nota, tanggal, sub_bagian, kd_item' +
        ', nama_item, tgl_kebutuhan, qty, qty_po, sum(qty_lpb) as qty_lpb' +
        ', status, tgl_insert, no_reff, ispost, tgl_update, opr_posting f' +
        'rom'
      
        '  (select * from pmtx02.vkebutuhan_bb_benang where kd_transaksi=' +
        ':kd_transaksi)'
      
        ' group by no_reg_kebutuhan, no_nota, tanggal, sub_bagian, kd_ite' +
        'm, nama_item, tgl_kebutuhan, qty, qty_po, status, tgl_insert, no' +
        '_reff, ispost, tgl_update, opr_posting)'
      ':myparam'
      ''
      ''
      '/*select * from'
      
        '(select * from pmtx02.vkebutuhan_bb_benang where kd_transaksi=:k' +
        'd_transaksi)'
      ':myparam*/')
    Variables.Data = {
      03000000020000000D0000003A4B445F5452414E53414B534905000000040000
      003130310000000000080000003A4D59504152414D01000000110000006F7264
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      525F504F5354494E47010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
  ...
  object QLookSubBagian: TOracleDataSet
    ...
    Variables.Data = {
      ...
      7265206B645F7472616E73616B73693D27313031270000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty) as qty, sum(qty2) as qty2 from pmtx02.vkebutuhan' +
        '_bb_benang'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000002000000030000005154590100000000000400000051545932010000
      000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    BeforeOpen = QBrowseBeforeOpen
  ...
  object QBrowse20: TOracleDataSet
    SQL.Strings = (
      'select * from ('
      ' select * from pmtx04.purchasing_kebutuhan_benang'
      ' where kd_transaksi=:kd_transaksi and no_nota not like '#39'#%'#39
      ')'
      ':myparam')
    Variables.Data = {
      ...
      534905000000040000003130310000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowse200: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select * from pmtx04.purchasing_kebutuhan_benang2' +
        ' where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
      0300000002000000080000003A4D59504152414D01000000110000006F726465
  ...
  object ODSTGL: TOracleDataSet
    SQL.Strings = (
      'select * from (select * from pmtx02.v_tgl_kebutuhan_bb_benang'
      'where kd_transaksi=:kd_transaksi)  '
      ':myparam ')
    Variables.Data = {
      03000000020000000D0000003A4B445F5452414E53414B534905000000040000
