...
var
  LPBbng2Frm: TLPBbng2Frm;

implementation

uses DM, MainBrowse, Main, Menus, XPROCS, DateUtils, Keterangan, Sisdur,
  {LPBDoubeling,} TerimaSementara, LPBNBB;

{$R *.dfm}

procedure TLPBbng2Frm.FormClose(Sender: TObject;
...
procedure TLPBbng2Frm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLPBbng2Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TLPBbng2Frm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TLPBbng2Frm.cbTanggalClick(Sender: TObject);
begin
...
procedure TLPBbng2Frm.QTransaksiAfterPost(DataSet: TDataSet);
begin
//  wwDBGrid2.SetFocus;
...
procedure TLPBbng2Frm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TLPBbng2Frm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QSuplier.Close;
...
procedure TLPBbng2Frm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TLPBbng2Frm.TabSheet2Show(Sender: TObject);
begin
...
procedure TLPBbng2Frm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TLPBbng2Frm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TLPBbng2Frm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TLPBbng2Frm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TLPBbng2Frm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TLPBbng2Frm.QLookLokasiBeforeOpen(DataSet: TDataSet);
begin
  QLookLokasi.SetVariable('kd_jns_item',QDetailKD_JNS_ITEM.AsString);
end;

procedure TLPBbng2Frm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TLPBbng2Frm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TLPBbng2Frm.ECariChange(Sender: TObject);
begin
...
procedure TLPBbng2Frm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TLPBbng2Frm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TLPBbng2Frm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TLPBbng2Frm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TLPBbng2Frm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vnomer:=0;
...
procedure TLPBbng2Frm.BitBtn5Click(Sender: TObject);
begin
...
procedure TLPBbng2Frm.TabSheet1Show(Sender: TObject);
begin
...
procedure TLPBbng2Frm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TLPBbng2Frm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TLPBbng2Frm.FormCloseQuery(Sender: TObject;
...
procedure TLPBbng2Frm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TLPBbng2Frm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
...
procedure TLPBbng2Frm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TLPBbng2Frm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TLPBbng2Frm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TLPBbng2Frm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TLPBbng2Frm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TLPBbng2Frm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TLPBbng2Frm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TLPBbng2Frm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TLPBbng2Frm.BtnExportClick(Sender: TObject);
begin
{azmi}
  case PageControl1.ActivePageIndex of
  0 :
...
procedure TLPBbng2Frm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TLPBbng2Frm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TLPBbng2Frm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TLPBbng2Frm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TLPBbng2Frm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TLPBbng2Frm.LookSuplierCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
var
  vkota : string;
begin
...
procedure TLPBbng2Frm.LookSuplierEnter(Sender: TObject);
begin
QPO.close;
...
procedure TLPBbng2Frm.LookSuplierUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
QPO.Close;
QPO.open;
...
procedure TLPBbng2Frm.LookMUEnter(Sender: TObject);
begin
  DMFrm.QMU.Open;
end;

procedure TLPBbng2Frm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TLPBbng2Frm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
//  QTotal.Close;
...
procedure TLPBbng2Frm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vdpp:=0;
  vppn:=0;
...
procedure TLPBbng2Frm.PageHeaderBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vfirst_page:=False;
end;

procedure TLPBbng2Frm.QBrowseDetailBeforeOpen(DataSet: TDataSet);
begin
//  QBrowseDetail.SetVariable('no_reg_po',QBrowseNO_REG_PO.AsInteger);
end;

procedure TLPBbng2Frm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLPBbng2Frm.QSuplierBeforeOpen(DataSet: TDataSet);
begin
...
procedure TLPBbng2Frm.QDetailCalcFields(DataSet: TDataSet);
begin
...
procedure TLPBbng2Frm.QDetailBeforePost(DataSet: TDataSet);
begin
  QDetailSATUAN.AsString:=QDetailSATUAN2.AsString;
end;

procedure TLPBbng2Frm.LookLokasiEnter(Sender: TObject);
begin
  QLookLokasi.Close;
  QLookLokasi.Open;
end;

procedure TLPBbng2Frm.LookLokasiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TLPBbng2Frm.QPOBeforeOpen(DataSet: TDataSet);
begin
  QPO.SetVariable('NO_NOTA',ENoNota.Text);
end;

procedure TLPBbng2Frm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer);
...
procedure TLPBbng2Frm.BitBtn4Click(Sender: TObject);
begin
...
procedure TLPBbng2Frm.wwDBDateTimePicker1Change(Sender: TObject);
begin
//btnformulasi.Click;
 { if QTransaksi.State<>dsBrowse then
   try
...
procedure TLPBbng2Frm.QTransaksiAfterCancel(DataSet: TDataSet);
begin
wwDBDateTimePicker1.Enabled:=true;
end;

procedure TLPBbng2Frm.Btn_filterClick(Sender: TObject);
...
procedure TLPBbng2Frm.Vtglawal2Change(Sender: TObject);
begin
 vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));

end;

procedure TLPBbng2Frm.Vtglakhir2Change(Sender: TObject);
begin
...
procedure TLPBbng2Frm.dbcfield2Enter(Sender: TObject);
...
procedure TLPBbng2Frm.cbotomatis2Click(Sender: TObject);
begin
...
procedure TLPBbng2Frm.ecari2Change(Sender: TObject);
begin
  if cbOtomatis2.Checked then
  begin
...
procedure TLPBbng2Frm.wwDBGrid3DblClick(Sender: TObject);
...
procedure TLPBbng2Frm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
 if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TLPBbng2Frm.Qbrowse2BeforeOpen(DataSet: TDataSet);
begin
// QBrowse2.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TLPBbng2Frm.TabSheet3Show(Sender: TObject);
begin
...
procedure TLPBbng2Frm.Voperand2Click(Sender: TObject);
begin
{azmi}
  if vOperand2.Caption='LIKE' then
    vOperand2.Caption:='='
...
procedure TLPBbng2Frm.cbtanggal2Click(Sender: TObject);
begin
  if cbTanggal2.Checked then
  begin
...
procedure TLPBbng2Frm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLPBbng2Frm.wwDBGrid4CalcCellColors(Sender: TObject;
  Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
  ABrush: TBrush);
begin
  if not Highlight then
...
procedure TLPBbng2Frm.wwDBGrid4DblClick(Sender: TObject);
var
  vnama_barang_org : String;
  vketerangan_org : String;
  vpos : Integer;
...
procedure TLPBbng2Frm.wwDBGrid4Enter(Sender: TObject);
begin
  if QTransaksi.State<>dsBrowse then
        try
          QTransaksi.Post;
...
procedure TLPBbng2Frm.LookItemEnter(Sender: TObject);
begin
  QLookItem2.Close;
  QLookItem2.Open;
end;

procedure TLPBbng2Frm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TLPBbng2Frm.QDetailAfterQuery(Sender: TOracleDataSet);
begin
{  QDetailKD_ITEM2.AsString:=QDetailKD_ITEM.AsString;
  QDetailKD_proyek.AsString:=QDetailKETERANGAN.AsString;}
end;

procedure TLPBbng2Frm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TLPBbng2Frm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLPBbng2Frm.LookMaklonCloseUp(Sender: TObject; LookupTable,
FillTable: TDataSet; modified: Boolean);
begin
...
procedure TLPBbng2Frm.LookMaklonEnter(Sender: TObject);
begin
QLookMaklonRekanan.CLOSE;
QLookMaklonRekanan.open;
end;

procedure TLPBbng2Frm.LookMaklonUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
QLookMaklonRekanan.Close;
QLookMaklonRekanan.open;
