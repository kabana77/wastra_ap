...
type
  TBonPemakaianBBKimiaFrm = class(TForm)
    Panel1: TPanel;
    ...
    procedure LookMesinUserButton1Click(Sender: TObject;
      LookupTable: TDataSet);
    procedure LookFormulasiUserButton2Click(Sender: TObject;
      LookupTable: TDataSet);
  ...
  private
    ...
    vfilter, vorder, vfilter2, vFF, idsubbag  : String;
  public
    { Public declarations }
...
var
  BonPemakaianBBKimiaFrm: TBonPemakaianBBKimiaFrm;
...
procedure TBonPemakaianBBKimiaFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  BonPemakaianBBKimiaFrm:=Nil;
end;

procedure TBonPemakaianBBKimiaFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TBonPemakaianBBKimiaFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TBonPemakaianBBKimiaFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBonPemakaianBBKimiaFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TBonPemakaianBBKimiaFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TBonPemakaianBBKimiaFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TBonPemakaianBBKimiaFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBBKimiaFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBBKimiaFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBBKimiaFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPemakaianBBKimiaFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TBonPemakaianBBKimiaFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TBonPemakaianBBKimiaFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TBonPemakaianBBKimiaFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TBonPemakaianBBKimiaFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TBonPemakaianBBKimiaFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TBonPemakaianBBKimiaFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TBonPemakaianBBKimiaFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TBonPemakaianBBKimiaFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TBonPemakaianBBKimiaFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TBonPemakaianBBKimiaFrm.ECariChange(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBonPemakaianBBKimiaFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TBonPemakaianBBKimiaFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TBonPemakaianBBKimiaFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBonPemakaianBBKimiaFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TBonPemakaianBBKimiaFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TBonPemakaianBBKimiaFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBonPemakaianBBKimiaFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TBonPemakaianBBKimiaFrm.FormCloseQuery(Sender: TObject;
...
procedure TBonPemakaianBBKimiaFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPemakaianBBKimiaFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TBonPemakaianBBKimiaFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TBonPemakaianBBKimiaFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBonPemakaianBBKimiaFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TBonPemakaianBBKimiaFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TBonPemakaianBBKimiaFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TBonPemakaianBBKimiaFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TBonPemakaianBBKimiaFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TBonPemakaianBBKimiaFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TBonPemakaianBBKimiaFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBonPemakaianBBKimiaFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TBonPemakaianBBKimiaFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBonPemakaianBBKimiaFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TBonPemakaianBBKimiaFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPemakaianBBKimiaFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPemakaianBBKimiaFrm.LookFormulasiEnter(Sender: TObject);
begin
  LookFormulasi.LookupTable.Open;
  {azmi}
        DMFrm.QFormulasiKimia.DisableControls;
        DMFrm.QFormulasiKimia.Close;
        DMFrm.QFormulasiKimia.SetVariable('no','%'+vFF+'%');
        DMFrm.QFormulasiKimia.SetVariable('ket','%'+vFF+'%');
        DMFrm.QFormulasiKimia.Open;
        DMFrm.QFormulasiKimia.EnableControls;
  {azmi}
end;

procedure TBonPemakaianBBKimiaFrm.LookFormulasiUserButton1Click(
...
procedure TBonPemakaianBBKimiaFrm.BtnFormulasiClick(Sender: TObject);
var
  vstok : real;
begin
...
procedure TBonPemakaianBBKimiaFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TBonPemakaianBBKimiaFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPemakaianBBKimiaFrm.LookMesinEnter(Sender: TObject);
begin
  QLookMesin.Open;

end;

procedure TBonPemakaianBBKimiaFrm.LookMesinCloseUp(Sender: TObject;
...
procedure TBonPemakaianBBKimiaFrm.LookMesinUserButton1Click(
  Sender: TObject; LookupTable: TDataSet);
begin
  QLookMesin.Close;
  QLookMesin.Open;
...
procedure TBonPemakaianBBKimiaFrm.LookFormulasiUserButton2Click(
  Sender: TObject; LookupTable: TDataSet);

begin
{azmi}
  if InputQuery('Filter','Filter : ',vFF) then
    begin
        DMFrm.QFormulasiKimia.DisableControls;
        DMFrm.QFormulasiKimia.Close;
        DMFrm.QFormulasiKimia.SetVariable('no','%'+vFF+'%');
...
procedure TBonPemakaianBBKimiaFrm.LookBenangEnter(Sender: TObject);
begin
  DMFrm.QBenang.Open;
end;

procedure TBonPemakaianBBKimiaFrm.vTglAWAL2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TBonPemakaianBBKimiaFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.vOperand2Click(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.cbTanggal2Click(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.BitBtn6Click(Sender: TObject);
begin
...
procedure TBonPemakaianBBKimiaFrm.LookBudgetEnter(Sender: TObject);
var
  vlok : string;
  vidb2: string;
begin
...
procedure TBonPemakaianBBKimiaFrm.LookBudgetCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
{MAA}
