object ValidasiPOInFrm: TValidasiPOInFrm
  Left = 232
  Top = 113
  Width = 1083
  Height = 567
  Caption = 'Validasi Bon Re Use'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        PictureMasks.Strings = (
          ...
          'ID_USER'#9'*3{&,#}'#9'T'#9'T')
        Selected.Strings = (
          'KD_ITEM'#9'10'#9'KODE'#9'T'#9'BAHAN / BARANG'
          'KETERANGAN'#9'58'#9'NAMA/ SPESIFIKASI (ALT)+(K)'#9'T'#9'BAHAN / BARANG'
          'SATUAN'#9'10'#9'SATUAN~STOK'#9'T'#9'BAHAN / BARANG'
          'QTY'#9'11'#9'KG'#9'F'#9'MASUK'
          'QTY_BOX'#9'11'#9'BALL'#9'F'#9'MASUK')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QTransaksi: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0000060000004D414B4C4F4E010000000000}
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      ...
      '  insert into pmtx02.vbon_barang_detail'
        ...
        'ngan, qty_bon, qty_valid, qty, qty_box, id_bag, id_sub_bag, kd_l' +
        'okasi, kk, no_mesin_tenun) (select'
      
        '  :no_reg_pemakaian, :tanggal, no_reg_bon, kd_item, mesin, nama_' +
        'item, qty, qty_validasi, (qty-qty_validasi), qty_box, id_bag, id' +
        '_sub_bag, '#39'0'#39'||kd_jns_item, kk, no_mesin_tenun'
  ...
  object QLookItem: TOracleDataSet
    SQL.Strings = (
        ...
        'select p.kd_item, decode(p.kd_item_lama,'#39'0'#39','#39'B. Baku'#39','#39'1'#39','#39'P/O'#39')' +
        ' AS jenis ,p.nama_item, p.sat1,p.kd_jns_item, p.kelompok as stok' +
        ', p.icc as opname'
      
        'from (select a.kd_item, a.kd_item_lama, a.nama_item, d.sat1,a.kd' +
        '_jns_item, c.kelompok,b.b00, a.icc'
        ...
        #9'((a.kd_jns_item=c.kd_jns_item) and (a.kd_kel=c.kd_kel)) and b.t' +
        'ahun=:tahun and a.kd_satuan=d.kd_satuan and a.kd_item_lama = '#39'1'#39 +
        ') p'
      '/*'
    ...
    Variables.Data = {
      ...
      430000000000060000003A544148554E0300000004000000E107000000000000
      080000003A4D59504152414D01000000150000006F7264657220627920702E6E
      616D615F6974656D0000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      0004000000534154310100000000000400000053544F4B010000000000060000
      004F504E414D45010000000000050000004A454E4953010000000000}
    Session = DMFrm.OS
