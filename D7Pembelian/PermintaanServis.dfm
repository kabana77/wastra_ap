object PermintaanServisFrm: TPermintaanServisFrm
  Left = 211
  Top = 111
  Width = 1177
  Height = 703
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_ITEM'#9'38'#9'NAMA'#9'F'#9'ITEM YANG DISERVIS'
          'KD_SERVIS'#9'3'#9'KODE'#9'F'#9'SERVIS'
          'NAMA_SERVIS'#9'35'#9'NAMA'#9'F'#9'SERVIS'
          'BAGIAN'#9'50'#9'BAGIAN'#9'F'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KETERANGAN'#9'46'#9'NAMA / SPESIFIKASI (ALT)+(K)'#9'T'#9'BARANG/ BAHAN'
          'QTY'#9'3'#9'JML'#9'F'
          'KD_SERVIS'#9'10'#9'KODE'#9'F'#9'SERVIS'
          'NAMA_SERVIS'#9'36'#9'NAMA'#9'T'#9'SERVIS'
    ...
    object TabSheet3: TTabSheet
      ...
      object wwDBGrid20: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_ITEM'#9'38'#9'NAMA'#9'F'#9'ITEM YANG DISERVIS'
          'KD_SERVIS'#9'3'#9'KODE'#9'F'#9'SERVIS'
          'NAMA_SERVIS'#9'30'#9'NAMA'#9'F'#9'SERVIS'
          'JENIS'#9'10'#9'JENIS'#9'F'
          'KD_REKANAN'#9'10'#9'KODE'#9'F'#9'REKANAN'
          'NAMA_REKANAN'#9'50'#9'NAMA'#9'F'#9'REKANAN'
          'TANGGAL_PO'#9'10'#9'TANGGAL'#9'F'#9'DATA PO'
          'NO_PO'#9'20'#9'NO. PO'#9'F'#9'DATA PO')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QTransaksi: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.permintaan_servis a'
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.servis_detail a'
    ...
    object QDetailNAMA_SERVIS: TStringField
      ...
      LookupDataSet = QLookServis
      LookupKeyFields = 'KD_SERVIS'
      LookupResultField = 'NAMA_SERVIS'
      KeyFields = 'KD_SERVIS'
      Size = 50
      Lookup = True
    end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from (select * from pmtx02.vpermintaan_servis'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
  ...
  object QBrowse2: TOracleDataSet
    SQL.Strings = (
      'select * from (select * from pmtx02.vpermintaan_servis_x)'
      ':myparam')
    Variables.Data = {
