...
//              showmessage(QCari_NO_PONO_PO.AsString);
...
{              QDetail.DisableControls;
              QDetail.Close;
//              QDetail.DeclareVariable('no_reg_hutang',otInteger);
              QDetail.SQL.Text:='select a.kd_item, a.qty_po, a.qty_lpb, a.qty, a.satuan, a.rasio, a.harga,'+
                                'a.disc, a.harga2, a.disc2, a.sub_total2, a.dpp2, a.ppn2, a.total2, a.no_reg_po,'+
                                'a.keterangan, a.satuan_po, a.ispilih, a.tgl_jth_tempo, a.rowid, b.no_nota as no_po,'+
                                'c.no_nota as no_lpb, c.no_surat_jalan'+
                                ' from pmtx02.lpb_detail@PISMASBY a'+
                                ' left outer join pmtx02.po@PISMASBY b on (a.no_reg_po=b.no_reg_po)'+
                                ' left outer join pmtx02.lpb@PISMASBY c on (a.no_reg_lpb=c.no_reg_lpb)'+
                                ' where no_reg_hutang = :no_reg_hutang'+
                                ' order by a.tgl_insert';
...
begin
// vLokStat:=copy(ENoNota.Text,11,1);
  if QTransaksiISPUSAT.AsString='W' then
  begin
