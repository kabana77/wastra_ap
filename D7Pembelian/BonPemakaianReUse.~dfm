object BonPemakaianWasteFrm: TBonPemakaianWasteFrm
  Left = 390
  Top = 484
  Width = 1126
  Height = 611
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KELOMPOK'#9'30'#9'KELOMPOK'#9'F'#9'ITEM BARANG'
          ...
          'KK'#9'12'#9'Spinning'#9'F'#9'PENEMPATAN'
          'NO_MESIN_TENUN'#9'8'#9'Line'#9'F'#9'PENEMPATAN')
    ...
    object TabSheet2: TTabSheet
      ...
      object LookBudget: TwwDBLookupComboDlg
        ...
        DataField = 'KD_BIAYA'
        DataSource = dsQDetail
        LookupTable = DMFrm.QLookBudgetBon
      ...
      object LookBagian2: TwwDBLookupComboDlg
        Left = 96
        Top = 216
        Width = 121
        Height = 21
        ...
        ShowButton = True
        AllowClearKey = False
        OnCloseUp = LookBagian2CloseUp
        OnEnter = LookBagian2Enter
      end
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'ID_BAG;CustomEdit;LookBagian2;F'
          'KD_JNS_KEBUTUHAN;CustomEdit;LookJnsKebutuhan;F'
          'MESIN;CustomEdit;LookMesin;F'
          'KD_BIAYA;CustomEdit;LookBudget;F'
          'KK;CustomEdit;LookLokTujuan;F'
          'NO_MESIN_TENUN;CustomEdit;LookLine;F'
          'KD_ITEM2;CustomEdit;LookLOT;F')
        PictureMasks.Strings = (
          'ID_BAG'#9'*2{#,&}'#9'T'#9'T'
          'KD_JNS_ITEM'#9'#,&'#9'T'#9'T'
          'KD_SATUAN'#9'#,&'#9'T'#9'T'
        ...
        Selected.Strings = (
          ...
          'KD_ITEM'#9'10'#9'KODE'#9'F'#9'BARANG/ BAHAN'
          'KETERANGAN'#9'48'#9'NAMA/ SPESIFIKASI (ALT)+(K)'#9'T'#9'BARANG/ BAHAN'
          'KELOMPOK'#9'30'#9'KELOMPOK'#9'T'#9'BARANG/ BAHAN'
          'SATUAN'#9'10'#9'SATUAN'#9'T'#9'BARANG/ BAHAN'
          'QTY_STOK'#9'8'#9'STOK~SAAT INI'#9'T'
          'QTY_BON'#9'10'#9'BON~BULAN INI'#9'T'
          'QTY'#9'8'#9'JUMLAH~DIMINTA'#9'F'
          'KK'#9'10'#9'Spinning'#9'F'#9'PENEMPATAN'
          'NO_MESIN_TENUN'#9'6'#9'Line'#9'F'#9'PENEMPATAN'
          'MESIN'#9'8'#9'MESIN'#9'F'
          'KD_ITEM2'#9'15'#9'NO. LOT'#9'F'
          'KD_BIAYA'#9'15'#9'KODE~BIAYA'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
      ...
      object LookLokTujuan: TwwDBComboBox
        ...
        ItemHeight = 0
        Items.Strings = (
          'SPINING 1'#9'SPINING1M'
          'SPINING 2'#9'SPINING2M'
          'SPINING 3'#9'SPINING3M')
        ParentFont = False
        Sorted = False
        TabOrder = 10
        UnboundDataType = wwDefault
  ...
  object QTransaksi: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0000004A4E535F4B4F52454B5349010000000000090000004B445F42454E414E
      470100000000000A0000004A4D4C5F535052494E47010000000000060000004C
      4F4B4153490100000000000700000049535055534154010000000000}
    ...
    object QTransaksiLOKASI: TStringField
      FieldName = 'LOKASI'
      Size = 1
    end
  ...
  object QDetail: TOracleDataSet
    ...
    Variables.Data = {
      ...
      000000}
    QBEDefinition.QBEFieldDefs = {
      040000001C000000070000004B445F4954454D0100000000000A0000004B4554
      ...
      
      010000000000}
    Master = QTransaksi
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000230000000C0000004B445F5452414E53414B53490100000000000700
      ...
      
      ...
      0000080000004B454C4F4D504F4B010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    ...
    object QBrowseKK: TStringField
      FieldName = 'KK'
      Size = 10
    end
    object QBrowseNO_MESIN_TENUN: TStringField
      FieldName = 'NO_MESIN_TENUN'
      Size = 50
    end
  end
  ...
  object QLookSubBagian: TOracleDataSet
    ...
    Variables.Data = {
      ...
      7265206B645F7472616E73616B73693D27423038270000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object ODSTGL: TOracleDataSet
    SQL.Strings = (
      'select * from (select * from pmtx02.v_tgl_bon_bb_benang'
      'where kd_transaksi=:kd_transaksi)  '
      ':myparam ')
    Variables.Data = {
      03000000020000000D0000003A4B445F5452414E53414B534905000000040000
      004230350000000000080000003A4D59504152414D01000000110000006F7264
      6572206279204E4F5F4E4F54410000000000}
    QBEDefinition.QBEFieldDefs = {
