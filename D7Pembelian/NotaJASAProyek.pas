...
type
  TNotaJasaProyekFrm = class(TForm)
    Panel1: TPanel;
...
var
  NotaJasaProyekFrm: TNotaJasaProyekFrm;
...
procedure TNotaJasaProyekFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  NotaJasaProyekFrm:=Nil;
end;

procedure TNotaJasaProyekFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TNotaJasaProyekFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TNotaJasaProyekFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TNotaJasaProyekFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
//  wwDBGrid2.SetFocus;
...
procedure TNotaJasaProyekFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
//      QTransaksiNILAI.AsFloat:=QTotalSUB_TOTAL.AsFloat+QTotal2TOT_BIAYA_LAIN.AsFloat;
  end;
end;

procedure TNotaJasaProyekFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TNotaJasaProyekFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TNotaJasaProyekFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TNotaJasaProyekFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TNotaJasaProyekFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TNotaJasaProyekFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TNotaJasaProyekFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TNotaJasaProyekFrm.ECariChange(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TNotaJasaProyekFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TNotaJasaProyekFrm.FormShow(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vnomer:=0;
...
procedure TNotaJasaProyekFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TNotaJasaProyekFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TNotaJasaProyekFrm.FormCloseQuery(Sender: TObject;
...
procedure TNotaJasaProyekFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TNotaJasaProyekFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
...
procedure TNotaJasaProyekFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
//  vdpp:=vdpp+QDetailDPP2.AsFloat;
 // vppn:=vppn+QDetailPPN2.AsFloat;
  vtotal:=vtotal+QDetailTX.AsFloat;
end;

procedure TNotaJasaProyekFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TNotaJasaProyekFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TNotaJasaProyekFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TNotaJasaProyekFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TNotaJasaProyekFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TNotaJasaProyekFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TNotaJasaProyekFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TNotaJasaProyekFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TNotaJasaProyekFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TNotaJasaProyekFrm.BtnFormulasiClick(Sender: TObject);
begin
  if ((QTransaksiKD_REKANAN.AsString='') OR  (ENoNota.Text='')) OR ((QTransaksiMU.AsString='') OR (QTransaksiKD_PERK.AsString='') OR (QTransaksiTERMIN.AsString='')) then
    ShowMessage('Rekanan, Jenis Hutang, Termin dan Mata Uang harus diisi !')
    else
    begin
        if (QTransaksiISPOST.AsString='0') then
        begin
...
procedure TNotaJasaProyekFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TNotaJasaProyekFrm.LookMUEnter(Sender: TObject);
begin
  DMFrm.QMU.Open;
end;

procedure TNotaJasaProyekFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  ...
  QTotal.Open;
  wwDBGrid2.ColumnByName('TX').FooterValue:=FormatFloat('#,##0.##;(#,##0.##)',QTotalDPP.AsFloat);
  end;
  if QTotal2.Active then
  LTotalHutang.Caption:=FormatFloat('#,##0.##;(#,##0.##)',QTotalTOTAL.AsFloat+QTotal2TOT_BIAYA_LAIN.AsFloat);
end;

procedure TNotaJasaProyekFrm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vdpp:=0;
  vppn:=0;
...
procedure TNotaJasaProyekFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if vfirst_page then
  begin
...
procedure TNotaJasaProyekFrm.PageHeaderBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vfirst_page:=False;
end;

procedure TNotaJasaProyekFrm.QBrowseDetailBeforeOpen(DataSet: TDataSet);
begin
//  QBrowseDetail.SetVariable('no_reg_po',QBrowseNO_REG_PO.AsInteger);
end;

procedure TNotaJasaProyekFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer);
...
procedure TNotaJasaProyekFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer2);
...
procedure TNotaJasaProyekFrm.LookSuplierEnter(Sender: TObject);
begin
  QSuplier.Open;
end;

procedure TNotaJasaProyekFrm.LookSuplierCloseUp(Sender: TObject;
...
procedure TNotaJasaProyekFrm.LookSuplierUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QSuplier.Close;
  QSuplier.Open;
...
procedure TNotaJasaProyekFrm.QJurnalNewRecord(DataSet: TDataSet);
begin
...
procedure TNotaJasaProyekFrm.wwDBGrid3UpdateFooter(Sender: TObject);
begin
  QTotal2.Close;
  ...
  LTotalHutang.Caption:=FormatFloat('#,##0.##;(#,##0.##)',QTotalTOTAL.AsFloat+QTotal2TOT_BIAYA_LAIN.AsFloat);
//  LTotalHutang.Caption:=FormatFloat('#,##0.##;(#,##0.##)',QTotalSubTOTAL.AsFloat+QTotal2TOT_BIAYA_LAIN.AsFloat);
end;

procedure TNotaJasaProyekFrm.QTotalBeforeOpen(DataSet: TDataSet);
var
  vsql : String;
begin
    if QTransaksiPPN.AsString='-' then
       vsql:='select sum(tx) as total, sum(tx) as dpp, 0 as ppn from pmtx02.hutang_jasa '+
        'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if QTransaksiPPN.AsString='INC' then
       vsql:='select (sum(tx)/1.1)+((sum(tx)/1.1)*0.1) as total, sum(tx)/1.1 as dpp, (sum(tx)/1.1)*0.1 as ppn from pmtx02.hutang_jasa '+
        'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if QTransaksiPPN.AsString='EXC' then
       vsql:='select sum(tx)+(sum(tx)*0.1) as total, sum(tx) as dpp, sum(tx)*0.1 as ppn from pmtx02.hutang_jasa '+
        'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString;


{    if (QTransaksiPPN.AsString='-') and (QTransaksiTERMIN.AsString='1') then
       vsql:='select sum(qty*harga)/100*25 as total, sum(qty*harga)/100*25 as dpp, 0 as ppn from pmtx02.hutang_jasa '+
       'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='-') and (QTransaksiTERMIN.AsString='2') then
       vsql:='select sum(qty*harga)/100*25 as total, sum(qty*harga)/100*25 as dpp, 0 as ppn from pmtx02.hutang_jasa '+
       'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='-') and (QTransaksiTERMIN.AsString='3') then
       vsql:='select sum(qty*harga)/100*45 as total, sum(qty*harga)/100*45 as dpp, 0 as ppn from pmtx02.hutang_jasa '+
       'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='-') and (QTransaksiTERMIN.AsString='4') then
       vsql:='select sum(qty*harga)/100*5 as total, sum(qty*harga)/100*5 as dpp, 0 as ppn from pmtx02.hutang_jasa '+
       'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='EXC') and (QTransaksiTERMIN.AsString='1') then
       vsql:='select (sum(qty*harga)+sum(((qty*harga)/100)*10))/100*25 as total, (sum(qty*harga))/100*25 as dpp, (sum(((qty*harga)/100)*10))/100*25 as ppn from pmtx02.hutang_jasa '+
       'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='EXC') and (QTransaksiTERMIN.AsString='2') then
       vsql:='select (sum(qty*harga)+sum(((qty*harga)/100)*10))/100*25 as total, (sum(qty*harga))/100*25 as dpp, (sum(((qty*harga)/100)*10))/100*25 as ppn from pmtx02.hutang_jasa '+
       'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='EXC') and (QTransaksiTERMIN.AsString='3') then
       vsql:='select (sum(qty*harga)+sum(((qty*harga)/100)*10))/100*45 as total, (sum(qty*harga))/100*45 as dpp, (sum(((qty*harga)/100)*10))/100*45 as ppn from pmtx02.hutang_jasa '+
       'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='EXC') and (QTransaksiTERMIN.AsString='4') then
       vsql:='select (sum(qty*harga)+sum(((qty*harga)/100)*10))/100*5 as total, (sum(qty*harga))/100*5 as dpp, (sum(((qty*harga)/100)*10))/100*5 as ppn from pmtx02.hutang_jasa '+
       'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='INC') and (QTransaksiTERMIN.AsString='1') then
       vsql:='select (sum(qty*harga)+sum(((qty*harga)/100)*10))/100*25 as total, (sum(qty*harga))/100*25 as dpp, (sum(((qty*harga)/100)*10)/100*25 as ppn from pmtx02.hutang_jasa '+
        'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='INC') and (QTransaksiTERMIN.AsString='2') then
       vsql:='select (sum(qty*harga)+sum(((qty*harga)/100)*10))/100*25 as total, (sum(qty*harga))/100*25 as dpp, (sum(((qty*harga)/100)*10)/100*25 as ppn from pmtx02.hutang_jasa '+
        'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='INC') and (QTransaksiTERMIN.AsString='3') then
       vsql:='select (sum(qty*harga)+sum(((qty*harga)/100)*10))/100*45 as total, (sum(qty*harga))/100*45 as dpp, (sum(((qty*harga)/100)*10)/100*45 as ppn from pmtx02.hutang_jasa '+
        'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString
    else if (QTransaksiPPN.AsString='INC') and (QTransaksiTERMIN.AsString='4') then
       vsql:='select (sum(qty*harga)+sum(((qty*harga)/100)*10))/100*5 as total, (sum(qty*harga))/100*5 as dpp, (sum(((qty*harga)/100)*10)/100*5 as ppn from pmtx02.hutang_jasa '+
        'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString; }
...
{    if QTransaksiPPN.AsString='-' then
  ...
  { vsql:='select sum(qty*harga) as total from pmtx02.hutang_jasa '+
        'where no_reg_hutang='+QTransaksiNO_REG_HUTANG.AsString;}
   QTotal.SQL.Text:=VSQL;
end;

procedure TNotaJasaProyekFrm.LookPerkiraanEnter(Sender: TObject);
begin
  QPerkiraan.Open;
end;

procedure TNotaJasaProyekFrm.LookPerkiraanHPEnter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TNotaJasaProyekFrm.LookMUCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TNotaJasaProyekFrm.BitBtn3Click(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TNotaJasaProyekFrm.QRBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
...
begin
  ...
  begin
      ...
      vtotal2:=(vdpp+vlain)-vum;
  end
  else
  if QTransaksiPPN.AsString='INC' then
  begin
      vum:=QTransaksiUM.AsFloat;
      vdpp:= vtotal/1.1; {(vlain+Vtotal)/1.1;}
      vppn:= vtotal-vdpp;{vdpp*0.1;}
      vtotal2:=((vdpp+vlain)+vppn)-vum;
  end
  else
  if QTransaksiPPN.AsString='EXC' then
  begin
      vum:=QTransaksiUM.AsFloat;
      vdpp:=vtotal;{vlain+Vtotal;}
      vppn:=vdpp*0.1;
      vtotal2:=((vdpp+vlain)+vppn)-vum;
  end;
//  QRLDPP.Caption:=FormatFloat('#.#,#;(#.#,#)',vdpp);
//  QRLPPN.Caption:=FormatFloat('#.#,#;(#.#,#)',QTotalPPN.AsFloat);
//  QRLTOTAL9.Caption:=FormatFloat('#.#,#;(#.#,#)',{vtotal2}QTotalTOTAL.AsFloat+QTotal2TOT_BIAYA_LAIN.AsFloat);
  ...
  QRLTOTAL9.Caption:=FormatFloat('#,#0.#0;(#,#0.#0)',vtotal2);
   ...
   if QTransaksiMU.AsString='IDR' then
  begin
//     DMFrm.MyRupiah.Nilai:=QTotalTOTAL.AsFloat+QTotal2TOT_BIAYA_LAIN.AsFloat{Vlain+vtotal};
  ...
  begin
    //DMFrm.MyUSD.Nilai:=QTotalTOTAL.AsFloat+QTotal2TOT_BIAYA_LAIN.AsFloat{Vlain+vtotal};
    DMFrm.MyRupiah.Nilai:=vtotal2;
     QRLTerbilang.Caption:='Terbilang : #'+DMFrm.MyUSD.HasilKonversi+'#';
  end;

{//QRLTOTAL.Caption:=FormatFloat('#,##0.##;(#,##0.##)',QTotalPPN.AsFloat+QTotalDPP.AsFloat);
if not QTotal2.IsEmpty then
begin
   vum:=QTransaksiUM.AsFloat;
   vlain:=QTotal2TOT_BIAYA_LAIN.AsFloat;
...
//  QRLDPP.Caption:=FormatFloat('#.#,#;(#.#,#)',vdpp);
//  QRLPPN.Caption:=FormatFloat('#.#,#;(#.#,#)',QTotalPPN.AsFloat);
//  QRLTOTAL9.Caption:=FormatFloat('#.#,#;(#.#,#)',QTotalTOTAL.AsFloat+QTotal2TOT_BIAYA_LAIN.AsFloat);
  QRLTOTAL.Caption:=FormatFloat('#,#0.#0;(#,#0.#0)',vdpp+vppn);
  QRDPP.Caption:=FormatFloat('#,#0.#0;(#,#0.#0)',vdpp);
  QRLPPN.Caption:=FormatFloat('#,#0.#0;(#,#0.#0)',vppn);
  QRLTOTAL9.Caption:=FormatFloat('#,#0.#0;(#,#0.#0)',vtotal2);
  ...
  if QTransaksiMU.AsString='IDR' then
  begin
//     DMFrm.MyRupiah.Nilai:=QTotalTOTAL.AsFloat+QTotal2TOT_BIAYA_LAIN.AsFloat;
     DMFrm.MyRupiah.Nilai:=vtotal2;
     QRLTerbilang.Caption:='Terbilang : #'+DMFrm.MyRupiah.HasilKonversi+'#';
  end
  else if QTransaksiMU.AsString='USD' then
...
procedure TNotaJasaProyekFrm.QDetailCalcFields(DataSet: TDataSet);
begin
Qdetailsub_total.AsFloat:=qdetailharga.AsFloat*qdetailqty.Asfloat;
// Qdetailsub_total.AsFloat:=qdetailharga.AsFloat*qdetailqty.Asfloat;
{if QTransaksiTERMIN.AsInteger = 1 then
begin
   Qdetailsub_total.AsFloat:=QDetailT1.AsFloat;
end
else if QTransaksiTERMIN.AsInteger = 2 then
begin
   Qdetailsub_total.AsFloat:=QDetailT2.AsFloat;
end
else if QTransaksiTERMIN.AsInteger = 3 then
begin
   Qdetailsub_total.AsFloat:=QDetailT3.AsFloat;
end
else if QTransaksiTERMIN.AsInteger = 4 then
begin
   Qdetailsub_total.AsFloat:=QDetailT4.AsFloat;
end
else
begin
   Qdetailsub_total.AsFloat:=qdetailharga.AsFloat*qdetailqty.Asfloat;
...
procedure TNotaJasaProyekFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
...
procedure TNotaJasaProyekFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
   QSuplier.Close;
...
procedure TNotaJasaProyekFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
//QTransaksiKD_TRANSAKSI2.AsString:=QJnsTransaksiKD_TRANSAKSI.AsString;
QTransaksiKD_TRANSAKSI.AsString:=QJnsTransaksiKD_TRANSAKSI.AsString;
end;

procedure TNotaJasaProyekFrm.wwDBGrid10TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TNotaJasaProyekFrm.VTglAwal10Change(Sender: TObject);
begin
  vTglAkhir10.Date:=Trunc(EndOfTheMonth(VTglAwal10.Date));

end;

procedure TNotaJasaProyekFrm.vTglAkhir10Change(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.cbOtomatis10Click(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.dbcField10Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TNotaJasaProyekFrm.vOperand10Click(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.cbTanggal10Click(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.ECari10Change(Sender: TObject);
begin
  if cbOtomatis10.Checked then
  begin
...
procedure TNotaJasaProyekFrm.BitBtn6Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
...
procedure TNotaJasaProyekFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.cbOtomatis100Click(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.dbcField100Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TNotaJasaProyekFrm.vOperand100Click(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.ECari100Change(Sender: TObject);
begin
  if cbOtomatis100.Checked then
  begin
...
procedure TNotaJasaProyekFrm.TabSheet4Show(Sender: TObject);
begin
...
procedure TNotaJasaProyekFrm.wwDBGrid100TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TNotaJasaProyekFrm.BitBtn7Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TNotaJasaProyekFrm.LookPPNChange(Sender: TObject);
begin
{azmi
...
procedure TNotaJasaProyekFrm.LookBudgetEnter(Sender: TObject);
var
  vlok : string;
  vidb2: string;
begin
...
procedure TNotaJasaProyekFrm.BitBtn9Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vmu, vrgTanggal : String;
...
procedure TNotaJasaProyekFrm.TabSheet5Show(Sender: TObject);
begin
QInvoice.Open;
end;
