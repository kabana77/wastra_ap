...
type
  TNotaLainFrm = class(TForm)
    ...
    QDetailTGL_JADWAL_BAYAR: TDateTimeField;
    QDetailNILAI: TFloatField;
    QDetailSTATUS: TStringField;
    QDetailOPR_INSERT: TStringField;
    QDetailKD_PERK_BAYAR: TStringField;
    QDetailNO_REG_HT: TIntegerField;
    Label1: TLabel;
    Label17: TLabel;
    ...
    QBrowseNO_REG_HT: TIntegerField;
...
procedure TNotaLainFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TNotaLainFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TNotaLainFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
