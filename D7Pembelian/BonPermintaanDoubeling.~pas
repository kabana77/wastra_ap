...
type
  TBonPermintaanDoubelingFrm = class(TForm)
    Panel1: TPanel;
    ...
    QDetailNAMA_ITEM2: TStringField;
    LookItem2: TwwDBLookupComboDlg;
    QBrowseKD_ITEM2: TStringField;
...
var
  BonPermintaanDoubelingFrm: TBonPermintaanDoubelingFrm;
...
procedure TBonPermintaanDoubelingFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  BonPermintaanDoubelingFrm:=Nil;
end;

procedure TBonPermintaanDoubelingFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TBonPermintaanDoubelingFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TBonPermintaanDoubelingFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBonPermintaanDoubelingFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TBonPermintaanDoubelingFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TBonPermintaanDoubelingFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TBonPermintaanDoubelingFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TBonPermintaanDoubelingFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TBonPermintaanDoubelingFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPermintaanDoubelingFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TBonPermintaanDoubelingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TBonPermintaanDoubelingFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TBonPermintaanDoubelingFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPermintaanDoubelingFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TBonPermintaanDoubelingFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TBonPermintaanDoubelingFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TBonPermintaanDoubelingFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TBonPermintaanDoubelingFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TBonPermintaanDoubelingFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TBonPermintaanDoubelingFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TBonPermintaanDoubelingFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TBonPermintaanDoubelingFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TBonPermintaanDoubelingFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TBonPermintaanDoubelingFrm.ECariChange(Sender: TObject);
begin
...
procedure TBonPermintaanDoubelingFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBonPermintaanDoubelingFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
//    vorder:=' order by '+wwDBGrid1.Columns[0].FieldName;
  ...
  QTotal.Open;
  wwDBGrid1.ColumnByName('QTY').FooterValue:=FormatFloat('#,##0.##;(#,##0.##)',QTotalQTY.AsFloat);
  wwDBGrid1.ColumnByName('QTY_VALIDASI').FooterValue:=FormatFloat('#,##0.##;(#,##0.##)',QTotalQTY_VALIDASI.AsFloat);
  wwDBGrid1.ColumnByName('QTY2').FooterValue:=FormatFloat('#,##0.######;(#,##0.######); ',QTotalQTY.AsFloat/cball2kg);
  wwDBGrid1.ColumnByName('QTY_VALIDASI2').FooterValue:=FormatFloat('#,##0.######;(#,##0.######); ',QTotalQTY_VALIDASI.AsFloat/cball2kg);

end;

procedure TBonPermintaanDoubelingFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TBonPermintaanDoubelingFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBonPermintaanDoubelingFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TBonPermintaanDoubelingFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TBonPermintaanDoubelingFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TBonPermintaanDoubelingFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TBonPermintaanDoubelingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBonPermintaanDoubelingFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TBonPermintaanDoubelingFrm.FormCloseQuery(Sender: TObject;
...
procedure TBonPermintaanDoubelingFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPermintaanDoubelingFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TBonPermintaanDoubelingFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TBonPermintaanDoubelingFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBonPermintaanDoubelingFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBonPermintaanDoubelingFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TBonPermintaanDoubelingFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TBonPermintaanDoubelingFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TBonPermintaanDoubelingFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TBonPermintaanDoubelingFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TBonPermintaanDoubelingFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TBonPermintaanDoubelingFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBonPermintaanDoubelingFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TBonPermintaanDoubelingFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBonPermintaanDoubelingFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TBonPermintaanDoubelingFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPermintaanDoubelingFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPermintaanDoubelingFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TBonPermintaanDoubelingFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailQTY_STOK2.AsFloat:=QDetailQTY_STOK.AsFloat/cball2kg;
  QDetailQTY_BON2.AsFloat:=QDetailQTY_BON.AsFloat/cball2kg;
end;

procedure TBonPermintaanDoubelingFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPermintaanDoubelingFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseQTY2.AsFloat:=QBrowseQTY.AsFloat/cball2kg;
  QBrowseQTY_VALIDASI2.AsFloat:=QBrowseQTY_VALIDASI.AsFloat/cball2kg;
end;

procedure TBonPermintaanDoubelingFrm.QTotalBeforeOpen(DataSet: TDataSet);
begin
  QTotal.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBonPermintaanDoubelingFrm.LookItem2Enter(
  Sender: TObject);
begin
  QLookItem.Open;
end;
