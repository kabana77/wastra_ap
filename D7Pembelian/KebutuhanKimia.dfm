object KebutuhanKimiaFrm: TKebutuhanKimiaFrm
  Left = 267
  Top = 284
  Width = 1629
  Height = 756
      ...
      object QuickRep2: TQuickRep
        ...
        object QRGroup1: TQRGroup
          ...
          Size.Values = (
            0.000000000000000000
            1923.520833333334000000)
          Expression = 'QTransaksi.NO_REG_KEBUTUHAN'
          FooterBand = QRBand1
          Master = QuickRep2
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KETERANGAN'#9'42'#9'NAMA / SPESIFIKASI (ALT)+(K)'#9'T'#9'BARANG/ BAHAN'
  ...
  object QBrowse: TOracleDataSet
    ...
    object QBrowseCQTY: TFloatField
      FieldKind = fkCalculated
      FieldName = 'CQTY'
      DisplayFormat = '#,##0.##;(#,##0.##)'
      Calculated = True
    end
    object QBrowseCQTY_PO: TFloatField
      FieldKind = fkCalculated
      FieldName = 'CQTY_PO'
      DisplayFormat = '#,##0.##;(#,##0.##)'
      Calculated = True
    end
    object QBrowseCQTY_LPB: TFloatField
      FieldKind = fkCalculated
      FieldName = 'CQTY_LPB'
      DisplayFormat = '#,##0.##;(#,##0.##)'
      Calculated = True
  ...
  object QLookSubBagian: TOracleDataSet
    ...
    Variables.Data = {
      ...
      7265206B645F7472616E73616B73693D27313032270000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QAmbilFormulasi: TOracleQuery
    SQL.Strings = (
      ...
      '  insert into pmtx02.kebutuhan_detail'
        ...
        'sub_bag, :konstanta*qty, :tgl_kebutuhan,:opr_insert,'#39'1'#39' from pmt' +
  ...
  object QBrowse20: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select * from pmtx04.purchasing_kebutuhan_kimia w' +
    ...
    Variables.Data = {
      ...
      534905000000040000003130320000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowse200: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select * from pmtx04.purchasing_kebutuhan_kimia2 ' +
        'where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
      0300000002000000080000003A4D59504152414D01000000110000006F726465
