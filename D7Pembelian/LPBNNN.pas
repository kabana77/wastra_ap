...
type
  TLPBNNNFrm = class(TForm)
    ...
    QLookItemNO_REG_PO: TIntegerField;
    QLookItemNO_NOTA: TStringField;
    QLookItemKD_REKANAN: TStringField;
    QLookItemNO_REG_KEBUTUHAN: TIntegerField;
    QLookItemKD_ITEM: TStringField;
    QLookItemNO_REG_PP: TIntegerField;
    QLookItemKETERANGAN: TStringField;
    QLookItemQTY_PO: TFloatField;
    QLookItemSATUAN_PO: TStringField;
    QLookItemQTY_LPB: TFloatField;
    QLookItemRASIO: TFloatField;
    QLookItemMU: TStringField;
    QLookItemHARGA: TFloatField;
    QLookItemSUB_TOTAL: TFloatField;
    QLookItemDPP: TFloatField;
    QLookItemPPN: TFloatField;
    QLookItemTOTAL: TFloatField;
    QLookItemISPILIH: TStringField;
    QLookItemDISC: TFloatField;
...
procedure TLPBNNNFrm.FormClose(Sender: TObject;
...
procedure TLPBNNNFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TLPBNNNFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLPBNNNFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TLPBNNNFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TLPBNNNFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TLPBNNNFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TLPBNNNFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TLPBNNNFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QSuplier.Close;
...
procedure TLPBNNNFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TLPBNNNFrm.TabSheet2Show(Sender: TObject);
begin
  wwDBGrid2.RowHeightPercent:=Round(vHeight.Value);
  QTransaksi.Close;
  QTransaksi.SetVariable('no_reg_po',QBrowseNO_REG_LPB.AsInteger);
  QTransaksi.Open;
  QDetail.Open;
...
procedure TLPBNNNFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TLPBNNNFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TLPBNNNFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TLPBNNNFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TLPBNNNFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TLPBNNNFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_kebutuhan',vkd_jns_kebutuhan);
end;

procedure TLPBNNNFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TLPBNNNFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TLPBNNNFrm.ECariChange(Sender: TObject);
begin
...
procedure TLPBNNNFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TLPBNNNFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TLPBNNNFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TLPBNNNFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TLPBNNNFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vnomer:=0;
...
procedure TLPBNNNFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TLPBNNNFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TLPBNNNFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TLPBNNNFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TLPBNNNFrm.FormCloseQuery(Sender: TObject;
...
procedure TLPBNNNFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TLPBNNNFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TLPBNNNFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TLPBNNNFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TLPBNNNFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TLPBNNNFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TLPBNNNFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TLPBNNNFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TLPBNNNFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TLPBNNNFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TLPBNNNFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TLPBNNNFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TLPBNNNFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TLPBNNNFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TLPBNNNFrm.BtnFormulasiClick(Sender: TObject);
begin
  if (ENoNota.Text='') and (QTransaksiKD_REKANAN.AsString='')  then
    ShowMessage('No. PO harus diisi !')
    else
    begin
        if (QTransaksiISPOST.AsString='0') then
        begin
...
procedure TLPBNNNFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TLPBNNNFrm.LookSuplierCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
{
    QTransaksiREKANAN.AsString:=QSuplierNAMA_REKANAN.AsString;
    if QSuplierALAMAT.AsString<>'' then
       QTransaksiREKANAN.AsString:=QTransaksiREKANAN.AsString+#13+QSuplierALAMAT.AsString;
    if QSuplierKOTA.AsString<>'' then
       QTransaksiREKANAN.AsString:=QTransaksiREKANAN.AsString+#13+QSuplierKOTA.AsString;
    if QSuplierTELEPON.AsString<>'' then
       QTransaksiREKANAN.AsString:=QTransaksiREKANAN.AsString+#13+QSuplierTELEPON.AsString;
}
       DBMemo2.Lines.Clear;
...
procedure TLPBNNNFrm.LookSuplierEnter(Sender: TObject);
begin
  QSuplier.Open;
end;

procedure TLPBNNNFrm.LookSuplierUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QSuplier.Close;
  QSuplier.Open;
...
procedure TLPBNNNFrm.LookMUEnter(Sender: TObject);
begin
  DMFrm.QMU.Open;
end;

procedure TLPBNNNFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailISPILIH.AsString:='0';
end;

procedure TLPBNNNFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TLPBNNNFrm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vdpp:=0;
  vppn:=0;
...
procedure TLPBNNNFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if vfirst_page then
  begin
...
procedure TLPBNNNFrm.PageHeaderBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vfirst_page:=False;
end;

procedure TLPBNNNFrm.QBrowseDetailBeforeOpen(DataSet: TDataSet);
begin
//  QBrowseDetail.SetVariable('no_reg_po',QBrowseNO_REG_PO.AsInteger);
end;

procedure TLPBNNNFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer);
...
procedure TLPBNNNFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer2);
...
procedure TLPBNNNFrm.QSuplierBeforeOpen(DataSet: TDataSet);
begin
