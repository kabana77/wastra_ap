...
procedure TBonPemakaianNBBFrm.LookMesinEnter(Sender: TObject);
begin
  QLookMesin.Open;
end;

procedure TBonPemakaianNBBFrm.LookMesinCloseUp(Sender: TObject;
...
procedure TBonPemakaianNBBFrm.LookMesinUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookMesin.Close;
  QLookMesin.Open;
...
procedure TBonPemakaianNBBFrm.vTglAWAL2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TBonPemakaianNBBFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TBonPemakaianNBBFrm.vOperand2Click(Sender: TObject);
begin
...
procedure TBonPemakaianNBBFrm.cbTanggal2Click(Sender: TObject);
begin
...
procedure TBonPemakaianNBBFrm.BitBtn6Click(Sender: TObject);
begin
...
procedure TBonPemakaianNBBFrm.LookBudgetEnter(Sender: TObject);
begin
...
procedure TBonPemakaianNBBFrm.LookBudgetCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
{MAA}
...
procedure TBonPemakaianNBBFrm.LookBagian2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TBonPemakaianNBBFrm.LookBagian2Enter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TBonPemakaianNBBFrm.LookItem2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TBonPemakaianNBBFrm.LookItem2Enter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TBonPemakaianNBBFrm.wwDBGrid4CalcCellColors(Sender: TObject;
  Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
  ABrush: TBrush);
begin
  if not Highlight then
...
procedure TBonPemakaianNBBFrm.wwDBGrid4DblClick(Sender: TObject);
var
  vnama_barang_org : String;
  vketerangan_org : String;
  vpos : Integer;
...
procedure TBonPemakaianNBBFrm.wwDBGrid4Enter(Sender: TObject);
begin
  if QTransaksi.State<>dsBrowse then
        try
          QTransaksi.Post;
...
procedure TBonPemakaianNBBFrm.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TBonPemakaianNBBFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TBonPemakaianNBBFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
//  DetailBand2.ForceNewPage:=(vrecord_ke>Round(vRecord.Value)-1);
...
procedure TBonPemakaianNBBFrm.LookLOTEnter(Sender: TObject);
begin
  DMFrm.QNoLot.Close;
  DMFrm.QNoLot.Open;
end;
