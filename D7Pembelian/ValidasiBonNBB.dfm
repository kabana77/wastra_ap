object ValidasiBonNBBFrm: TValidasiBonNBBFrm
  Left = 213
  Top = 135
  Width = 1083
  Height = 567
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'VKELOMPOK'#9'25'#9'KELOMPOK'#9'F'#9'ITEM BARANG'
  ...
  object QBrowse: TOracleDataSet
    ...
    object QBrowseVKELOMPOK: TStringField
      FieldName = 'VKELOMPOK'
      Size = 50
    end
  end
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      ...
      '  insert into pmtx02.vbon_barang_detail'
        ...
        ', no_mesin_tenun, kelompok, kd_item2)'
      
        '  (select :no_reg_pemakaian, :tanggal, no_reg_bon, kd_item, mesi' +
        'n, nama_item, qty, qty_validasi, 0,/*(qty-qty_validasi),*/ id_ba' +
        'g, id_sub_bag, '#39'0'#39'||kd_jns_item, kk,'
      '   no_mesin_tenun, kelompok, no_reff'
