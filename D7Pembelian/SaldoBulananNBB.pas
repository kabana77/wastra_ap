...
type
  TSaldoBulananNBBFrm = class(TForm)
    Panel1: TPanel;
...
var
  SaldoBulananNBBFrm: TSaldoBulananNBBFrm;
...
procedure TSaldoBulananNBBFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  SaldoBulananNBBFrm:=Nil;
end;

procedure TSaldoBulananNBBFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TSaldoBulananNBBFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TSaldoBulananNBBFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TSaldoBulananNBBFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TSaldoBulananNBBFrm.ECariChange(Sender: TObject);
begin
...
procedure TSaldoBulananNBBFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TSaldoBulananNBBFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TSaldoBulananNBBFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TSaldoBulananNBBFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TSaldoBulananNBBFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TSaldoBulananNBBFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TSaldoBulananNBBFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TSaldoBulananNBBFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TSaldoBulananNBBFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TSaldoBulananNBBFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSaldoBulananNBBFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_jns_item',vkd_jns_item);
  QBrowse.SetVariable('tahun', Round(spTahun.Value));
end;

procedure TSaldoBulananNBBFrm.QBrowseBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSaldoBulananNBBFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=LTitle.Caption;
end;

procedure TSaldoBulananNBBFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TSaldoBulananNBBFrm.dbcField1Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSaldoBulananNBBFrm.vOperand1Click(Sender: TObject);
begin
...
procedure TSaldoBulananNBBFrm.ECari1Change(Sender: TObject);
begin
...
procedure TSaldoBulananNBBFrm.BitBtn2Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TSaldoBulananNBBFrm.cbOtomatis1Click(Sender: TObject);
begin
{azmi}
  if cbOtomatis1.Checked then
  begin
...
procedure TSaldoBulananNBBFrm.TabSheet2Show(Sender: TObject);
begin
{azmi}
...
procedure TSaldoBulananNBBFrm.QPakaiBeforeOpen(DataSet: TDataSet);
begin
{azmi}
...
procedure TSaldoBulananNBBFrm.QPakaiAfterScroll(DataSet: TDataSet);
begin
{azmi}
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
{azmi}
