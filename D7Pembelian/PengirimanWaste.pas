...
type
  TPengirimanWasteFrm = class(TForm)
    Panel1: TPanel;
...
var
  PengirimanWasteFrm: TPengirimanWasteFrm;

implementation

uses DM, MainBrowse, Main, Menus, XPROCS, DateUtils, Keterangan, Sisdur,
  BonPemakaianNBB, ReturPemakaianBBM, PengirimanReuse;

{$R *.dfm}

procedure TPengirimanWasteFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  PengirimanWasteFrm:=Nil;
end;

procedure TPengirimanWasteFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TPengirimanWasteFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPengirimanWasteFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TPengirimanWasteFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TPengirimanWasteFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
//  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TPengirimanWasteFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TPengirimanWasteFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TPengirimanWasteFrm.TabSheet2Show(Sender: TObject);
begin
IF vkd_jns_item = 'A' then
  begin
...
procedure TPengirimanWasteFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TPengirimanWasteFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPengirimanWasteFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TPengirimanWasteFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TPengirimanWasteFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TPengirimanWasteFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TPengirimanWasteFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TPengirimanWasteFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TPengirimanWasteFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TPengirimanWasteFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TPengirimanWasteFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPengirimanWasteFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TPengirimanWasteFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TPengirimanWasteFrm.ECariChange(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TPengirimanWasteFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TPengirimanWasteFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TPengirimanWasteFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TPengirimanWasteFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TPengirimanWasteFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TPengirimanWasteFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TPengirimanWasteFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TPengirimanWasteFrm.FormCloseQuery(Sender: TObject;
...
procedure TPengirimanWasteFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TPengirimanWasteFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TPengirimanWasteFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TPengirimanWasteFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TPengirimanWasteFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TPengirimanWasteFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TPengirimanWasteFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TPengirimanWasteFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TPengirimanWasteFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TPengirimanWasteFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TPengirimanWasteFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TPengirimanWasteFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TPengirimanWasteFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TPengirimanWasteFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TPengirimanWasteFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TPengirimanWasteFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TPengirimanWasteFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TPengirimanWasteFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TPengirimanWasteFrm.LookMesinEnter(Sender: TObject);
begin
  QLookMesin.Open;
end;

procedure TPengirimanWasteFrm.LookMesinCloseUp(Sender: TObject;
...
procedure TPengirimanWasteFrm.LookMesinUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookMesin.Close;
  QLookMesin.Open;
...
procedure TPengirimanWasteFrm.vTglAWAL2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TPengirimanWasteFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.vOperand2Click(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.cbTanggal2Click(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.BitBtn6Click(Sender: TObject);
begin
...
procedure TPengirimanWasteFrm.LookBudgetEnter(Sender: TObject);
var
  vlok : string;
  vidb2: string;
begin
...
procedure TPengirimanWasteFrm.LookBudgetCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
{MAA}
...
procedure TPengirimanWasteFrm.LookBagian2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TPengirimanWasteFrm.LookBagian2Enter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TPengirimanWasteFrm.LookItem2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPengirimanWasteFrm.LookItem2Enter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TPengirimanWasteFrm.wwDBGrid4CalcCellColors(Sender: TObject;
  Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
  ABrush: TBrush);
begin
  if not Highlight then
...
procedure TPengirimanWasteFrm.wwDBGrid4DblClick(Sender: TObject);
var
  vnama_barang_org : String;
  vketerangan_org : String;
  vpos : Integer;
...
procedure TPengirimanWasteFrm.wwDBGrid4Enter(Sender: TObject);
begin
  if QTransaksi.State<>dsBrowse then
        try
          QTransaksi.Post;
...
procedure TPengirimanWasteFrm.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TPengirimanWasteFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TPengirimanWasteFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
//  DetailBand2.ForceNewPage:=(vrecord_ke>Round(vRecord.Value)-1);
