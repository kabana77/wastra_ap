...
type
  TBonPermintaanReturFrm = class(TForm)
    Panel1: TPanel;
...
var
  BonPermintaanReturFrm: TBonPermintaanReturFrm;
...
procedure TBonPermintaanReturFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  BonPermintaanReturFrm:=Nil;
end;

procedure TBonPermintaanReturFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TBonPermintaanReturFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TBonPermintaanReturFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBonPermintaanReturFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TBonPermintaanReturFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TBonPermintaanReturFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TBonPermintaanReturFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TBonPermintaanReturFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TBonPermintaanReturFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPermintaanReturFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TBonPermintaanReturFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TBonPermintaanReturFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TBonPermintaanReturFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPermintaanReturFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TBonPermintaanReturFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TBonPermintaanReturFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TBonPermintaanReturFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TBonPermintaanReturFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TBonPermintaanReturFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TBonPermintaanReturFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TBonPermintaanReturFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TBonPermintaanReturFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TBonPermintaanReturFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TBonPermintaanReturFrm.ECariChange(Sender: TObject);
begin
...
procedure TBonPermintaanReturFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBonPermintaanReturFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TBonPermintaanReturFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TBonPermintaanReturFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBonPermintaanReturFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TBonPermintaanReturFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TBonPermintaanReturFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TBonPermintaanReturFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TBonPermintaanReturFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBonPermintaanReturFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TBonPermintaanReturFrm.FormCloseQuery(Sender: TObject;
...
procedure TBonPermintaanReturFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBonPermintaanReturFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TBonPermintaanReturFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TBonPermintaanReturFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBonPermintaanReturFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBonPermintaanReturFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TBonPermintaanReturFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TBonPermintaanReturFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TBonPermintaanReturFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TBonPermintaanReturFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TBonPermintaanReturFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TBonPermintaanReturFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBonPermintaanReturFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TBonPermintaanReturFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBonPermintaanReturFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TBonPermintaanReturFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPermintaanReturFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TBonPermintaanReturFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TBonPermintaanReturFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailQTY_STOK2.AsFloat:=QDetailQTY_STOK.AsFloat/cball2kg;
  QDetailQTY_BON2.AsFloat:=QDetailQTY_BON.AsFloat/cball2kg;
end;

procedure TBonPermintaanReturFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TBonPermintaanReturFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseQTY2.AsFloat:=QBrowseQTY.AsFloat/cball2kg;
  QBrowseQTY_VALIDASI2.AsFloat:=QBrowseQTY_VALIDASI.AsFloat/cball2kg;
end;

procedure TBonPermintaanReturFrm.QTotalBeforeOpen(DataSet: TDataSet);
begin
