...
type
  TKebutuhanKimiaFrm = class(TForm)
    Panel1: TPanel;
    ...
    QBrowseCQTY: TFloatField;
    QBrowseCQTY_PO: TFloatField;
    QBrowseCQTY_LPB: TFloatField;
...
var
  KebutuhanKimiaFrm: TKebutuhanKimiaFrm;
...
procedure TKebutuhanKimiaFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  KebutuhanKimiaFrm:=Nil;
end;

procedure  TKebutuhanKimiaFrm.ambil;
begin
...
procedure TKebutuhanKimiaFrm.FormCreate(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKebutuhanKimiaFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TKebutuhanKimiaFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TKebutuhanKimiaFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TKebutuhanKimiaFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
...
procedure TKebutuhanKimiaFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TKebutuhanKimiaFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TKebutuhanKimiaFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKebutuhanKimiaFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TKebutuhanKimiaFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TKebutuhanKimiaFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TKebutuhanKimiaFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TKebutuhanKimiaFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TKebutuhanKimiaFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TKebutuhanKimiaFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TKebutuhanKimiaFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TKebutuhanKimiaFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKebutuhanKimiaFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TKebutuhanKimiaFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TKebutuhanKimiaFrm.ECariChange(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TKebutuhanKimiaFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
//    vorder:=' order by '+wwDBGrid1.Columns[0].FieldName;
  ...
  QBrowse.Open;
//wwDBGrid1.GroupFieldName:='REKANAN';
  QBrowse.EnableControls;

end;

procedure TKebutuhanKimiaFrm.FormShow(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TKebutuhanKimiaFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TKebutuhanKimiaFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TKebutuhanKimiaFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TKebutuhanKimiaFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKebutuhanKimiaFrm.FormCloseQuery(Sender: TObject;
...
procedure TKebutuhanKimiaFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TKebutuhanKimiaFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TKebutuhanKimiaFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TKebutuhanKimiaFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TKebutuhanKimiaFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=36;
  1 : vRecord.Value:=18;
...
procedure TKebutuhanKimiaFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TKebutuhanKimiaFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TKebutuhanKimiaFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TKebutuhanKimiaFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TKebutuhanKimiaFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TKebutuhanKimiaFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TKebutuhanKimiaFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TKebutuhanKimiaFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.LookFormulasiEnter(Sender: TObject);
begin
  DMFrm.QFormulasiKimia.Open;
end;

procedure TKebutuhanKimiaFrm.LookFormulasiUserButton1Click(
...
procedure TKebutuhanKimiaFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TKebutuhanKimiaFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
  case rgKonversi.ItemIndex of
  0 : begin
            QBrowseCQTY.AsFloat:=QBrowseQTY.AsFloat;
            QBrowseCQTY_PO.AsFloat:=QBrowseQTY_PO.AsFloat;
            QBrowseCQTY_LPB.AsFloat:=QBrowseQTY_LPB.AsFloat;
      end;
  1 : begin
        if QBrowseSAT1.AsString='GRAM' then
        begin
            QBrowseCQTY.AsFloat:=QBrowseQTY.AsFloat;
            QBrowseCQTY_PO.AsFloat:=QBrowseQTY_PO.AsFloat;
            QBrowseCQTY_LPB.AsFloat:=QBrowseQTY_LPB.AsFloat;
        ...
        if QBrowseSAT1.AsString='KG' then
        begin
            QBrowseCQTY.AsFloat:=1000*QBrowseQTY.AsFloat;
            QBrowseCQTY_PO.AsFloat:=1000*QBrowseQTY_PO.AsFloat;
            QBrowseCQTY_LPB.AsFloat:=1000*QBrowseQTY_LPB.AsFloat;
        end
        else
        begin
            QBrowseCQTY.AsFloat:=QBrowseQTY.AsFloat;
  ...
  2 : begin
        if QBrowseSAT1.AsString='GRAM' then
        begin
            QBrowseCQTY.AsFloat:=QBrowseQTY.AsFloat/1000;
            QBrowseCQTY_PO.AsFloat:=QBrowseQTY_PO.AsFloat/1000;
            QBrowseCQTY_LPB.AsFloat:=QBrowseQTY_LPB.AsFloat/1000;
        end
        else
        if QBrowseSAT1.AsString='KG' then
        begin
  ...
  3 : begin
        if QBrowseSAT1.AsString='GRAM' then
        begin
            QBrowseCQTY.AsFloat:=QBrowseQTY.AsFloat/1000000;
            QBrowseCQTY_PO.AsFloat:=QBrowseQTY_PO.AsFloat/1000000;
            QBrowseCQTY_LPB.AsFloat:=QBrowseQTY_LPB.AsFloat/1000000;
        end
        else
        if QBrowseSAT1.AsString='KG' then
        begin
...
procedure TKebutuhanKimiaFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TKebutuhanKimiaFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.dbcField20Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TKebutuhanKimiaFrm.vOperand20Click(Sender: TObject);
begin
  if vOperand20.Caption='LIKE' then
    vOperand20.Caption:='='
    else
...
procedure TKebutuhanKimiaFrm.ECari20Change(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.cbOtomatis20Click(Sender: TObject);
begin
  if cbOtomatis20.Checked then
  begin
    ShowMessage('Mencari data pada kolom paling kiri.'+#13+'Urutkan data terlebih dahulu supaya mudah mencari !');
...
procedure TKebutuhanKimiaFrm.vTglAwal20Change(Sender: TObject);
begin
  vTglAkhir20.Date:=Trunc(EndOfTheMonth(VTglAwal20.Date));
end;

procedure TKebutuhanKimiaFrm.vTglAkhir20Change(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.cbTanggal20Click(Sender: TObject);
begin
if cbTanggal20.Checked then
  begin
...
procedure TKebutuhanKimiaFrm.QBrowse200BeforeOpen(DataSet: TDataSet);
begin
   QBrowse200.SetVariable('kd_transaksi','102');
end;

procedure TKebutuhanKimiaFrm.TabSheet4Show(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.vTglAwal200Change(Sender: TObject);
begin
  vTglAkhir200.Date:=Trunc(EndOfTheMonth(VTglAwal200.Date));

end;

procedure TKebutuhanKimiaFrm.vTglAkhir200Change(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.cbOtomatis200Click(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.dbcField200Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TKebutuhanKimiaFrm.vOperand200Click(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.cbTanggal200Click(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.ECari200Change(Sender: TObject);
begin
  if cbOtomatis200.Checked then
  begin
...
procedure TKebutuhanKimiaFrm.BitBtn4Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TKebutuhanKimiaFrm.wwDBGrid200TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TKebutuhanKimiaFrm.LookBudgetEnter(Sender: TObject);
var
  vlok : string;
  vidb2: string;
begin
...
procedure TKebutuhanKimiaFrm.BitBtn6Click(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.cbTanggal2Click(Sender: TObject);
begin
  if cbTanggal2.Checked then
  begin
...
procedure TKebutuhanKimiaFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.vTglAWAL2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TKebutuhanKimiaFrm.vOperand2Click(Sender: TObject);
begin
  if vOperand2.Caption='>' then
    vOperand2.Caption:='<'
    else
...
procedure TKebutuhanKimiaFrm.LookBudgetCloseUp(Sender: TObject;
...
procedure TKebutuhanKimiaFrm.BitBtn8Click(Sender: TObject);
begin
ambil;
end;

procedure TKebutuhanKimiaFrm.wwDBGrid20URLOpen(Sender: TObject;
...
procedure TKebutuhanKimiaFrm.cbDetailClick(Sender: TObject);
begin
...
procedure TKebutuhanKimiaFrm.wwDBGrid20RowChanged(Sender: TObject);
begin
QBPO.Close;
  QLPB.Close;
