object NotaReturFrm: TNotaReturFrm
  Left = 222
  Top = 158
  Width = 1009
  Height = 611
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel5: TPanel
        ...
        object Panel8: TPanel
          ...
          object LookJnsRetur: TwwDBComboBox
            Left = 88
            Top = 136
            Width = 137
            Height = 21
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KETERANGAN'#9'31'#9'NAMA / SPESIFIKASI (ALT)+(K)'#9'T'#9'BARANG/ BAHAN'
          ...
          'QTY'#9'11'#9'DISERAHKAN~( KG )'#9'F'
          'KD_SUB_LOKASI'#9'5'#9'KODE'#9'F'#9'DARI LOKASI'
          'LOKASI'#9'15'#9'NAMA'#9'T'#9'DARI LOKASI'
          'HARGA'#9'8'#9'HARGA~PER BALE'#9'F'
          'SUB_TOTAL'#9'12'#9'SUB TOTAL'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QTransaksi: TOracleDataSet
    ...
    object QTransaksiPOT_HUT: TStringField
      FieldName = 'POT_HUT'
      Size = 1
    end
  end
  ...
  object QBrowse: TOracleDataSet
    ...
    Variables.Data = {
      ...
      005245310000000000080000003A4D59504152414D01000000110000006F7264
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        'delete pmtx02.vbon_barang_detail where no_reg_pemakaian=:no_reg_' +
        'pemakaian;'
  ...
  object QJnsTransaksi: TOracleDataSet
    SQL.Strings = (
      ...
      'from pmtx01.jns_transaksi where kd_transaksi=:kd_transaksi')
    Variables.Data = {
