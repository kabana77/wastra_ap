object BonPermintaanReturFrm: TBonPermintaanReturFrm
  Left = 255
  Top = 174
  Width = 825
  Height = 611
  Caption = 'Permintaan Retur Bahan Baku'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'QTY'#9'7'#9'BON ( KG )'#9'F'
          'QTY_VALIDASI'#9'7'#9'VALIDASI ( KG )'#9'F'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'QTY_STOK'#9'10'#9'STOK SAAT INI~( KG )'#9'T'
          'QTY_BON'#9'10'#9'BON BULAN INI~( KG )'#9'T'
          'QTY'#9'8'#9'JUMLAH RETUR~( KG )'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QDetail: TOracleDataSet
    ...
    ReadBuffer = 10
    Variables.Data = {
      03000000010000000B0000003A4E4F5F5245475F424F4E030000000400000039
      00000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select * from pmtx02.vbon_bb_benang where kd_tran' +
        'saksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
      ...
      53490500000005000000523031250000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      4E0100000000000A00000054474C5F494E53455254010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
  ...
  object QLookSubBagian: TOracleDataSet
    ...
    Variables.Data = {
      ...
      7265206B645F7472616E73616B73693D27523031270000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from pmtx02.vbon_bb_benang'
