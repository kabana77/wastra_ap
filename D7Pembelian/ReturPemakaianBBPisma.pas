...
type
  TReturPemakaianBBPismaFrm = class(TForm)
    Panel1: TPanel;
...
var
  ReturPemakaianBBPismaFrm: TReturPemakaianBBPismaFrm;

implementation

uses DM, MainBrowse, Main, Menus, XPROCS, DateUtils, Keterangan, Sisdur,
  BonPemakaianBBBenang;

{$R *.dfm}

procedure TReturPemakaianBBPismaFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  ReturPemakaianBBPismaFrm:=Nil;
end;

procedure TReturPemakaianBBPismaFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TReturPemakaianBBPismaFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TReturPemakaianBBPismaFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TReturPemakaianBBPismaFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TReturPemakaianBBPismaFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TReturPemakaianBBPismaFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QLookItem.Close;
...
procedure TReturPemakaianBBPismaFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TReturPemakaianBBPismaFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TReturPemakaianBBPismaFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TReturPemakaianBBPismaFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TReturPemakaianBBPismaFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TReturPemakaianBBPismaFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TReturPemakaianBBPismaFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TReturPemakaianBBPismaFrm.LookBagianCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
    QDetailID_SUB_BAG.AsString:=QLookSubBagianID_SUB_BAG.AsString;
...
procedure TReturPemakaianBBPismaFrm.LookItemEnter(Sender: TObject);
begin
  QLookItem.Open;
end;

procedure TReturPemakaianBBPismaFrm.QLookItemBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TReturPemakaianBBPismaFrm.LookBagianEnter(Sender: TObject);
begin
  QLookSubBagian.Open;
end;

procedure TReturPemakaianBBPismaFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TReturPemakaianBBPismaFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TReturPemakaianBBPismaFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TReturPemakaianBBPismaFrm.ECariChange(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TReturPemakaianBBPismaFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TReturPemakaianBBPismaFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TReturPemakaianBBPismaFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TReturPemakaianBBPismaFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TReturPemakaianBBPismaFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TReturPemakaianBBPismaFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TReturPemakaianBBPismaFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TReturPemakaianBBPismaFrm.FormCloseQuery(Sender: TObject;
...
procedure TReturPemakaianBBPismaFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TReturPemakaianBBPismaFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TReturPemakaianBBPismaFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TReturPemakaianBBPismaFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TReturPemakaianBBPismaFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TReturPemakaianBBPismaFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TReturPemakaianBBPismaFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TReturPemakaianBBPismaFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TReturPemakaianBBPismaFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TReturPemakaianBBPismaFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TReturPemakaianBBPismaFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TReturPemakaianBBPismaFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TReturPemakaianBBPismaFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TReturPemakaianBBPismaFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TReturPemakaianBBPismaFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TReturPemakaianBBPismaFrm.LookBagianUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TReturPemakaianBBPismaFrm.LookItemUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TReturPemakaianBBPismaFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailQTY_STOK2.AsFloat:=QDetailQTY_STOK.AsFloat/cball2kg;
  QDetailQTY_BON2.AsFloat:=QDetailQTY_BON.AsFloat/cball2kg;
end;

procedure TReturPemakaianBBPismaFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TReturPemakaianBBPismaFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseQTY2.AsFloat:=QBrowseQTY.AsFloat/cball2kg;
  QBrowseQTY_VALIDASI2.AsFloat:=QBrowseQTY_VALIDASI.AsFloat/cball2kg;
end;

procedure TReturPemakaianBBPismaFrm.QTotalBeforeOpen(DataSet: TDataSet);
begin
  QTotal.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TReturPemakaianBBPismaFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TReturPemakaianBBPismaFrm.vTglAWAL2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TReturPemakaianBBPismaFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.vOperand2Click(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.cbTanggal2Click(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.BitBtn6Click(Sender: TObject);
begin
...
procedure TReturPemakaianBBPismaFrm.LookBudgetEnter(Sender: TObject);
var
  vlok : string;
  vidb2: string;
begin
...
procedure TReturPemakaianBBPismaFrm.LookBudgetCloseUp(Sender: TObject;
...
procedure TReturPemakaianBBPismaFrm.wwDBGrid4CalcCellColors(Sender: TObject;
  Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
  ABrush: TBrush);
begin
  if not Highlight then
...
procedure TReturPemakaianBBPismaFrm.wwDBGrid4DblClick(Sender: TObject);
var
  vnama_barang_org : String;
  vketerangan_org : String;
  vpos : Integer;
