object BonPemakaianBBKimiaFrm: TBonPemakaianBBKimiaFrm
  Left = 442
  Top = 127
  Width = 783
  Height = 611
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_ITEM'#9'36'#9'NAMA'#9'F'#9'ITEM BARANG'
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel5: TPanel
        ...
        object LookFormulasi: TwwDBLookupComboDlg
          ...
          OnUserButton2Click = LookFormulasiUserButton2Click
          Selected.Strings = (
          ...
          DataSource = dsQTransaksi
          LookupTable = DMFrm.QFormulasiKimia
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'ID_SUB_BAG'#9'6'#9'SETC'#9'T'#9'BEBANKAN KE'
          'KD_ITEM'#9'10'#9'KODE'#9'F'#9'BARANG/ BAHAN'
          'KETERANGAN'#9'49'#9'NAMA/ SPESIFIKASI (ALT)+(K)'#9'T'#9'BARANG/ BAHAN'
  ...
  object QTransaksi: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      470100000000000A0000004A4D4C5F535052494E47010000000000}
    ...
    object QTransaksiFORMULASI: TStringField
      FieldKind = fkLookup
      FieldName = 'FORMULASI'
      LookupDataSet = DMFrm.QFormulasiKimia
  ...
  object QDetail: TOracleDataSet
    ...
    Variables.Data = {
      ...
      00000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000014000000070000004B445F4954454D0100000000000A0000004B4554
      ...
      004B445F4249415941010000000000}
    Master = QTransaksi
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      530100000000000A0000004E4F5F5245475F424F4E0100000000000B0000004B
      445F4A4E535F4954454D0100000000000C0000005154595F56414C4944415349
  ...
  object QLookSubBagian: TOracleDataSet
    ...
    Variables.Data = {
      ...
      7265206B645F7472616E73616B73693D27423032270000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QAmbilFormulasi: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  delete pmtx02.bon_barang_detail where no_reg_bon=:no_reg_bon; ' +
        ' '
      '  insert into pmtx02.bon_barang_detail'
      
        '   (no_reg_bon, kd_item, keterangan, id_bag, id_sub_bag, qty, op' +
        'r_insert, mesin)'
      
        '   (select :no_reg_bon, kd_item, keterangan, :id_bag, :id_sub_ba' +
        'g, :konstanta*qty, :opr_insert,'#39'-'#39' from pmtx01.formulasi_detail ' +
        'where id_formulasi=:id_formulasi);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      
      00000000000000}
    Left = 630
    Top = 161
  end
  ...
  object ODSTGL: TOracleDataSet
    ...
    Variables.Data = {
      03000000020000000D0000003A4B445F5452414E53414B534905000000040000
      004230320000000000080000003A4D59504152414D01000000110000006F7264
      6572206279204E4F5F4E4F54410000000000}
    QBEDefinition.QBEFieldDefs = {
