...
type
  TKartuStokAffalFrm = class(TForm)
    Panel1: TPanel;
    ...
    QSubTotal_NP: TOracleDataSet;
    QSubTotal_NPKEL: TStringField;
    QSubTotal_NPAWAL: TFloatField;
    QSubTotal_NPPEMBELIAN: TFloatField;
    QSubTotal_NPKOREKSI_IN: TFloatField;
    QSubTotal_NPPEMAKAIAN: TFloatField;
    QSubTotal_NPKOREKSI_OUT: TFloatField;
    QRBand3: TQRBand;
    ...
    QSubTotal_P: TOracleDataSet;
    QSubTotal_PKEL: TStringField;
    QSubTotal_PAWAL: TFloatField;
    QSubTotal_PPEMBELIAN: TFloatField;
    QSubTotal_PKOREKSI_IN: TFloatField;
    QSubTotal_PPEMAKAIAN: TFloatField;
    QSubTotal_PKOREKSI_OUT: TFloatField;
    QRShape1: TQRShape;
    QRShape2: TQRShape;
    QRShape3: TQRShape;
    QRShape4: TQRShape;
    ...
    QSubTotal_NPAKHIR: TFloatField;
    QRDBText41: TQRDBText;
    QRDBText42: TQRDBText;
    QSubTotal_PAKHIR: TFloatField;
    QRLabel39: TQRLabel;
    QRShape78: TQRShape;
    QRShape79: TQRShape;
    QRShape80: TQRShape;
    ...
    QRDBText7: TQRDBText;
    QRiwayatTransaksiBBMASUK3: TFloatField;
    QRiwayatTransaksiBBK_LOKASI6: TFloatField;
    ...
    procedure QSubTotal_PCalcFields(DataSet: TDataSet);
  private
    { Private declarations }
    vfilter, vorder, vfilter2 : String;
    vvlpb, vvkm, vvrm, vvsp1, vvsp2, vvsp3, vvkk, vpenyesuaian, vdimusnahkan, vmutasi : real;
  public
    { Public declarations }
...
var
  KartuStokAffalFrm: TKartuStokAffalFrm;
...
procedure TKartuStokAffalFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  KartuStokAffalFrm:=Nil;
end;

procedure TKartuStokAffalFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TKartuStokAffalFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKartuStokAffalFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TKartuStokAffalFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TKartuStokAffalFrm.TabSheet2Show(Sender: TObject);
begin
  ...
  if QRiwayatTransaksiBB.QBEMode then
      ...
      begin
        ...
        vpenyesuaian:=vpenyesuaian+QRiwayatTransaksiBBMASUK3.AsFloat;
        ...
        vdimusnahkan:=vdimusnahkan+QRiwayatTransaksiBBK_LOKASI5.AsFloat;
        vmutasi:=vmutasi+QRiwayatTransaksiBBK_LOKASI6.AsFloat;
        ...
        wwDBGrid4.ColumnByName('MASUK3').FooterValue:=FormatFloat('#,0.00;(#,0.00)',vpenyesuaian);
        ...
        wwDBGrid4.ColumnByName('K_LOKASI5').FooterValue:=FormatFloat('#,0.00;(#,0.00)',vdimusnahkan);
        wwDBGrid4.ColumnByName('K_LOKASI6').FooterValue:=FormatFloat('#,0.00;(#,0.00)',vmutasi);
...
procedure TKartuStokAffalFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TKartuStokAffalFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TKartuStokAffalFrm.ECariChange(Sender: TObject);
begin
...
procedure TKartuStokAffalFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TKartuStokAffalFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TKartuStokAffalFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  vfilter:='';
end;

procedure TKartuStokAffalFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
//  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TKartuStokAffalFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TKartuStokAffalFrm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TKartuStokAffalFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TKartuStokAffalFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TKartuStokAffalFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
//  inc(vrecord_ke);
...
procedure TKartuStokAffalFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TKartuStokAffalFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TKartuStokAffalFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TKartuStokAffalFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TKartuStokAffalFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TKartuStokAffalFrm.BtnExportClick(Sender: TObject);
begin
{  if QBrowse.Active then
  begin
...
procedure TKartuStokAffalFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TKartuStokAffalFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TKartuStokAffalFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TKartuStokAffalFrm.BitBtn2Click(Sender: TObject);
 var
...
procedure TKartuStokAffalFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKartuStokAffalFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKartuStokAffalFrm.BitBtn3Click(Sender: TObject);
begin
 KartuStokNBB2Frm:=TKartuStokNBB2Frm.Create(application);
  KartuStokNBB2Frm.ShowModal;
end;

procedure TKartuStokAffalFrm.BitBtn4Click(Sender: TObject);
begin
...
procedure TKartuStokAffalFrm.wwDBGrid2DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
...
procedure TKartuStokAffalFrm.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TKartuStokAffalFrm.cbStokClick(Sender: TObject);
begin
  QBrowse.Filtered:=cbStok.Checked;
end;

procedure TKartuStokAffalFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TKartuStokAffalFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKartuStokAffalFrm.DetailBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  QRDBText7.Enabled:=False;
end;

procedure TKartuStokAffalFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vdetail:=vdetail+1;
  if vdetail>1 then
...
procedure TKartuStokAffalFrm.TabSheet3Show(Sender: TObject);
var
  vin, vout :real;
begin
vin:=0;
...
procedure TKartuStokAffalFrm.QLookWOBeforeOpen(DataSet: TDataSet);
begin
  QLookWO.SetVariable('ptgl',vTglAkhir.Date);
end;

procedure TKartuStokAffalFrm.QLookDblBeforeOpen(DataSet: TDataSet);
begin
  QLookDbl.SetVariable('ptgl',vTglAkhir.Date);

end;

procedure TKartuStokAffalFrm.cbMaklonClick(Sender: TObject);
begin
  QBrowse.Filtered:=cbMaklon.Checked;
end;

procedure TKartuStokAffalFrm.wwDBGrid4DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
...
procedure TKartuStokAffalFrm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TKartuStokAffalFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKartuStokAffalFrm.QRiwayatTransaksiBBCalcFields(
  DataSet: TDataSet);
begin
...
procedure TKartuStokAffalFrm.QSubTotal_PCalcFields(DataSet: TDataSet);
begin
QSubTotal_NPAKHIR.asfloat:=(QSubTotal_NPAWAL.AsFloat+QSubTotal_NPPEMBELIAN.Asfloat+QSubTotal_NPKOREKSI_IN.asfloat)-(QSubTotal_NPPEMAKAIAN.AsFloat+QSubTotal_NPKOREKSI_OUT.AsFloat);
QSubTotal_PAKHIR.asfloat:=(QSubTotal_PAWAL.AsFloat+QSubTotal_PPEMBELIAN.Asfloat+QSubTotal_PKOREKSI_IN.asfloat)-(QSubTotal_PPEMAKAIAN.AsFloat+QSubTotal_PKOREKSI_OUT.AsFloat);
end;
