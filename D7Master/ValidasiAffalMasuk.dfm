object ValidasiAffalMasukFrm: TValidasiAffalMasukFrm
  Left = 326
  Top = 100
  Width = 901
  Height = 611
  Caption = 'Validasi Koreksi Masuk'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = '&Daftar Pemasukkan Waste'
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel5: TPanel
        ...
        object BtnFormulasi: TBitBtn
          ...
          Width = 169
          Height = 30
          Caption = '&Refresh/ Ambil Bukti Koreksi'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'KD_LOKASI;CustomEdit;LookLokasi;F'
        ...
        Selected.Strings = (
          ...
          'QTY_KG_PALET'#9'8'#9'Nett~( Kg )'#9'F'#9'MASUK'
          'QTY'#9'8'#9'Gross~( KG)'#9'F'#9'MASUK'
          'QTY_BALL'#9'8'#9'BALL'#9'F'#9'MASUK'
          'KD_LOKASI'#9'5'#9'Kode'#9'F'#9'PENEMPATAN'
          'LOKASI'#9'10'#9'LOKASI'#9'F'#9'PENEMPATAN'
    ...
    object TabSheet3: TTabSheet
      ...
      object wwDBGrid6: TwwDBGrid
        ...
        ControlType.Strings = (
          'STATUS;CheckBox;1;0'
          'NO_NOTA;CustomEdit;LookWaste;F')
        Selected.Strings = (
          'NO_NOTA'#9'16'#9'NO_NOTA'#9'F'#9
          'KD_ITEM'#9'15'#9'KD_ITEM'#9'F'#9
          'NAMA_ITEM'#9'20'#9'NAMA_ITEM'#9'F'#9
          'SATUAN'#9'3'#9'SATUAN'#9'F'#9
          'QTY'#9'8'#9'JUMLAH'#9'F'#9
          'NO_BC'#9'20'#9'NO. BC'#9'F'#9
          'TANGGAL_BC'#9'18'#9'TANGGAL BC'#9'F'#9
          'VALUE'#9'10'#9'NILAI'#9'F'#9)
        IniAttributes.Delimiter = ';;'
        ExportOptions.ExportType = wwgetSYLK
        TitleColor = clSkyBlue
        FixedCols = 0
      ...
      object LookWaste: TwwDBLookupComboDlg
        ...
        Selected.Strings = (
          ...
          'QTY'#9'10'#9'QTY'#9'F'
          'SATUAN'#9'3'#9'SATUAN'#9'F'
          'NO_LOT'#9'20'#9'NO_LOT'#9'F')
        DataField = 'NO_NOTA'
        DataSource = dsQDocBC
        LookupTable = QLookWaste
        LookupField = 'KD_ITEM'
        TabOrder = 3
        Visible = False
        AutoDropDown = False
  ...
  object QDetail: TOracleDataSet
    ...
    object QDetailHARGA_BALE: TFloatField
      FieldKind = fkCalculated
      FieldName = 'HARGA_BALE'
      DisplayFormat = '0.0,0;(0.0,0)'
      Calculated = True
    end
    object QDetailQTY_BALE: TFloatField
      FieldKind = fkCalculated
      FieldName = 'QTY_BALE'
      DisplayFormat = '#,##0.######;(#,##0.######); '
      Calculated = True
    ...
    object QDetailQTY_KG_PALET: TFloatField
      FieldName = 'QTY_KG_PALET'
      DisplayFormat = '#,##0.##0;(#,##0.##0)'
    end
  ...
  object QBrowse: TOracleDataSet
    ...
    Variables.Data = {
      ...
      005641310000000000080000003A4D59504152414D01000000110000006F7264
    ...
    object QBrowseQTY_BALE: TFloatField
      FieldKind = fkCalculated
      FieldName = 'QTY_BALE'
      DisplayFormat = '#,##0.######;(#,##0.######); '
      Calculated = True
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      ...
      '  insert into pmtx02.vbon_barang_detail'
        ...
        'ngan, qty_bon, qty_valid, qty, qty_BALL, id_bag, id_sub_bag, kd_' +
        'sub_lokasi, kd_lokasi, lokasi, no_reff)'
      
        '  (select :no_reg_pemakaian, :tanggal, no_reg_bon, kd_item, mesi' +
        'n, nama_item, qty, qty_validasi, (qty-qty_validasi), qty_box, id' +
        '_bag, id_sub_bag, '#39'0001'#39', '#39'0'#39'||kd_jns_item, '#39'-'#39', no_reff'
      '  from pmtx02.vterima_affal'
  ...
  object QJnsKoreksi: TOracleDataSet
    SQL.Strings = (
      'select * from pmtx01.jns_PEMASUKKAN')
  ...
  object QLookItem: TOracleDataSet
    ...
    Variables.Data = {
      ...
      410000000000090000003A54474C5F4157414C0C000000070000007873060101
      0101000000000A0000003A54474C5F414B4849520C000000070000007873061E
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000080000000B0000004B445F4A4E535F4954454D010000000000070000
      ...
      060000004F504E414D45010000000000}
    Session = DMFrm.OS
  ...
  object QDocBC: TOracleDataSet
    SQL.Strings = (
      'select t.*,t.rowid from pmtx04.WEB_DOC_BC24 t :myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      010000000000}
    Cursor = crSQLWait
    QueryAllRecords = False
    CountAllRecords = True
    ...
    AfterScroll = QBrowseAfterScroll
    Left = 756
    object QDocBCNO_NOTA: TStringField
      DisplayWidth = 16
      FieldName = 'NO_NOTA'
    end
    object QDocBCKD_ITEM: TStringField
      DisplayWidth = 15
      FieldName = 'KD_ITEM'
      Size = 10
    end
    object QDocBCNAMA_ITEM: TStringField
      DisplayWidth = 20
      FieldName = 'NAMA_ITEM'
      Size = 100
    end
    object QDocBCSATUAN: TStringField
      DisplayWidth = 3
      FieldName = 'SATUAN'
      Size = 3
    end
    object QDocBCQTY: TFloatField
      DisplayLabel = 'JUMLAH'
      DisplayWidth = 8
      FieldName = 'QTY'
    end
    object QDocBCNO_BC: TStringField
      DisplayLabel = 'NO. BC'
      DisplayWidth = 20
      FieldName = 'NO_BC'
      Size = 50
    end
    object QDocBCTANGGAL_BC: TDateTimeField
      DisplayLabel = 'TANGGAL BC'
      DisplayWidth = 18
      FieldName = 'TANGGAL_BC'
    end
    object QDocBCVALUE: TFloatField
      DisplayLabel = 'NILAI'
      DisplayWidth = 10
      FieldName = 'VALUE'
    end
    object QDocBCNO_REG_PEMAKAIAN: TFloatField
      DisplayWidth = 10
      FieldName = 'NO_REG_PEMAKAIAN'
      Visible = False
    end
  end
  object dsQDocBC: TwwDataSource
    DataSet = QDocBC
    Left = 804
    Top = 1
  end
  object QLookWaste: TOracleDataSet
    SQL.Strings = (
      
        'select t.no_nota, t.tanggal, x.kd_item, x.keterangan, x.qty, '#39'KG' +
        #39' as satuan, x.no_reff as no_lot, t.no_reg_pemakaian from pmtx02' +
        '.vbon_barang t, pmtx02.vbon_barang_detail x'
      'where t.no_reg_pemakaian=x.no_reg_pemakaian and'
      
        't.kd_transaksi IN ('#39'SJ2'#39') AND t.tanggal >= to_date('#39'01-11-2019'#39',' +
        #39'dd-mm-yyyy'#39')')
    QBEDefinition.QBEFieldDefs = {
      
      4E4F5F5245475F50454D414B4149414E010000000000}
    Session = DMFrm.OS
    BeforeOpen = QLookItemBeforeOpen
    Left = 100
    Top = 409
    object QLookWasteNO_NOTA: TStringField
      DisplayWidth = 15
      FieldName = 'NO_NOTA'
      Size = 15
    end
    object QLookWasteTANGGAL: TDateTimeField
      DisplayWidth = 18
      FieldName = 'TANGGAL'
    end
    object QLookWasteKD_ITEM: TStringField
      DisplayWidth = 10
      FieldName = 'KD_ITEM'
      Size = 16
    end
    object QLookWasteKETERANGAN: TStringField
      DisplayWidth = 25
      FieldName = 'KETERANGAN'
      Size = 255
    end
    object QLookWasteQTY: TFloatField
      DisplayWidth = 10
      FieldName = 'QTY'
    end
    object QLookWasteSATUAN: TStringField
      DisplayWidth = 3
      FieldName = 'SATUAN'
      Size = 2
    end
    object QLookWasteNO_LOT: TStringField
      DisplayWidth = 20
      FieldName = 'NO_LOT'
      Size = 50
    end
    object QLookWasteNO_REG_PEMAKAIAN: TIntegerField
      FieldName = 'NO_REG_PEMAKAIAN'
      Required = True
      Visible = False
    end
