...
procedure TATKFrm.FormClose(Sender: TObject;
...
procedure TATKFrm.BtnSimpanClick(Sender: TObject);
begin
...
procedure TATKFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  BtnSimpan.Enabled:=True;
end;

procedure TATKFrm.BtnEditingClick(Sender: TObject);
begin
...
procedure TATKFrm.BtnBrowseClick(Sender: TObject);
begin
...
procedure TATKFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TATKFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QSatuan.Close;
...
procedure TATKFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TATKFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TATKFrm.BitBtn5Click(Sender: TObject);
var
  vtitle : String;
begin
  case PageControl1.ActivePageIndex of
...
procedure TATKFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TATKFrm.BtnEditing2Click(Sender: TObject);
begin
...
procedure TATKFrm.BtnBrowse2Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TATKFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TATKFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TATKFrm.TabSheet2Show(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TATKFrm.FormShow(Sender: TObject);
begin
  Height:=600;
  Width:=716;
end;

procedure TATKFrm.LookMesinEnter(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TATKFrm.LookJenisEnter(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TATKFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TATKFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QMasterKD_JNS_ITEM.AsString:='8';
...
procedure TATKFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
  QMaster2KD_JNS_ITEM.AsString:='8';
end;

procedure TATKFrm.FormCloseQuery(Sender: TObject;
...
procedure TATKFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TATKFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TATKFrm.LookSatuanEnter(Sender: TObject);
begin
  DMFrm.QSatuan.Open;
end;

procedure TATKFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TATKFrm.ECariChange(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TATKFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TATKFrm.QMasterBeforePost(DataSet: TDataSet);
begin
 QMasterOPR_EDIT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TATKFrm.BitBtn6Click(Sender: TObject);
begin
{azmi}
...
procedure TATKFrm.BitBtn4Click(Sender: TObject);
begin
{azmi}
if QLookUpKelKD_KEL.AsString='' then
begin
...
procedure TATKFrm.wwDBLookupCombo1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{azmi}
...
procedure TATKFrm.wwDBLookupCombo1Enter(Sender: TObject);
begin
{azmi}
QLookUpKel.Open;
{azmi}
...
procedure TATKFrm.BitBtn2Click(Sender: TObject);
{azmi}
var
  vuser, vpwd : string;
begin
