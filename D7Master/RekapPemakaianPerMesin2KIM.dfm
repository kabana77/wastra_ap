object RekapPemakaianPerMesin2KIMFrm: TRekapPemakaianPerMesin2KIMFrm
  Left = 89
  Top = 112
  Width = 976
  Height = 611
  Caption = 'Rekap Pemakaian BB Kimia Per Unit'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object QuickRep1: TQuickRep
        ...
        object SummaryBand1: TQRBand
          ...
          object QRExpr3: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'SUM(QBrowse.SUB_TOTAL)'
            Mask = '#,#;(#,#);-'
            FontSize = 8
          end
        end
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'MESIN'#9'17'#9'MESIN'#9'F'
          'KD_ITEM'#9'9'#9'Kode'#9'F'#9'BARANG/ BAHAN'
          'NAMA_ITEM'#9'28'#9'Nama'#9'F'#9'BARANG/ BAHAN'
          'SAT1'#9'7'#9'Satuan'#9'F'#9'BARANG/ BAHAN'
          'QTY_VALIDASI'#9'10'#9'Gram'#9'F'#9'PEMAKAIAN'
          'QTY_VALIDASI2'#9'10'#9'Kg'#9'F'#9'PEMAKAIAN'
          'QTY_VALIDASI3'#9'10'#9'Pcs'#9'F'#9'PEMAKAIAN'
          'HARGA2'#9'10'#9'HARGA SAT'#9'F'
  ...
  object Panel4: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 491
      Height = 24
      Caption = 'REKAP PEMAKAIAN BAHAN BAKU KIMIA PER UNIT'
    end
  end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'tem, sat1, sum(qty_validasi) as qty_pp, decode(sat1,'#39'GRAM'#39',sum(q' +
        'ty_validasi), decode(sat1,'#39'KG'#39',sum(qty_validasi)*1000,0)) as qty' +
        '_validasi, '
      
        'decode(sat1,'#39'GRAM'#39',sum(qty_validasi)/1000, decode(sat1,'#39'KG'#39',sum(' +
        'qty_validasi),0)) as qty_validasi2, decode(sat1,'#39'GRAM'#39',0, decode' +
        '(sat1,'#39'KG'#39',0,sum(qty_validasi))) as qty_validasi3'
      'from pmtx02.vbon_barang_nbb2 '
      
        'where kd_jns_item=:vjns and tanggal>=trunc(:pawal) and tanggal<t' +
        'runc(:pakhir)+1-1/86400 group by bagian, sub_bagian, mesin, kd_i' +
        'tem, nama_item, sat1) :myparam'
      '')
    Variables.Data = {
      0300000004000000080000003A4D59504152414D010000000000000000000000
      060000003A504157414C0C00000007000000786E080101010100000000070000
      003A50414B4849520C00000007000000786E081F01010100000000050000003A
      564A4E530500000002000000320000000000}
    QBEDefinition.QBEFieldDefs = {
      
      00}
    Session = DMFrm.OS
    Active = True
    ...
    object QBrowseHARGA2: TFloatField
      FieldKind = fkCalculated
      FieldName = 'HARGA2'
      DisplayFormat = '#,#;(#,#)'
      Calculated = True
    ...
    object QBrowseQTY_VALIDASI3: TFloatField
      FieldName = 'QTY_VALIDASI3'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
  ...
  object QLookNilai: TOracleDataSet
    ...
    Variables.Data = {
      ...
      3A50544148554E0300000004000000D907000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QDetail2: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select no_nota, tanggal, bagian, sub_bagian, deco' +
        'de(mesin,null,'#39'-'#39',mesin) as mesin,  kd_item, nama_item, sat1, qt' +
        'y as qty_kebutuhan, qty_validasi as qty_pp from pmtx02.vbon_bara' +
        'ng_nbb2 '
      
        'where kd_jns_item=:vjns and tanggal>=trunc(:pawal) and tanggal<t' +
        'runc(:pakhir)+1-1/86400 order by tanggal, no_nota) :myparam'
      '')
    Variables.Data = {
      0300000004000000080000003A4D59504152414D010000000000000000000000
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0A0000005355425F42414749414E010000000000070000004E4F5F4E4F544101
