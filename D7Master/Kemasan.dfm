object KemasanFrm: TKemasanFrm
  ...
  Width = 767
  Height = 600
  Caption = 'Bahan Kemas dan Packing'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KELOMPOK'#9'10'#9'NAMA'#9'T'#9'KELOMPOK'
          'NAMA_ITEM'#9'38'#9'NAMA ITEM'#9'F'
          'KD_ITEM_LAMA'#9'10'#9'KODE~LAMA'#9'F'
          'KD_SATUAN'#9'5'#9'KODE'#9'F'#9'SATUAN'
          'SAT1'#9'6'#9'NAMA'#9'T'#9'SATUAN'
          'NO_PART'#9'8'#9'NO PART'#9'F'
          'MIN_STOK'#9'10'#9'MIN STOK'#9'F'
          'MAX_STOK'#9'10'#9'MAX STOK'#9'F'
          'TLR_PSN'#9'6'#9'PERSEN'#9'F'#9'TOLERANSI~PENERIMAAN'
          'TLR_QTY'#9'6'#9'JUMLAH'#9'F'#9'TOLERANSI~PENERIMAAN'
          'ICC'#9'5'#9'VALID'#9'F'#9'OPNAME'
          'LAST_CC'#9'18'#9'TERAKHIR'#9'F'#9'OPNAME'
          'QTY'#9'10'#9'JUMLAH'#9'F'#9'OPNAME'
          'OPR_EDIT'#9'10'#9'OPERATOR'#9'F'#9'EDIT'
          'TGL_EDIT'#9'16'#9'TANGGAL'#9'F'#9'EDIT')
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select a.kd_item, a.kd_item_lama, a.kd_jns_item, ' +
        'a.kd_kel, a.nama_item, a.kd_satuan, a.no_part, a.tlr_psn, a.tlr_' +
        'qty,a.icc, a.last_cc, a.qty, a.tgl_edit, a.opr_edit, a.min_stok,' +
        ' a.max_stok, a.rowid, b.kelompok, c.sat1 from pmtx01.item a'
      ...
      'where a.kd_jns_item='#39'5'#39')'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000012000000080000004B454C4F4D504F4B010000000000070000004B44
      ...
      }
    ...
    object QMasterTLR_PSN: TFloatField
      FieldName = 'TLR_PSN'
    end
    object QMasterTLR_QTY: TFloatField
      FieldName = 'TLR_QTY'
    end
    ...
    object QMasterKD_ITEM_LAMA: TStringField
    ...
    object QMasterMAX_STOK: TFloatField
      FieldName = 'MAX_STOK'
    end
  end
  ...
  object QLookUpKel: TOracleDataSet
    SQL.Strings = (
    ...
    Left = 732
    Top = 169
    object QLookUpKelKD_KEL: TStringField
      DisplayLabel = 'KODE'
      DisplayWidth = 5
      FieldName = 'KD_KEL'
      Required = True
    ...
    object QLookUpKelKELOMPOK: TStringField
      DisplayWidth = 30
      FieldName = 'KELOMPOK'
      Required = True
      Size = 50
    end
    object QLookUpKelKD_JNS_ITEM: TStringField
      DisplayLabel = 'KODE'
      DisplayWidth = 10
      FieldName = 'KD_JNS_ITEM'
      Required = True
  ...
  object dsQLookUpKel: TwwDataSource
    DataSet = QLookUpKel
    Left = 796
    Top = 169
  end
