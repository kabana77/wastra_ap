...
procedure TRTUmumFrm.FormClose(Sender: TObject;
...
procedure TRTUmumFrm.BtnSimpanClick(Sender: TObject);
begin
...
procedure TRTUmumFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  BtnSimpan.Enabled:=True;
end;

procedure TRTUmumFrm.BtnEditingClick(Sender: TObject);
begin
...
procedure TRTUmumFrm.BtnBrowseClick(Sender: TObject);
begin
...
procedure TRTUmumFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TRTUmumFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QSatuan.Close;
...
procedure TRTUmumFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TRTUmumFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TRTUmumFrm.BitBtn5Click(Sender: TObject);
var
  vtitle : String;
begin
  case PageControl1.ActivePageIndex of
...
procedure TRTUmumFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TRTUmumFrm.BtnEditing2Click(Sender: TObject);
begin
...
procedure TRTUmumFrm.BtnBrowse2Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TRTUmumFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TRTUmumFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TRTUmumFrm.TabSheet2Show(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TRTUmumFrm.FormShow(Sender: TObject);
begin
  Height:=600;
  Width:=716;
end;

procedure TRTUmumFrm.LookMesinEnter(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TRTUmumFrm.LookJenisEnter(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TRTUmumFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TRTUmumFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QMasterKD_JNS_ITEM.AsString:='9';
...
procedure TRTUmumFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
  QMaster2KD_JNS_ITEM.AsString:='9';
end;

procedure TRTUmumFrm.FormCloseQuery(Sender: TObject;
...
procedure TRTUmumFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TRTUmumFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TRTUmumFrm.LookSatuanEnter(Sender: TObject);
begin
  DMFrm.QSatuan.Open;
end;

procedure TRTUmumFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TRTUmumFrm.ECariChange(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TRTUmumFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TRTUmumFrm.QMasterBeforeEdit(DataSet: TDataSet);
begin
 QMasterOPR_EDIT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TRTUmumFrm.QMasterBeforePost(DataSet: TDataSet);
begin
 QMasterOPR_EDIT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TRTUmumFrm.BitBtn6Click(Sender: TObject);
begin
{azmi}
...
procedure TRTUmumFrm.BitBtn4Click(Sender: TObject);
begin
{azmi}
if QLookUpKelKD_KEL.AsString='' then
begin
...
procedure TRTUmumFrm.wwDBLookupCombo1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{azmi}
...
procedure TRTUmumFrm.wwDBLookupCombo1Enter(Sender: TObject);
begin
{azmi}
QLookUpKel.Open;
{azmi}
...
procedure TRTUmumFrm.BitBtn2Click(Sender: TObject);
{azmi}
var
  vuser, vpwd : string;
begin
