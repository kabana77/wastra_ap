object DiagnosaDanKKFrm: TDiagnosaDanKKFrm
  Left = 182
  Top = 41
  Width = 700
  Height = 600
  Caption = 'Daftar Diagnosa dan Jenis Kecelakaan Kerja'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        PictureMasks.Strings = (
          ...
          'ID_HAK'#9'*1{&,#}'#9'T'#9'T'
          'KD_DIAGNOSA'#9'*4{&,#}'#9'T'#9'T')
        Selected.Strings = (
          'KD_DIAGNOSA'#9'4'#9'KODE'#9'F'
          'DIAGNOSA'#9'100'#9'DIAGNOSA'#9#9)
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          'KK'#9'5'#9'KODE'#9'F'
          'JNS_KECELAKAAN'#9'100'#9'JENIS KECELAKAAN'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object Panel4: TPanel
    ...
    object LTitle: TLabel
      ...
      Height = 23
      Cursor = crHandPoint
      Caption = 'DIAGNOSA DAN KECELAKAAN KERJA'
