object KartuStokReuseFrm: TKartuStokReuseFrm
  Left = 195
  Top = 127
  Width = 1033
  Height = 596
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'PEMBELIAN'#9'10'#9'Re Use'#9'F'#9'MASUK'
  ...
  object QProses: TOracleQuery
    SQL.Strings = (
      'begin'
      ' commit; '
      '  pmtx02.proc_temp_mutasi_reuse(:kd_jns_item,:pawal,:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QPRiwayatBB: TOracleQuery
    SQL.Strings = (
      'begin'
      ' commit; '
      '  pmtx02.proc_temp_riwayat_bb(:kd_item,:pawal,:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
