object BAServisFrm: TBAServisFrm
  Left = 34
  Top = 66
  Width = 907
  Height = 711
  Caption = 'Berita Acara Servis'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object QuickRep3: TQuickRep
        ...
        object QRBand7: TQRBand
          ...
          object QRDBText65: TQRDBText
            ...
            AutoStretch = False
            Color = clWhite
            DataSet = NotaPembelianFrm.QTransaksi
            DataField = 'NO_NOTA'
            Font.Charset = ANSI_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        ControlType.Strings = (
          'ISPOST;CheckBox;1;0')
        Selected.Strings = (
          'NO_NOTA'#9'15'#9'NO_BA'#9'F'
          'ISPOST'#9'6'#9'ISPOST'#9'F'
          'TANGGAL'#9'11'#9'TANGGAL'#9'F'
          'PP_SERVIS'#9'9'#9'PP_SERVIS'#9'F'
          'KD_REKANAN'#9'5'#9'Kode'#9'F'#9'SUPLIER'
          'REKANAN'#9'47'#9'Nama'#9'F'#9'SUPLIER'
          'MU'#9'4'#9'MU'#9'F'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'TGL_SELESAI'#9'21'#9'SELESAI'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QTransaksi: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      040000001F0000000700000054414E4747414C010000000000070000004E4F5F
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select no_reg_hutang, kd_transaksi, keterangan, no_nota, tanggal' +
        ', pp_servis, kd_rekanan, rekanan, tgl_jth_tempo, to_date(decode(' +
        'tgl_jth_tempo,tgl_jadwal_bayar,null,tgl_jadwal_bayar),'#39'dd-mm-yyy' +
        'y'#39') as tgl_jadwal_bayar,ispost, mu, kd_perk_bayar from pmtx02.vb' +
        'a_servis :myparam')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0000004953504F53540100000000001000000054474C5F4A414457414C5F4241
      5941520100000000000D0000004B445F5045524B5F4241594152010000000000
      0900000050505F5345525649530100000000000A0000004B45544552414E4741
      4E010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      ...
      '    from pmtx02.servis_detail a, pmtx02.permintaan_servis b'
        ...
        '    where a.no_reg_servis=b.no_reg_servis and no_nota like:no_no' +
        'ta'
      '  );'
      'end;')
    Session = DMFrm.OS
