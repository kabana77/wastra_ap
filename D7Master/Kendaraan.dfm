object KendaraanFrm: TKendaraanFrm
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          'NO_POLISI'#9'10'#9'NO POLISI'#9'F'
          'JENIS'#9'11'#9'JENIS'#9'F'
          'KENDARAAN'#9'25'#9'KENDARAAN'#9#9
          'TAHUN'#9'6'#9'TAHUN'#9'F'
          'NO_BPKB'#9'12'#9'NO BPKB'#9'F'
          'TGL_STNK'#9'11'#9'JATUH~TEMPO'#9'F'#9'STNK'
          'NO_MESIN'#9'10'#9'NO MESIN'#9'F'#9'STNK'
          'NO_RANGKA'#9'11'#9'NO RANGKA'#9'F'#9'STNK'
          'WARNA'#9'6'#9'WARNA'#9'F'#9'STNK'
          'PENANGGUNG_JAWAB'#9'12'#9'PENANGGUNG~JAWAB'#9'F'
          'JNS_KEND'#9'10'#9'MACAM'#9'F')
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        PictureMasks.Strings = (
          ...
          'ID_USER'#9'*3{&,#}'#9'T'#9'T')
        Selected.Strings = (
          'JENIS'#9'20'#9'JENIS KENDARAAN'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx01.kendaraan a'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      010000000000}
    ...
    Left = 60
    Top = 137
    object QMasterNO_POLISI: TStringField
      FieldName = 'NO_POLISI'
      Required = True
      Size = 10
    end
    ...
    object QMasterNO_BPKB: TStringField
      FieldName = 'NO_BPKB'
    end
    object QMasterTAHUN: TIntegerField
      FieldName = 'TAHUN'
    end
    object QMasterTGL_STNK: TDateTimeField
      FieldName = 'TGL_STNK'
    end
    object QMasterNO_MESIN: TStringField
      FieldName = 'NO_MESIN'
    end
    object QMasterNO_RANGKA: TStringField
      FieldName = 'NO_RANGKA'
    end
    ...
    object QMasterTGL_PEMBELIAN: TDateTimeField
    ...
    object QMasterJNS_KEND: TStringField
      FieldName = 'JNS_KEND'
      Size = 10
    end
  end
  ...
  object QMaster2: TOracleDataSet
    SQL.Strings = (
      'select * from (select a.*, a.rowid from pmtx01.jns_kend a )'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
