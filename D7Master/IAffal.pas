...
procedure TIAffalFrm.FormClose(Sender: TObject;
...
procedure TIAffalFrm.BtnSimpanClick(Sender: TObject);
begin
...
procedure TIAffalFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  BtnSimpan.Enabled:=True;
end;

procedure TIAffalFrm.BtnEditingClick(Sender: TObject);
begin
...
procedure TIAffalFrm.BtnBrowseClick(Sender: TObject);
begin
...
procedure TIAffalFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TIAffalFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QSatuan.Close;
...
procedure TIAffalFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TIAffalFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TIAffalFrm.BitBtn5Click(Sender: TObject);
var
  vtitle : String;
begin
  case PageControl1.ActivePageIndex of
...
procedure TIAffalFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TIAffalFrm.BtnEditing2Click(Sender: TObject);
begin
...
procedure TIAffalFrm.BtnBrowse2Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TIAffalFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TIAffalFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TIAffalFrm.TabSheet2Show(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TIAffalFrm.FormShow(Sender: TObject);
begin
  Height:=600;
  Width:=716;
end;

procedure TIAffalFrm.LookMesinEnter(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TIAffalFrm.LookJenisEnter(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TIAffalFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TIAffalFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QMasterKD_JNS_ITEM.AsString:='A';
...
procedure TIAffalFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
  QMaster2KD_JNS_ITEM.AsString:='A';
end;

procedure TIAffalFrm.FormCloseQuery(Sender: TObject;
...
procedure TIAffalFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TIAffalFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TIAffalFrm.LookSatuanEnter(Sender: TObject);
begin
  DMFrm.QSatuan.Open;
end;

procedure TIAffalFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TIAffalFrm.ECariChange(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TIAffalFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TIAffalFrm.QMasterBeforePost(DataSet: TDataSet);
begin
 QMasterOPR_EDIT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TIAffalFrm.BitBtn6Click(Sender: TObject);
begin
{azmi}
...
procedure TIAffalFrm.BitBtn4Click(Sender: TObject);
begin
{azmi}
if QLookUpKelKD_KEL.AsString='' then
begin
...
procedure TIAffalFrm.wwDBLookupCombo1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{azmi}
...
procedure TIAffalFrm.wwDBLookupCombo1Enter(Sender: TObject);
begin
{azmi}
QLookUpKel.Open;
{azmi}
...
procedure TIAffalFrm.BitBtn2Click(Sender: TObject);
{azmi}
var
  vuser, vpwd : string;
begin
