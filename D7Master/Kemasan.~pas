...
type
  TKemasanFrm = class(TForm)
    ...
    QMasterTLR_PSN: TFloatField;
    QMasterTLR_QTY: TFloatField;
...
procedure TKemasanFrm.BtnSimpanClick(Sender: TObject);
begin
...
procedure TKemasanFrm.BtnEditingClick(Sender: TObject);
begin
...
procedure TKemasanFrm.BtnBrowseClick(Sender: TObject);
begin
...
procedure TKemasanFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKemasanFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TKemasanFrm.BitBtn5Click(Sender: TObject);
var
  vtitle : String;
begin
  case PageControl1.ActivePageIndex of
  0 : begin
        vtitle:='Daftar Bahan Kemas dan Packing';
  ...
  1 : begin
        vtitle:='Kelompok Bahan Kemas dan Packing';
        DMFrm.SaveDialog1.FileName:=vtitle;
        if DMFrm.SaveDialog1.Execute then
        begin
...
procedure TKemasanFrm.BtnEditing2Click(Sender: TObject);
begin
...
procedure TKemasanFrm.BtnBrowse2Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TKemasanFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TKemasanFrm.TabSheet2Show(Sender: TObject);
begin
  QMaster2.Open;
end;
...
procedure TKemasanFrm.LookMesinEnter(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TKemasanFrm.LookJenisEnter(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TKemasanFrm.LookKonstruksiEnter(Sender: TObject);
begin
...
procedure TKemasanFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
  QMaster2KD_JNS_ITEM.AsString:='5';
end;

procedure TKemasanFrm.FormCloseQuery(Sender: TObject;
...
procedure TKemasanFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TKemasanFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TKemasanFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TKemasanFrm.ECariChange(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TKemasanFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TKemasanFrm.QMasterBeforePost(DataSet: TDataSet);
begin
 QMasterOPR_EDIT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TKemasanFrm.BitBtn6Click(Sender: TObject);
begin
{azmi}
...
procedure TKemasanFrm.BitBtn4Click(Sender: TObject);
begin
{azmi}
if QLookUpKelKD_KEL.AsString='' then
begin
...
procedure TKemasanFrm.wwDBLookupCombo1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{azmi}
...
procedure TKemasanFrm.wwDBLookupCombo1Enter(Sender: TObject);
begin
{azmi}
QLookUpKel.Open;
{azmi}
...
procedure TKemasanFrm.BitBtn7Click(Sender: TObject);
{azmi}
var
  vuser, vpwd : string;
begin
