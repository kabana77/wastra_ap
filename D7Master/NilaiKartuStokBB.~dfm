object NilaiKartuStokBBFrm: TNilaiKartuStokBBFrm
  Left = 239
  Top = 0
  Width = 1036
  Height = 738
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'BENANG'#9'35'#9'NAMA BARANG'#9'F'#9'ITEM BARANG'
          'AWAL'#9'8'#9'KG'#9'F'#9'AWAL'
          'NILAI_AWAL'#9'12'#9'NILAI'#9'F'#9'AWAL'
          'AWAL_AVG2'#9'10'#9'AVG'#9'F'#9'AWAL'
          'PEMBELIAN'#9'8'#9'KG'#9'F'#9'MASUK~BELI'
          'NILAI_BELI'#9'10'#9'NILAI'#9'F'#9'MASUK~BELI'
          'KOREKSI_IN'#9'8'#9'KG'#9'F'#9'MASUK~KOREKSI'
          'NILAI_KOREKSI'#9'10'#9'NILAI'#9'F'#9'MASUK~KOREKSI'
          'MASUK_NILAI'#9'10'#9'NILAI'#9'F'#9'MASUK~TOTAL'
          'MASUK_AVG2'#9'8'#9'AVG'#9'F'#9'MASUK~TOTAL'
          'KELUAR_AVG2'#9'10'#9'HARGA~AVG'#9'F'
          'PEMAKAIAN'#9'8'#9'KG'#9'F'#9'KELUAR~PAKAI'
          'NILAI_PAKAI'#9'10'#9'NILAI PAKAI'#9'F'#9'KELUAR~PAKAI'
          'KOREKSI_OUT'#9'8'#9'KG'#9'F'#9'KELUAR~KOREKSI'
          'NIL_KOREKSI_OUT'#9'10'#9'NILAI'#9'F'#9'KELUAR~KOREKSI'
          'KELUAR_NILAI'#9'10'#9'NILAI'#9'F'#9'KELUAR~TOTAL'
          'AKHIR'#9'8'#9'KG'#9'F'#9'AKHIR'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NO_REFF'#9'11'#9'NO REFF'#9'F'
          'KETERANGAN'#9'35'#9'KETERANGAN'#9'F'
          'QTY_IN'#9'8'#9'MASUK~( KG )'#9'F'
          'QTY_OUT'#9'7'#9'KELUAR~( KG )'#9'F'
          'HARGA2'#9'11'#9'NOTA'#9'F'#9'HARGA'
          'HARGA_AVG'#9'10'#9'AVG'#9'F'#9'HARGA'
          'TGL_INSERT'#9'11'#9'TANGGAL~INSERT'#9'F'
          'OPR_INSERT'#9'13'#9'OPERATOR~INSERT'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select a.*, b.benang, trim(b.patal) as patal from' +
        ' pmtx02.vtemp_mutasi_barang a'
      'left outer join pmtx01.vitem_bb b on (a.kd_item=b.kd_item))'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000170000006F726465
      722062792062656E616E672C20706174616C0000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      0600000042454E414E4701000000000005000000504154414C010000000000}
    ...
    object QBrowsePATAL: TStringField
      FieldName = 'PATAL'
      Size = 80
    end
    ...
    object QBrowseNIL_KOREKSI_OUT: TCurrencyField
      DisplayLabel = 'NILAI_KOREKSI_OUT'
      FieldKind = fkCalculated
      FieldName = 'NIL_KOREKSI_OUT'
      DisplayFormat = '0.0,0;(0.0,0)'
      Calculated = True
    end
    object QBrowseAWAL_AVG2: TFloatField
      FieldKind = fkCalculated
      FieldName = 'AWAL_AVG2'
      DisplayFormat = '#,#;(#,#);-'
      Calculated = True
    end
    object QBrowseMASUK_AVG2: TFloatField
      FieldKind = fkCalculated
      FieldName = 'MASUK_AVG2'
      DisplayFormat = '#,#;(#,#);-'
      Calculated = True
    end
    object QBrowseKELUAR_AVG2: TFloatField
      FieldKind = fkCalculated
      FieldName = 'KELUAR_AVG2'
      DisplayFormat = '#,#;(#,#);-'
      Calculated = True
    end
  end
  ...
  object QProses: TOracleQuery
    ...
    Variables.Data = {
      ...
      310000000000060000003A504157414C0C00000007000000786E010101010100
      000000070000003A50414B4849520C00000007000000786E011F010101000000
      00}
    Left = 756
    Top = 129
  end
  object QRiwayatTransaksi: TOracleDataSet
    ...
    object QRiwayatTransaksiQTY_IN2: TFloatField
      FieldKind = fkCalculated
      FieldName = 'QTY_IN2'
      DisplayFormat = '#,##0.######;(#,##0.######);-'
      Calculated = True
    end
    object QRiwayatTransaksiQTY_OUT2: TFloatField
      FieldKind = fkCalculated
      FieldName = 'QTY_OUT2'
      DisplayFormat = '#,##0.######;(#,##0.######);-'
      Calculated = True
