object SparepartFrm: TSparepartFrm
  Left = 281
  Top = 178
  Width = 907
  Height = 600
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'ICC;CheckBox;1;0')
        Selected.Strings = (
          'KD_ITEM'#9'10'#9'KODE'#9'T'
          'KD_KEL'#9'5'#9'KODE'#9'F'#9'KELOMPOK'
          'KELOMPOK'#9'17'#9'NAMA'#9'T'#9'KELOMPOK'
          ...
          'QTY'#9'7'#9'JUMLAH'#9'F'#9'OPNAME'
          'LAST_CC'#9'8'#9'TERAKHIR'#9'F'#9'OPNAME'
          'OPR_EDIT'#9'5'#9'NAMA'#9'F'#9'EDIT'
          'TGL_EDIT'#9'17'#9'TANGGAL'#9'F'#9'EDIT')
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
        ...
        'a.kd_kel, a.nama_item, a.kd_satuan, a.no_part, a.icc, a.last_cc,' +
        ' a.qty, '
      #9#9' a.rowid, b.kelompok, c.sat1, a.tgl_edit, a.opr_edit'
      'from pmtx01.item a'
      ...
      'where a.kd_jns_item='#39'3'#39')'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      040000000E000000080000004B454C4F4D504F4B010000000000070000004B44
      ...
      000000000C0000004B445F4954454D5F4C414D41010000000000}
  ...
  object QProses: TOracleQuery
    ...
    Variables.Data = {
      ...
      330000000000060000003A504157414C0C000000070000007870090101010100
      000000070000003A50414B4849520C000000070000007870091E010101000000
      00}
    Left = 1124
    Top = 73
  end
  ...
  object QStokOpname: TOracleQuery
    SQL.Strings = (
      'begin'
      'pmtx02.proc_stok_akhir_item(:kd_jns_item,:kd_kel);'
      'commit;  '
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      03000000020000000C0000003A4B445F4A4E535F4954454D0500000002000000
      330000000000070000003A4B445F4B454C050000000300000030310000000000}
    Left = 1172
    Top = 73
  end
