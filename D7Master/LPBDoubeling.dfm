object LPBDoubelingFrm: TLPBDoubelingFrm
  Left = 227
  Top = 76
  Width = 944
  Height = 611
  Caption = 'Penerimaan Jasa Doubeling'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = '&Daftar LPB Benang Doubeling'
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'TANGGAL'#9'19'#9'TANGGAL'#9'F'
          'ISPOST'#9'6'#9'ISPOST'#9#9
          'KD_ITEM'#9'10'#9'KODE'#9'F'#9'ITEM BARANG'
          'NAMA_ITEM'#9'42'#9'NAMA'#9'F'#9'ITEM BARANG'
          'QTY'#9'7'#9'KG'#9'F'#9'ORDER'
          'QTY2'#9'10'#9'BALE'#9'F'#9'ORDER'
          'QTY_LPB'#9'10'#9'KG'#9'F'#9'DITERIMA LPB'
          'QTY_LPB2'#9'10'#9'BALE'#9'F'#9'DITERIMA LPB'
          'QTY_WASTE'#9'10'#9'KG'#9'F'#9'WASTE'
          'QTY_WASTE2'#9'10'#9'BALE'#9'F'#9'WASTE')
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KETERANGAN'#9'41'#9'NAMA / SPESIFIKASI (ALT)+(K)'#9'T'#9'BARANG/ BAHAN'
          'KD_ITEM2'#9'10'#9'KODE'#9'T'#9'BENANG HASIL DOUBELING'
          'NAMA_ITEM2'#9'23'#9'NAMA'#9'T'#9'BENANG HASIL DOUBELING'
          'QTY'#9'11'#9'KG'#9'T'#9'QTY DATA ORDER'
          'BALE'#9'10'#9'BALE'#9'T'#9'QTY DATA ORDER'
          'QTY3'#9'10'#9'KG'#9'F'#9'DITERIMA'
          'QTY4'#9'10'#9'BALE'#9'F'#9'DITERIMA'
          'QTY_WASTE'#9'10'#9'KG'#9'F'#9'WASTE'
          'QTY_WASTE2'#9'10'#9'BALE'#9'F'#9'WASTE')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
  ...
  object QTransaksi: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.bon_barang3 a'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0000004A4E535F4B4F52454B5349010000000000080000004E4F5F4E4F544132
      0100000000000800000054414E4747414C32010000000000070000004953504F
      5354320100000000000A0000004B445F52454B414E414E010000000000}
    ...
    object QTransaksiNAMA_SUPLIER: TStringField
      ...
      LookupDataSet = DMFrm.QSuplierBenang
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.bon_barang_detail3 a'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      5154595F424F4E0100000000000400000051545932010000000000080000004B
      445F4954454D3201000000000004000000515459330100000000000400000051
      545934010000000000090000005154595F57415354450100000000000A000000
      5154595F574153544532010000000000}
    Master = QTransaksi
    ...
    object QDetailNAMA_ITEM2: TStringField
      FieldKind = fkLookup
    ...
    object QDetailBALE: TFloatField
      FieldKind = fkCalculated
      FieldName = 'BALE'
      DisplayFormat = '#,##0.###;(#,##0.###)'
      Calculated = True
    ...
    object QDetailQTY_WASTE: TFloatField
      FieldName = 'QTY_WASTE'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
    object QDetailQTY_WASTE2: TFloatField
      FieldName = 'QTY_WASTE2'
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
  end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select * from pmtx02.vbon_bb_benang3 where kd_tra' +
        'nsaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
      ...
      534905000000040000004431320000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      
      005355425F544F54414C010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    ...
    object QBrowseQTY_LPB2: TFloatField
      FieldName = 'QTY_LPB2'
      Required = True
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
    object QBrowseQTY_WASTE: TFloatField
      FieldName = 'QTY_WASTE'
      Required = True
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
    object QBrowseQTY_WASTE2: TFloatField
      FieldName = 'QTY_WASTE2'
      Required = True
      DisplayFormat = '#,##0.###;(#,##0.###)'
    end
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty) as qty, sum(qty2) as qty2, sum(qty_lpb) as qty_l' +
        'pb, sum(qty_lpb2) as qty_lpb2 from (select * from pmtx02.vbon_bb' +
        '_benang3'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000004000000030000005154590100000000000400000051545932010000
      000000070000005154595F4C5042010000000000080000005154595F4C504232
      010000000000}
    Session = DMFrm.OS
    ...
    object QTotalQTY_LPB: TFloatField
      FieldName = 'QTY_LPB'
    end
    object QTotalQTY_LPB2: TFloatField
      FieldName = 'QTY_LPB2'
    end
  end
end
