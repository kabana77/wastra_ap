object UnpostFrm: TUnpostFrm
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      Caption = '&Kunci Tanggal Transaksi'
      ImageIndex = 1
      ...
      object wwDBGrid3: TwwDBGrid
        ...
        Selected.Strings = (
          'TRANS'#9'15'#9'TRANSAKSI'#9'T'
          'MUNDUR'#9'10'#9'MUNDUR'#9'F'
          'MAJU'#9'10'#9'MAJU'#9'F'
          'USER_UPDATE'#9'15'#9'USER_UPDATE'#9'T'
          'TGL_INSERT'#9'15'#9'TGL_UPDATE'#9'T')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QMaster3: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.LOCK_TRANS a'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000140000006F726465
      722062792074676C5F696E736572740000000000}
    QBEDefinition.QBEFieldDefs = {
      
      00000000}
    QueryAllRecords = False
    CountAllRecords = True
    CachedUpdates = True
    ...
    AfterPost = QMaster3AfterPost
    AfterDelete = QMaster3AfterDelete
    Left = 228
    Top = 273
    object QMaster3TRANS: TStringField
      FieldName = 'TRANS'
      Size = 15
    end
    object QMaster3KD_TRANS: TStringField
      FieldName = 'KD_TRANS'
      Size = 3
    end
    object QMaster3USER_UPDATE: TStringField
      FieldName = 'USER_UPDATE'
      Size = 15
    end
    object QMaster3TGL_INSERT: TDateTimeField
      FieldName = 'TGL_INSERT'
    end
    object QMaster3MAJU: TFloatField
      FieldName = 'MAJU'
    end
    object QMaster3MUNDUR: TFloatField
      FieldName = 'MUNDUR'
    end
    object QMaster3TABLE_NAME: TStringField
