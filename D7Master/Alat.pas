...
procedure TAlatFrm.BtnSimpanClick(Sender: TObject);
begin
...
procedure TAlatFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  BtnSimpan.Enabled:=True;
end;

procedure TAlatFrm.BtnEditingClick(Sender: TObject);
begin
...
procedure TAlatFrm.BtnBrowseClick(Sender: TObject);
begin
...
procedure TAlatFrm.FormCreate(Sender: TObject);
begin
...
procedure TAlatFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
...
procedure TAlatFrm.BtnEditing2Click(Sender: TObject);
begin
...
procedure TAlatFrm.BtnBrowse2Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TAlatFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TAlatFrm.TabSheet2Show(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TAlatFrm.FormShow(Sender: TObject);
begin
  Height:=600;
  Width:=767;
end;

procedure TAlatFrm.LookMesinEnter(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TAlatFrm.LookJenisEnter(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TAlatFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TAlatFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QMasterKELOMPOK.AsString:='ALAT';
end;

procedure TAlatFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
  QMaster2KELOMPOK.AsString:='ALAT';
end;

procedure TAlatFrm.FormCloseQuery(Sender: TObject;
...
procedure TAlatFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TAlatFrm.wwDBGrid1CalcCellColors(Sender: TObject; Field: TField;
...
procedure TAlatFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
