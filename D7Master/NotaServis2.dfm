object NotaServis2Frm: TNotaServis2Frm
  Left = 264
  Top = 157
  Width = 999
  Height = 711
      ...
      object QuickRep3: TQuickRep
        ...
        object QRBand3: TQRBand
          ...
          object QRLabel36: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'Telah diterima barang-barang hasil servis/ reparasi sbb :'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'TGL_START'#9'16'#9'MULAI'#9'F'#9'DATA ORDER'
  ...
  object QTransaksi: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000210000000700000054414E4747414C010000000000070000004E4F5F
      ...
      000053544154555332010000000000}
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'y'#39') as tgl_jadwal_bayar,ispost, mu, kd_perk_bayar,nilai,dibayar,' +
        ' sisa from pmtx02.vhutang_servis :myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000110000006F726465
      72206279204E4F5F4E4F54410000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000100000000700000054414E4747414C0100000000000A0000004B445F
      ...
      000A0000004B45544552414E47414E010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    AfterScroll = QBrowseAfterScroll
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      ...
      'begin'
        ...
        '  select count(*) into vcount from pmtx02.hutang where no_reff=:' +
        'no_nota;'
      'end;'
      ''
      '')
    Session = DMFrm.OS
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F544105000000100000003330352D
      313131302D3030303031360000000000}
    Left = 748
    Top = 105
  end
