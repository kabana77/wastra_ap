object PermintaanServis2Frm: TPermintaanServis2Frm
  Left = 234
  Top = 79
  Width = 988
  Height = 659
  Caption = 'Permintaan Servis'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = '&Daftar Permintaan Servis'
      ...
      object QuickRep2: TQuickRep
        ...
        object ColumnHeaderBand2: TQRBand
          ...
          object QRLabel13: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'NAMA BARANG/ ALAT/ KENDARAAN'
            Color = clWhite
            Font.Charset = ANSI_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          'NO_PO'#9'13'#9'NOMER'#9'F'#9'PO SERVIS'
          'TANGGAL2'#9'12'#9'TANGGAL'#9'F'#9'PO SERVIS'
          'NO_NOTA'#9'15'#9'NOMER'#9'F'#9'PERMINTAAN'
          'TANGGAL'#9'11'#9'TANGGAL'#9'F'#9'PERMINTAAN'
          'REKANAN'#9'17'#9'REKANAN'#9'F'
          'SUB_BAGIAN'#9'13'#9'SUB BAGIAN'#9'F'
          'KD_ITEM'#9'10'#9'KODE'#9'F'#9'ITEM YANG DISERVIS'
          'NAMA_ITEM'#9'35'#9'NAMA'#9'F'#9'ITEM YANG DISERVIS'
          'ISPOST'#9'6'#9'ISPOST'#9#9
          'KD_SERVIS'#9'5'#9'KODE'#9'F'#9'SERVIS'
          'NAMA_SERVIS'#9'42'#9'NAMA'#9'F'#9'SERVIS')
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KD_SERVIS'#9'10'#9'KODE'#9'T'#9'SERVIS'
          'NAMA_SERVIS'#9'28'#9'NAMA'#9'T'#9'SERVIS'
          'QTY'#9'3'#9'JUMLAH'#9'F'
          'BIAYA'#9'8'#9'BIAYA'#9'F'
          'SUB_TOTAL'#9'11'#9'SUB TOTAL'#9'T'
          'TERAKHIR_SERVIS'#9'12'#9'TERAKHIR~SERVIS'#9'T'
      ...
      object LookServis: TwwDBLookupComboDlg
        Left = 448
        Top = 296
        Width = 121
        Height = 21
        ...
        MaxHeight = 209
        Selected.Strings = (
          'NAMA_SERVIS'#9'40'#9'NAMA_SERVIS'#9'F'
          'KD_SERVIS'#9'3'#9'KODE'#9'F')
        DataField = 'KD_SERVIS'
        DataSource = dsQDetail
        LookupTable = QLookServis
        LookupField = 'KD_SERVIS'
        TabOrder = 6
        AutoDropDown = False
        ShowButton = True
        AllowClearKey = False
        OnCloseUp = LookServisCloseUp
      end
    end
  end
  ...
  object QTransaksi: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.permintaan_servis2 a'
      'where a.no_reg_servis=:no_reg_servis')
    ReadBuffer = 1
    Variables.Data = {
      03000000010000000E0000003A4E4F5F5245475F534552564953030000000000
      000000000000}
    SequenceField.Field = 'NO_REG_SERVIS'
    SequenceField.Sequence = 'PMTX02.NO_REG_PO'
    QBEDefinition.QBEFieldDefs = {
      040000001A0000000700000054414E4747414C010000000000070000004E4F5F
      ...
      
      004F50525F494E5345525432010000000000}
    ...
    object QTransaksiNO_REG_SERVIS: TIntegerField
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.servis_detail2 a'
      'where no_reg_servis = :no_reg_servis'
    ...
    Variables.Data = {
      ...
      000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000013000000070000004B445F4954454D0100000000000A0000004B4554
      ...
      
      00}
    Master = QTransaksi
    MasterFields = 'NO_REG_SERVIS'
    DetailFields = 'NO_REG_SERVIS'
    QueryAllRecords = False
    CountAllRecords = True
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    Session = DMFrm.OS
    ...
    object QDetailTERAKHIR_SERVIS: TDateTimeField
      FieldName = 'TERAKHIR_SERVIS'
    end
    ...
    object QDetailKD_SERVIS: TStringField
      FieldName = 'KD_SERVIS'
      Size = 3
    end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from (select * from pmtx02.vpermintaan_servis2b)'
      ':myparam')
    Variables.Data = {
    ...
    object QBrowseNO_REG_SERVIS: TIntegerField
      FieldName = 'NO_REG_SERVIS'
      Required = True
    end
    ...
    object QBrowseKD_SERVIS: TStringField
      FieldName = 'KD_SERVIS'
      Size = 3
    end
    object QBrowseNAMA_SERVIS: TStringField
      FieldName = 'NAMA_SERVIS'
      Size = 50
    end
  ...
  object QLookServis: TOracleDataSet
    SQL.Strings = (
      'select * from pmtx01.jns_servis')
    QBEDefinition.QBEFieldDefs = {
    ...
    Session = DMFrm.OS
    BeforeOpen = QLookServisBeforeOpen
    Left = 228
    Top = 113
    object QLookServisNAMA_SERVIS: TStringField
      DisplayWidth = 40
      FieldName = 'NAMA_SERVIS'
      Size = 50
    end
    object QLookServisKD_SERVIS: TStringField
      DisplayLabel = 'KODE'
      DisplayWidth = 3
      FieldName = 'KD_SERVIS'
      Required = True
    ...
    object QLookServisJENIS: TStringField
      DisplayWidth = 10
      FieldName = 'JENIS'
      Required = True
      Visible = False
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  delete pmtx02.servis_detail2 where no_reg_servis=:no_reg_servi' +
        's;'
      '  insert into pmtx02.servis_detail2'
      '  ('
      
        '    kd_item, no_reg_servis, qty, keterangan, terakhir_servis, la' +
        'ma, tgl_start, tgl_insert, opr_insert, kd_servis, jenis, kd_mesi' +
        'n, kd_alat, no_polisi, id_bag, id_sub_bag, status, biaya, sub_to' +
        'tal'
      '  )'
      '  (select'
      
        '    kd_item, :no_reg_servis, qty, a.keterangan, terakhir_servis,' +
        ' lama, tgl_start, sysdate, :opr_insert, kd_servis, b.jenis, kd_m' +
        'esin, kd_alat, no_polisi, id_bag, id_sub_bag, b.status, 0, sub_t' +
        'otal'
      '    from pmtx02.servis_detail a, pmtx02.permintaan_servis b'
      
        '    where a.no_reg_servis=b.no_reg_servis and b.no_nota like:no_' +
        'nota'
      '  );'
      '  commit;'
      'end;')
    ...
    Variables.Data = {
      ...
      0E0000003A4E4F5F5245475F5345525649530300000000000000000000000B00
  ...
  object QPS: TOracleDataSet
    SQL.Strings = (
      'select * from pmtx02.permintaan_servis where no_nota=:no_nota')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F5441050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      4A4B010000000000}
    ...
    Left = 698
    Top = 185
    object QPSNO_REG_SERVIS: TIntegerField
      FieldName = 'NO_REG_SERVIS'
      Required = True
    end
