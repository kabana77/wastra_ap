object MesinLainnyaFrm: TMesinLainnyaFrm
  Left = 99
  Top = 88
  Width = 748
  Height = 600
  Caption = 'Daftar Mesin Non Tenun'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        PictureMasks.Strings = (
          ...
          'ID_HAK'#9'*1{&,#}'#9'T'#9'T'
          'KD_MESIN'#9'*4{&,#}'#9'T'#9'T')
        Selected.Strings = (
          'KD_MESIN'#9'7'#9'KODE'#9'F'
          'MERK'#9'13'#9'MERK'#9'F'
          'SPESIFIKASI'#9'31'#9'SPESIFIKASI'#9'F'
          'JENIS'#9'15'#9'JENIS'#9'F'
          'TAHUN'#9'8'#9'TAHUN~RAKIT'#9'F'
          'KPS_PROD'#9'10'#9'NILAI'#9'F'#9'KAPASITAS PRODUKSI'
          'SAT_KPS'#9'10'#9'SATUAN'#9'F'#9'KAPASITAS PRODUKSI'
          'KEC_PROD'#9'10'#9'NILAI'#9'F'#9'KECEPATAN'
          'SAT_KEC'#9'9'#9'SATUAN'#9'F'#9'KECEPATAN')
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select * from (select a.*, a.rowid from pmtx01.mesin a'
      'where a.kelompok='#39'MESIN LAIN'#39')'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      00080000004B454C4F4D504F4B010000000000}
    ...
    object QMasterKPS_PROD: TFloatField
      DisplayWidth = 10
      FieldName = 'KPS_PROD'
      Visible = False
    end
    object QMasterKEC_PROD: TFloatField
      DisplayWidth = 10
      FieldName = 'KEC_PROD'
      Visible = False
    end
    object QMasterSAT_KPS: TStringField
      DisplayWidth = 12
      FieldName = 'SAT_KPS'
      Visible = False
      Size = 12
    end
    object QMasterSAT_KEC: TStringField
      DisplayWidth = 12
      FieldName = 'SAT_KEC'
      Visible = False
      Size = 12
  ...
  object QMaster2: TOracleDataSet
    SQL.Strings = (
      'select * from (select a.*, a.rowid from pmtx01.jns_mesin a'
      'where a.kelompok='#39'MESIN LAIN'#39')'
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
