...
type
  TValidasiReturBBFrm = class(TForm)
    Panel1: TPanel;
...
var
  ValidasiReturBBFrm: TValidasiReturBBFrm;
...
procedure TValidasiReturBBFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  ValidasiReturBBFrm:=Nil;
end;

procedure TValidasiReturBBFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TValidasiReturBBFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TValidasiReturBBFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TValidasiReturBBFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TValidasiReturBBFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TValidasiReturBBFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TValidasiReturBBFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
...
procedure TValidasiReturBBFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TValidasiReturBBFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TValidasiReturBBFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailOPR_INSERT.AsString:=DMFrm.QUserNAMA_USER.AsString;
  QDetailKD_LOKASI.AsString:='01';
  QDetailKD_SUB_LOKASI.AsString:='0001';
end;

procedure TValidasiReturBBFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TValidasiReturBBFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiReturBBFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TValidasiReturBBFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TValidasiReturBBFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TValidasiReturBBFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TValidasiReturBBFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TValidasiReturBBFrm.ECariChange(Sender: TObject);
begin
...
procedure TValidasiReturBBFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TValidasiReturBBFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TValidasiReturBBFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TValidasiReturBBFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TValidasiReturBBFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TValidasiReturBBFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TValidasiReturBBFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TValidasiReturBBFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TValidasiReturBBFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TValidasiReturBBFrm.FormCloseQuery(Sender: TObject;
...
procedure TValidasiReturBBFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiReturBBFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TValidasiReturBBFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TValidasiReturBBFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TValidasiReturBBFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TValidasiReturBBFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TValidasiReturBBFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TValidasiReturBBFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TValidasiReturBBFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TValidasiReturBBFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TValidasiReturBBFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TValidasiReturBBFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TValidasiReturBBFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TValidasiReturBBFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TValidasiReturBBFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TValidasiReturBBFrm.QLookLokasiBeforeOpen(DataSet: TDataSet);
begin
  QLookLokasi.SetVariable('kd_jns_item',QDetailKD_JNS_ITEM.AsString);
end;

procedure TValidasiReturBBFrm.LookLokasiCloseUp(Sender: TObject;
...
procedure TValidasiReturBBFrm.LookLokasiEnter(Sender: TObject);
begin
  QLookLokasi.Close;
  QLookLokasi.Open;
end;

procedure TValidasiReturBBFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TValidasiReturBBFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TValidasiReturBBFrm.LookSuplierCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
var
  vkota : string;
begin
...
procedure TValidasiReturBBFrm.LookSuplierEnter(Sender: TObject);
begin
  DMFrm.QSuplier.Open;
end;

procedure TValidasiReturBBFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailQTY_BALE.AsFloat:=QDetailQTY.AsFloat/cball2kg;
  QDetailHARGA_BALE.AsFloat:=QDetailHARGA.AsFloat*cball2kg;
  QDetailSUB_TOTAL.AsFloat:=QDetailHARGA.AsFloat*QDetailQTY.AsFloat;
end;

procedure TValidasiReturBBFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QSubTotal.Close;
...
procedure TValidasiReturBBFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
