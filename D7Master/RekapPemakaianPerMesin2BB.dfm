object RekapPemakaianPerMesin2BBFrm: TRekapPemakaianPerMesin2BBFrm
  Left = 89
  Top = 112
  Width = 976
  Height = 611
  Caption = 'Rekap Pemakaian BB Benang Per Unit'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'QTY_KEBUTUHAN'#9'10'#9'Bon'#9'F'#9'KG'
          'QTY_PP'#9'11'#9'Disetujui'#9'F'#9'KG'
          'QTY_KEBUTUHAN2'#9'10'#9'Bon'#9'F'#9'BALL'
          'QTY_PP2'#9'10'#9'Disetujui'#9'F'#9'BALL'
          'HARGA2'#9'10'#9'HARGA BALL'#9'F'
  ...
  object Panel4: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 523
      Height = 24
      Caption = 'REKAP PEMAKAIAN BAHAN BAKU BENANG PER UNIT'
    end
  end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'tem, sat1, sum(qty) as qty_kebutuhan, sum(qty_validasi) as qty_p' +
        'p, sum(qty/181.44) as qty_kebutuhan2, sum(qty_validasi/181.44) a' +
        's qty_pp2 from pmtx02.vbon_barang_nbb2 '
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0A0000005355425F42414749414E0100000000000E0000005154595F4B454255
      545548414E32010000000000070000005154595F505032010000000000}
    Session = DMFrm.OS
    ...
    object QBrowseQTY_KEBUTUHAN2: TFloatField
      FieldName = 'QTY_KEBUTUHAN2'
      DisplayFormat = '#,##0.0000;(#,##0.0000);-'
    end
    object QBrowseQTY_PP2: TFloatField
      FieldName = 'QTY_PP2'
      DisplayFormat = '#,##0.0000;(#,##0.0000);-'
    end
  end
