...
procedure TBengkelFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QSatuan.Close;
...
procedure TBengkelFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TBengkelFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBengkelFrm.BitBtn5Click(Sender: TObject);
var
  vtitle : String;
begin
  case PageControl1.ActivePageIndex of
  0 : begin
        vtitle:='Daftar Barang Bengkel dan Alat';
  ...
  1 : begin
        vtitle:='Kelompok Bengkel dan Alat';
        DMFrm.SaveDialog1.FileName:=vtitle;
        if DMFrm.SaveDialog1.Execute then
        begin
...
procedure TBengkelFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TBengkelFrm.BtnEditing2Click(Sender: TObject);
begin
...
procedure TBengkelFrm.BtnBrowse2Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TBengkelFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TBengkelFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBengkelFrm.TabSheet2Show(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TBengkelFrm.FormShow(Sender: TObject);
begin
  Height:=600;
  Width:=716;
end;

procedure TBengkelFrm.LookMesinEnter(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TBengkelFrm.LookJenisEnter(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TBengkelFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TBengkelFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QMasterKD_JNS_ITEM.AsString:='6';
...
procedure TBengkelFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
  QMaster2KD_JNS_ITEM.AsString:='6';
end;

procedure TBengkelFrm.FormCloseQuery(Sender: TObject;
...
procedure TBengkelFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TBengkelFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TBengkelFrm.LookSatuanEnter(Sender: TObject);
begin
  DMFrm.QSatuan.Open;
end;

procedure TBengkelFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TBengkelFrm.ECariChange(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBengkelFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBengkelFrm.QMasterBeforePost(DataSet: TDataSet);
begin
 QMasterOPR_EDIT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TBengkelFrm.BitBtn6Click(Sender: TObject);
begin
{azmi}
...
procedure TBengkelFrm.BitBtn4Click(Sender: TObject);
begin
{azmi}
if QLookUpKelKD_KEL.AsString='' then
begin
...
procedure TBengkelFrm.wwDBLookupCombo1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{azmi}
...
procedure TBengkelFrm.wwDBLookupCombo1Enter(Sender: TObject);
begin
{azmi}
QLookUpKel.Open;
{azmi}
...
procedure TBengkelFrm.BitBtn2Click(Sender: TObject);
{azmi}
var
  vuser, vpwd : string;
begin
