object InfoJurnalFrm: TInfoJurnalFrm
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet4: TTabSheet
      Caption = '&Buku pembantu kas bank'
      ImageIndex = 3
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'TANGGAL'#9'11'#9'Tanggal'#9'F'
          'KD_PERK'#9'12'#9'Kode'#9'F'#9'KAS / BANK'
          'NAMA_PERKIRAAN'#9'20'#9'Nama'#9'F'#9'KAS / BANK'
          ...
          'IS_VERIF'#9'1'#9'ISVER'#9'F'#9'VERIFIKATOR'
          'TGL_VERIF'#9'18'#9'Tanggal'#9'F'#9'VERIFIKATOR'
          'USER_VERIF'#9'8'#9'User'#9'F'#9'VERIFIKATOR'
          'CTTN_VERIF'#9'55'#9'Catatan/Koreksi'#9'F'#9'VERIFIKATOR')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
    ...
    object TabSheet5: TTabSheet
      ...
      object wwDBGrid5: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'ISTOTAL;CheckBox;1;0')
        Selected.Strings = (
          'KD_PERK'#9'15'#9'COA'#9'F'
          'REKENING'#9'35'#9'KAS / BANK'#9'F'
          'SALDO_IDR'#9'15'#9'IDR'#9'F'#9'SALDO AWAL'
          'SALDO_USD'#9'15'#9'USD'#9'F'#9'SALDO AWAL'
          'DEBET_IDR'#9'15'#9'IDR'#9'F'#9'DEBET'
          'DEBET_USD'#9'15'#9'USD'#9'F'#9'DEBET'
          'KREDIT_IDR'#9'15'#9'IDR'#9'F'#9'KREDIT'
          'KREDIT_USD'#9'15'#9'USD'#9'F'#9'KREDIT'
          'S_AKHIR_IDR'#9'15'#9'IDR'#9'F'#9'SALDO AKHIR'
          'S_AKHIR_USD'#9'15'#9'USD'#9'F'#9'SALDO AKHIR')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Cipsoft_GL'
        IniAttributes.Delimiter = ';;'
      ...
      object Panel16: TPanel
        ...
        object Panel17: TPanel
          ...
          object cbSaldo: TCheckBox
            Left = 11
            Top = 3
            Width = 206
            Height = 17
            Caption = 'Yang ada saldo / mutasinya saja'
            TabOrder = 5
            OnClick = cbSaldoClick
          end
        end
      end
    end
    object TabSheet6: TTabSheet
      Caption = 'Pembayaran PPH 23'
      ImageIndex = 5
      object wwDBGrid6: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'ISTOTAL;CheckBox;1;0')
        Selected.Strings = (
          'KD_REKANAN'#9'5'#9'KD REKANAN'#9'F'
          'NO_NOTA_HTG'#9'15'#9'NO NOTA'#9'F'#9'NOTA UTANG'
          'TGL_HTG'#9'18'#9'TANGGAL'#9'F'#9'NOTA UTANG'
          'UM'#9'10'#9'UM'#9'F'#9'NOTA UTANG'
          'NIL_HTG'#9'10'#9'NILAI HUTANG'#9'F'
          'DIBAYAR'#9'10'#9'DIBAYAR'#9'F'
  ...
  object Panel4: TPanel
    ...
    Alignment = taLeftJustify
    BevelOuter = bvNone
    Caption = '   BUKU PEMBANTU KAS dan BANK'
    Color = 206
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -19
  ...
  object QBrowse4: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00000000070000004E4F5F4C494E450100000000000800000049535F56455249
      460100000000000A000000555345525F56455249460100000000000900000054
      474C5F56455249460100000000000A0000004354544E5F564552494601000000
      0000}
    QueryAllRecords = False
    Session = DMFrm.OS
    AfterScroll = QBrowseAfterScroll
    ...
    object QBrowse4IS_VERIF: TStringField
      FieldName = 'IS_VERIF'
      Size = 1
    end
    object QBrowse4USER_VERIF: TStringField
      FieldName = 'USER_VERIF'
      Size = 15
    end
    object QBrowse4TGL_VERIF: TDateTimeField
      FieldName = 'TGL_VERIF'
      DisplayFormat = 'dd/mm/yyyy'
    end
    object QBrowse4CTTN_VERIF: TStringField
      FieldName = 'CTTN_VERIF'
      Size = 255
    end
  end
  ...
  object QRekap_RB: TOracleDataSet
    SQL.Strings = (
      'select a.* from pmtx99.temp_saldo_rek_bank a'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000160000006F726465
      72206279204D552C2072656B656E696E670000000000}
    QBEDefinition.QBEFieldDefs = {
      
      5F5045524B010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    AfterScroll = QBrowseAfterScroll
    OnCalcFields = QRekap_RBCalcFields
    OnFilterRecord = QRekap_RBFilterRecord
    Left = 460
    Top = 209
    object QRekap_RBREKENING: TStringField
      FieldName = 'REKENING'
      Size = 50
    end
    object QRekap_RBSALDO_IDR: TFloatField
      FieldName = 'SALDO_IDR'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QRekap_RBSALDO_USD: TFloatField
      FieldName = 'SALDO_USD'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QRekap_RBDEBET_IDR: TFloatField
      FieldName = 'DEBET_IDR'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QRekap_RBDEBET_USD: TFloatField
      FieldName = 'DEBET_USD'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QRekap_RBKREDIT_IDR: TFloatField
      FieldName = 'KREDIT_IDR'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QRekap_RBKREDIT_USD: TFloatField
      FieldName = 'KREDIT_USD'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QRekap_RBS_AKHIR_IDR: TFloatField
      FieldKind = fkCalculated
      FieldName = 'S_AKHIR_IDR'
      DisplayFormat = '0.0,0;(0.0,0);-'
      Calculated = True
    end
    object QRekap_RBS_AKHIR_USD: TFloatField
      FieldKind = fkCalculated
      FieldName = 'S_AKHIR_USD'
      DisplayFormat = '0.0,0;(0.0,0);-'
      Calculated = True
    end
    object QRekap_RBKD_PERK: TStringField
      FieldName = 'KD_PERK'
    end
  end
  object dsQRekap_RB: TwwDataSource
    DataSet = QRekap_RB
    Left = 516
    Top = 297
  end
  object QProc_Rekap_RB: TOracleQuery
    SQL.Strings = (
      'begin'
      '  commit;'
      '   pmtx99.proc_saldo_rek_bank(:vsysdate, :vsysdate2);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000002000000090000003A56535953444154450C00000007000000787601
  ...
  object QBrowse6: TOracleDataSet
    SQL.Strings = (
      'select a.*'
      'from pmtx99.vpph23_status_pembayaran a'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      520100000000000400000053495341010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    AfterScroll = QBrowseAfterScroll
    Left = 20
    Top = 1
    object QBrowse6KD_REKANAN: TStringField
      FieldName = 'KD_REKANAN'
      Size = 5
    end
    object QBrowse6TGL_HTG: TDateTimeField
      FieldName = 'TGL_HTG'
    end
    object QBrowse6NO_REG_HUTANG: TIntegerField
      FieldName = 'NO_REG_HUTANG'
      Required = True
    end
    object QBrowse6NO_NOTA_HTG: TStringField
      FieldName = 'NO_NOTA_HTG'
      Size = 15
    end
    object QBrowse6NIL_HTG: TFloatField
      FieldName = 'NIL_HTG'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QBrowse6UM: TFloatField
      FieldName = 'UM'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QBrowse6DIBAYAR: TFloatField
      FieldName = 'DIBAYAR'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QBrowse6SISA: TFloatField
      FieldName = 'SISA'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
  end
