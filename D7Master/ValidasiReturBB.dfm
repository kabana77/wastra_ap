object ValidasiReturBBFrm: TValidasiReturBBFrm
  Left = 211
  Top = 127
  Width = 901
  Height = 611
  Caption = 'Validasi Retur Bahan Baku'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'QTY_STOK'#9'7'#9'STOK~GUDANG'#9'T'#9'JUMLAH'
          'QTY_BON'#9'6'#9'Retur (KG)'#9'T'#9'JUMLAH'
          'QTY'#9'8'#9'VALIDASI~( KG)'#9'F'
          'HARGA'#9'10'#9'HARGA~PER KG'#9'F'
