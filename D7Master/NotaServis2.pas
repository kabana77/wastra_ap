...
var
  NotaServis2Frm: TNotaServis2Frm;
...
procedure TNotaServis2Frm.FormClose(Sender: TObject;
...
procedure TNotaServis2Frm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TNotaServis2Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TNotaServis2Frm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TNotaServis2Frm.cbTanggalClick(Sender: TObject);
begin
...
procedure TNotaServis2Frm.QTransaksiAfterPost(DataSet: TDataSet);
begin
//  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TNotaServis2Frm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TNotaServis2Frm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TNotaServis2Frm.TabSheet2Show(Sender: TObject);
begin
...
procedure TNotaServis2Frm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TNotaServis2Frm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TNotaServis2Frm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TNotaServis2Frm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TNotaServis2Frm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TNotaServis2Frm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TNotaServis2Frm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TNotaServis2Frm.ECariChange(Sender: TObject);
begin
...
procedure TNotaServis2Frm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TNotaServis2Frm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vrgTanggal : String;
...
procedure TNotaServis2Frm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TNotaServis2Frm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vnomer:=0;
...
procedure TNotaServis2Frm.BitBtn5Click(Sender: TObject);
begin
...
procedure TNotaServis2Frm.TabSheet1Show(Sender: TObject);
begin
...
procedure TNotaServis2Frm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TNotaServis2Frm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TNotaServis2Frm.FormCloseQuery(Sender: TObject;
...
procedure TNotaServis2Frm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TNotaServis2Frm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TNotaServis2Frm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TNotaServis2Frm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TNotaServis2Frm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TNotaServis2Frm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TNotaServis2Frm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TNotaServis2Frm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TNotaServis2Frm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TNotaServis2Frm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TNotaServis2Frm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TNotaServis2Frm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TNotaServis2Frm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TNotaServis2Frm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TNotaServis2Frm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TNotaServis2Frm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TNotaServis2Frm.LookMUEnter(Sender: TObject);
begin
  DMFrm.QMU.Open;
end;

procedure TNotaServis2Frm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
...
procedure TNotaServis2Frm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vdpp:=0;
  vppn:=0;
...
procedure TNotaServis2Frm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if vfirst_page then
  begin
...
procedure TNotaServis2Frm.PageHeaderBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vfirst_page:=False;
end;

procedure TNotaServis2Frm.QBrowseDetailBeforeOpen(DataSet: TDataSet);
begin
//  QBrowseDetail.SetVariable('no_reg_po',QBrowseNO_REG_PO.AsInteger);
end;

procedure TNotaServis2Frm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer);
...
procedure TNotaServis2Frm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer2);
...
procedure TNotaServis2Frm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QSuplier.Close;
...
procedure TNotaServis2Frm.LookSuplierEnter(Sender: TObject);
begin
  QSuplier.Open;
end;

procedure TNotaServis2Frm.LookSuplierCloseUp(Sender: TObject;
...
procedure TNotaServis2Frm.LookSuplierUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QSuplier.Close;
  QSuplier.Open;
...
procedure TNotaServis2Frm.QJurnalNewRecord(DataSet: TDataSet);
begin
...
procedure TNotaServis2Frm.wwDBGrid3UpdateFooter(Sender: TObject);
begin
  QTotal2.Close;
...
procedure TNotaServis2Frm.QTotalBeforeOpen(DataSet: TDataSet);
var
  vsql : String;
begin
...
procedure TNotaServis2Frm.LookPerkiraanEnter(Sender: TObject);
begin
  QPerkiraan.Open;
end;

procedure TNotaServis2Frm.LookPerkiraanHPEnter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TNotaServis2Frm.LookMUCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TNotaServis2Frm.BitBtn3Click(Sender: TObject);
begin
   DMFrm.QDateTime.Close;
  DMFrm.QDateTime.Open;
  case PageControl1.ActivePageIndex of
...
procedure TNotaServis2Frm.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 if QTransaksiISPOST.AsString='1' then
      QRLabel15.Caption:='BERITA ACARA SERVIS'
    else
...
procedure TNotaServis2Frm.QDetailCalcFields(DataSet: TDataSet);
begin
