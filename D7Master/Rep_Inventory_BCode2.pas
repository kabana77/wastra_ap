...
type
  TRep_Inventory_BCode2_FRM = class(TQuickRep)
    QRBand3: TQRBand;
    BC11: TQRLabel;
    QRDBText1: TQRDBText;
    QRBand5: TQRBand;
...
var
  Rep_Inventory_BCode2_FRM: TRep_Inventory_BCode2_FRM;
...
procedure TRep_Inventory_BCode2_FRM.QuickRepBeforePrint(
...
procedure TRep_Inventory_BCode2_FRM.QRBand3BeforePrint(
