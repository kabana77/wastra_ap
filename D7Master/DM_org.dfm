object DMFrm: TDMFrm
  ...
  object QUser: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000090000000700000049445F55534552010000000000090000004E414D
  ...
  object FNo_Nota_PMTX99: TOracleDataSet
    SQL.Strings = (
        ...
        'select pmtx99.fno_nota(:pkode, :pispjk, :ptgl) as no_nota from d' +
        'ual')
    Variables.Data = {
      0300000003000000060000003A504B4F44450500000000000000000000000700
      00003A504953504A4B050000000000000000000000050000003A5054474C0C00
  ...
  object QHakPerkiraan: TOracleDataSet
    SQL.Strings = (
        ...
        'where a.kd_perk=b.kd_perk and a.kd_perk like :kd_perk and a.id_u' +
        'ser=:id_user')
    Variables.Data = {
      0300000002000000080000003A49445F55534552050000000000000000000000
      080000003A4B445F5045524B0500000002000000250000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000030000000700000049445F55534552010000000000070000004B445F
      5045524B010000000000020000004D55010000000000}
    Session = OS
    Left = 624
    Top = 96
  ...
  object OSKlego: TOracleSession
    LogonUsername = 'pmtx01'
    LogonPassword = 'koncar26327'
    LogonDatabase = 'KLEGO'
    Left = 208
    Top = 56
