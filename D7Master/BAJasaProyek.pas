...
var
  BAJasaProyekFrm: TBAJasaProyekFrm;

implementation

uses DM, MainBrowse, Main, Menus, XPROCS, DateUtils, Keterangan, Sisdur,
  {QRNotaServis,} BAJasa2;

{$R *.dfm}

procedure TBAJasaProyekFrm.FormClose(Sender: TObject;
...
procedure TBAJasaProyekFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TBAJasaProyekFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBAJasaProyekFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TBAJasaProyekFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TBAJasaProyekFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
//  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TBAJasaProyekFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TBAJasaProyekFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TBAJasaProyekFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TBAJasaProyekFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TBAJasaProyekFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBAJasaProyekFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TBAJasaProyekFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TBAJasaProyekFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TBAJasaProyekFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TBAJasaProyekFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TBAJasaProyekFrm.ECariChange(Sender: TObject);
begin
...
procedure TBAJasaProyekFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBAJasaProyekFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vrgTanggal : String;
...
procedure TBAJasaProyekFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TBAJasaProyekFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vnomer:=0;
...
procedure TBAJasaProyekFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TBAJasaProyekFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TBAJasaProyekFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBAJasaProyekFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TBAJasaProyekFrm.FormCloseQuery(Sender: TObject;
...
procedure TBAJasaProyekFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TBAJasaProyekFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TBAJasaProyekFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TBAJasaProyekFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBAJasaProyekFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBAJasaProyekFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TBAJasaProyekFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TBAJasaProyekFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TBAJasaProyekFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TBAJasaProyekFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TBAJasaProyekFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TBAJasaProyekFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBAJasaProyekFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TBAJasaProyekFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBAJasaProyekFrm.BtnFormulasiClick(Sender: TObject);
begin
  if (ENoNota.Text='') or (QTransaksiMU.AsString='') or (QTransaksiKD_PERK.AsString='') then
    ShowMessage('Jenis Hutang, Mata Uang !')
    else
    begin
        if (QTransaksiISPOST.AsString='0') then
        begin
...
procedure TBAJasaProyekFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TBAJasaProyekFrm.LookMUEnter(Sender: TObject);
begin
  DMFrm.QMU.Open;
end;

procedure TBAJasaProyekFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
...
procedure TBAJasaProyekFrm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vdpp:=0;
  vppn:=0;
...
procedure TBAJasaProyekFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if vfirst_page then
  begin
...
procedure TBAJasaProyekFrm.PageHeaderBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vfirst_page:=False;
end;

procedure TBAJasaProyekFrm.QBrowseDetailBeforeOpen(DataSet: TDataSet);
begin
//  QBrowseDetail.SetVariable('no_reg_po',QBrowseNO_REG_PO.AsInteger);
end;

procedure TBAJasaProyekFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer);
...
procedure TBAJasaProyekFrm.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer2);
...
procedure TBAJasaProyekFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QSuplier.Close;
...
procedure TBAJasaProyekFrm.LookSuplierEnter(Sender: TObject);
begin
QPO.close;
...
procedure TBAJasaProyekFrm.LookSuplierCloseUp(Sender: TObject;
...
procedure TBAJasaProyekFrm.LookSuplierUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QSuplier.Close;
  QSuplier.Open;
...
procedure TBAJasaProyekFrm.QJurnalNewRecord(DataSet: TDataSet);
begin
...
procedure TBAJasaProyekFrm.wwDBGrid3UpdateFooter(Sender: TObject);
begin
{  QTotal2.Close;
...
procedure TBAJasaProyekFrm.QTotalBeforeOpen(DataSet: TDataSet);
var
  vsql : String;
begin
...
procedure TBAJasaProyekFrm.LookPerkiraanEnter(Sender: TObject);
begin
  QPerkiraan.Open;
end;

procedure TBAJasaProyekFrm.LookPerkiraanHPEnter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).LookupTable.Open;
end;

procedure TBAJasaProyekFrm.LookMUCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
...
procedure TBAJasaProyekFrm.BitBtn3Click(Sender: TObject);
begin
   DMFrm.QDateTime.Close;
  DMFrm.QDateTime.Open;
  case PageControl1.ActivePageIndex of
...
procedure TBAJasaProyekFrm.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 if QTransaksiISPOST.AsString='1' then
...
procedure TBAJasaProyekFrm.QDetailCalcFields(DataSet: TDataSet);
begin
Qdetailsub_total.AsFloat:=qdetailharga.AsFloat*qdetailqty.Asfloat;
end;

procedure TBAJasaProyekFrm.Btn_filterClick(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TBAJasaProyekFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TBAJasaProyekFrm.Vtglawal2Change(Sender: TObject);
begin
