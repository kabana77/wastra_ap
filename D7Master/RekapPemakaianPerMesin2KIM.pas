unit RekapPemakaianPerMesin2KIM;
...
type
  TRekapPemakaianPerMesin2KIMFrm = class(TForm)
    Panel1: TPanel;
    ...
    QBrowseQTY_VALIDASI3: TFloatField;
...
var
  RekapPemakaianPerMesin2KIMFrm: TRekapPemakaianPerMesin2KIMFrm;
...
procedure TRekapPemakaianPerMesin2KIMFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  RekapPemakaianPerMesin2KIMFrm:=Nil;
end;

procedure TRekapPemakaianPerMesin2KIMFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TRekapPemakaianPerMesin2KIMFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TRekapPemakaianPerMesin2KIMFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_kebutuhan',vkd_jns_kebutuhan);
end;

procedure TRekapPemakaianPerMesin2KIMFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TRekapPemakaianPerMesin2KIMFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vdd, vmm, vyy : word;
...
//  QBrowse.DisableControls;
  ...
  begin
    ...
    vtotal:=vtotal+(QBrowseHARGA.AsFloat*QBrowseQTY_VALIDASI.AsFloat);
    vkg:=vkg+QBrowseQTY_VALIDASI.AsFloat;
    QBrowse.Next;
  end;
  QBrowse.First;
  QBrowse.EnableControls;
  wwDBGrid1.ColumnByName('SUB_TOTAL').FooterValue:=FormatFloat('#,#;(#,#)',vtotal);
  wwDBGrid1.ColumnByName('QTY_VALIDASI').FooterValue:=FormatFloat('#,#;(#,#)',vkg);
  wwDBGrid1.ColumnByName('QTY_VALIDASI2').FooterValue:=FormatFloat('#,##0.0000;(#,##0.0000);-',vkg/1000);
  LRecords.Caption:='Jml. Record : '+FormatFloat('#,#',QBrowse.RecordCount);
end;

procedure TRekapPemakaianPerMesin2KIMFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
end;

procedure TRekapPemakaianPerMesin2KIMFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
//  QBrowse.SetVariable('kd_transaksi','%');
end;

procedure TRekapPemakaianPerMesin2KIMFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=Caption;
end;

procedure TRekapPemakaianPerMesin2KIMFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.FormCloseQuery(Sender: TObject;
...
procedure TRekapPemakaianPerMesin2KIMFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TRekapPemakaianPerMesin2KIMFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TRekapPemakaianPerMesin2KIMFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TRekapPemakaianPerMesin2KIMFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TRekapPemakaianPerMesin2KIMFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TRekapPemakaianPerMesin2KIMFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TRekapPemakaianPerMesin2KIMFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TRekapPemakaianPerMesin2KIMFrm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  Inc(vnomer);
end;

procedure TRekapPemakaianPerMesin2KIMFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseHARGA2.AsFloat:=QBrowseHARGA.AsFloat;
  QBrowseSUB_TOTAL.AsFloat:=QBrowseHARGA.AsFloat*QBrowseQTY_PP.AsFloat;
end;

procedure TRekapPemakaianPerMesin2KIMFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TRekapPemakaianPerMesin2KIMFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TRekapPemakaianPerMesin2KIMFrm.wwDBGrid1TitleButtonClick(
...
procedure TRekapPemakaianPerMesin2KIMFrm.TabSheet2Show(Sender: TObject);
begin
  QDetail2.DisableControls;
  QDetail2.Close;
  QDetail2.SetVariable('vjns','2');
...
procedure TRekapPemakaianPerMesin2KIMFrm.cbAllClick(Sender: TObject);
begin
  QDetail2.DisableControls;
  QDetail2.Close;
  QDetail2.SetVariable('vjns','2');
