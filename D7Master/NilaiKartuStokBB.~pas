...
type
  TNilaiKartuStokBBFrm = class(TForm)
    ...
    QBrowseAWAL_AVG2: TFloatField;
    QBrowseMASUK_AVG2: TFloatField;
    QBrowseKELUAR_AVG2: TFloatField;
...
begin
  ...
  begin
    ...
    LMDProgress1.Position:=i;
      ...
      w7:=w7+QBrowseNILAI_PAKAI.AsFloat;
      w8:=w8+QBrowseNIL_KOREKSI_OUT.AsFloat;
      QBrowse.Next;
  end;
  QBrowse.First;
  QBrowse.EnableControls;
