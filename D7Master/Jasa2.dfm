object JasaProyek1Frm: TJasaProyek1Frm
  Left = 283
  Top = 119
  Width = 1013
  Height = 611
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = '&Daftar Permintaan Jasa Proyek'
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          'BAGIAN'#9'35'#9'BAGIAN'#9'F'
          'SUB_BAGIAN'#9'35'#9'SUB BAGIAN'#9'F'
          'NO_NOTA'#9'15'#9'Nomor'#9'F'#9'NOTA'
          'TANGGAL'#9'11'#9'Tanggal'#9'F'#9'NOTA'
          'KD_ITEM'#9'10'#9'KODE'#9'F'#9'ITEM YANG DISERVIS'
          'NAMA_ITEM'#9'38'#9'Deskripsi'#9'F'#9'ITEM YANG DISERVIS'
          'QTY'#9'10'#9'Jumlah'#9'F'#9'ITEM YANG DISERVIS'
          'JENIS'#9'10'#9'JENIS'#9'F'
          'TGL_START'#9'18'#9'Tanggal~Mulai'#9'F'
          'LAMA'#9'10'#9'Perkiraan~Selesai (hari)'#9'F')
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        PictureMasks.Strings = (
          ...
          'ID_USER'#9'*3{&,#}'#9'T'#9'T')
        Selected.Strings = (
          'ID_BAG'#9'3'#9'Dept'#9'F'#9'DIBEBANKAN'
          'ID_SUB_BAG'#9'3'#9'Sub Dept'#9'T'#9'DIBEBANKAN'
          'KD_ITEM'#9'16'#9'Kode'#9'T'#9'JASA'
          'KETERANGAN'#9'46'#9'NAMA / SPESIFIKASI (ALT)+(K)'#9'F'#9'JASA'
          'QTY'#9'3'#9'JUMLAH'#9'F'
          'TGL_START'#9'12'#9'TANGGAL~MULAI'#9'F'
          'LAMA'#9'10'#9'TGL SELESAI~(Perkiraan)'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
    ...
    object TabSheet3: TTabSheet
      Caption = 'Realisasi Order Jasa Proyek'
      ImageIndex = 2
      ...
      object wwDBGrid20: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_SERVIS'#9'50'#9'NAMA'#9'F'#9'SERVIS'
          'JENIS'#9'10'#9'JENIS'#9'F'
          'KD_REKANAN'#9'20'#9'KODE'#9'F'#9'REKANAN'
  ...
  object QDetail: TOracleDataSet
    ...
    Variables.Data = {
      ...
      00000000}
    QBEDefinition.QBEFieldDefs = {
      0400000015000000070000004B445F4954454D0100000000000A0000004B4554
      ...
      445F41534554010000000000090000004449534B5249505349010000000000}
    Master = QTransaksi
  ...
  object QLookItem: TOracleDataSet
    SQL.Strings = (
      'select * from :myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D0100000027000000706D7478
      30312E6974656D5F6A617361207768657265206B645F6A617361203D20274A30
      35270000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000006000000050000004A454E4953010000000000070000004B445F4A41
      5341010000000000070000004B445F4954454D010000000000090000004E414D
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from (select * from pmtx02.vpermintaan_jasa_proyek'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000170000000C0000004B445F5452414E53414B53490100000000000700
      ...
      49534B5249505349010000000000030000005154590100000000000900000054
      474C5F5354415254010000000000040000004C414D41010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    ...
    object QBrowseLAMA: TIntegerField
      FieldName = 'LAMA'
    end
  end
  ...
  object QLookSubBagian: TOracleDataSet
    ...
    Variables.Data = {
      ...
      7265206B645F7472616E73616B73693D274A5332270000000000}
    QBEDefinition.QBEFieldDefs = {
