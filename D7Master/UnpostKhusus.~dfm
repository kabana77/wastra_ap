object UnpostKhususFrm: TUnpostKhususFrm
  Left = 282
  Top = 136
  Width = 952
  Height = 513
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select t.*, t.rowid from'
        ...
        '(select a.* from pmtx02.permintaan_unpost a where kd_transaksi i' +
        'n ('#39'B00'#39','#39'B01'#39','#39'V00'#39','#39'V01'#39')) t'
      ':myparam')
    Variables.Data = {
