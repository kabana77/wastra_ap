object BAJasa2Frm: TBAJasa2Frm
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object QuickRep3: TQuickRep
        ...
        object QRBand3: TQRBand
          ...
          object QRLabel36: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'Telah diterima jasa sbb :'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        ControlType.Strings = (
          'ISPOST;CheckBox;1;0')
        Selected.Strings = (
          'NO_NOTA'#9'15'#9'NO BA'#9'F'#9'JASA'
          'TANGGAL'#9'11'#9'TANGGAL'#9'F'#9'JASA'
          'KETERANGAN'#9'36'#9'DISKRIPSI'#9'F'#9'JASA'
          'QTY'#9'8'#9'QTY'#9'F'
          'PP_JASA'#9'15'#9'PO JASA'#9'F'
          'NO_JASA'#9'15'#9'PP JASA'#9'F'
          'KD_REKANAN'#9'5'#9'KODE'#9'F'#9'REKANAN'
          'REKANAN'#9'34'#9'NAMA'#9'F'#9'REKANAN'
          'MU'#9'4'#9'MU'#9'F'
          'TGL_JTH_TEMPO'#9'12'#9'JATUH~TEMPO'#9'F'
          'TGL_JADWAL_BAYAR'#9'10'#9'RE-SKEDUL'#9'F'
          'KD_PERK_BAYAR'#9'8'#9'KASIR'#9'F'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Height = 203
        Selected.Strings = (
          'ID_BAG'#9'6'#9'SUB.~DEPT.'#9'T'#9'BEBANKAN KE'
          'ID_SUB_BAG'#9'6'#9'SECT.'#9'T'#9'BEBANKAN KE'
          'KD_ASET'#9'15'#9'Kode'#9'T'#9'ASET'
          'DISKRIPSI'#9'40'#9'Nama Aset'#9'T'#9'ASET'
          'KD_ITEM'#9'9'#9'KODE'#9'T'#9'JASA'
          'KETERANGAN'#9'50'#9'DISKRIPSI'#9'T'#9'JASA'
          'TGL_START'#9'16'#9'MULAI'#9'T'#9'DATA ORDER'
          'NAMA_JASA'#9'24'#9'JENIS JASA'#9'T'
          'QTY'#9'7'#9'JUMLAH'#9'F'
    ...
    object TabSheet3: TTabSheet
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        Height = 474
        Selected.Strings = (
          'BAGIAN'#9'18'#9'SUB DEP'#9'F'
          'SUB_BAGIAN'#9'18'#9'SECTION'#9'F'
          'TANGGAL'#9'18'#9'TANGGAL'#9'F'#9'BERITA ACARA'
          'NO_BA'#9'18'#9'NO_BA'#9'F'#9'BERITA ACARA'
          'NO_PO'#9'18'#9'NO_PO'#9'F'
          'REKANAN2'#9'30'#9'REKANAN'#9'F'
          'KETERANGAN'#9'20'#9'KETERANGAN'#9'F'
          'ITEM_JASA'#9'25'#9'ITEM_JASA'#9'F'
          'QTY_PO'#9'10'#9'QTY_PO'#9'F'
          'QTY_LPB'#9'10'#9'QTY_LPB'#9'F'
          'SELISIH'#9'10'#9'SELISIH'#9'F')
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
        ExportOptions.ExportType = wwgetSYLK
        TitleColor = clSkyBlue
    ...
    object TabSheet4: TTabSheet
      Caption = 'Penerimaan Barang Jasa'
      ImageIndex = 3
      object PageControl2: TPageControl
        ...
        object TabSheet5: TTabSheet
          ...
          object QuickRep4: TQuickRep
            ...
            object QRBand9: TQRBand
              ...
              object QRLabel59: TQRLabel
                ...
                AutoSize = True
                AutoStretch = False
                Caption = 'PENERIMAAN BARANG JASA / SERVIS'
                Color = clWhite
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clWindowText
                Font.Height = -15
          ...
          object Panel15: TPanel
            ...
            object LookSuplier2: TwwDBLookupComboDlg
              ...
              MaxHeight = 209
              UserButton1Caption = '&Refresh'
              OnUserButton1Click = LookSuplier2UserButton1Click
              Selected.Strings = (
                'NAMA_REKANAN'#9'35'#9'NAMA_REKANAN'#9#9
                'KD_REKANAN'#9'5'#9'KODE'#9#9
          ...
          object wwDBGrid5: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NO_NOTA_PO_JB'#9'20'#9'NO. PO JASA'#9'T'
              'NAMA_BARANG'#9'50'#9'NAMA BARANG'#9'T'
              'QTY'#9'6'#9'JUMLAH'#9'F'
        ...
        object TabSheet6: TTabSheet
          ...
          object wwDBGrid6: TwwDBGrid
            ...
            Selected.Strings = (
              'NO_REG_BA_JB'#9'10'#9'NO. REG'#9'F'
              'NO_NOTA'#9'15'#9'BA JASA BARANG'#9'F'#9'NO. NOTA'
              'NO_NOTA_PO_JB'#9'15'#9'PO JASA BARANG'#9'F'#9'NO. NOTA'
              'NO_NOTA_JB'#9'15'#9'JASA BARANG'#9'F'#9'NO. NOTA'
              'TANGGAL'#9'18'#9'TANGGAL'#9'F'#9'BARANG JASA'
              'NAMA_BARANG'#9'50'#9'NAMA'#9'F'#9'BARANG JASA'
              'QTY'#9'6'#9'JUMLAH'#9'F'#9'BARANG JASA'
              'SATUAN'#9'15'#9'SATUAN'#9'F'#9'BARANG JASA'
              'KETERANGAN'#9'50'#9'KETERANGAN'#9'F'#9'BARANG JASA'
              'REKANAN'#9'50'#9'REKANAN'#9'F'
              'ISPOST'#9'1'#9'APPROVE'#9'F'
              'OPR_INSERT'#9'20'#9'OPERATOR INSERT'#9'F')
            IniAttributes.Enabled = True
            IniAttributes.SaveToRegistry = True
            IniAttributes.FileName = 'Pismatex Master'
            IniAttributes.Delimiter = ';;'
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid, b.nama_jasa from pmtx02.ba_jasa_detail a'
      
        'left outer join pmtx01.jns_jasa b on (a.kd_jasa=b.kd_jasa and b.' +
        'jenis=a.jenis)'
      'where no_reg_ba = :no_reg_ba'
      'order by a.tgl_insert')
    ReadBuffer = 10
    Variables.Data = {
      03000000010000000A0000003A4E4F5F5245475F424103000000040000004601
      000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      0100000000000D0000004E4F5F5245475F485554414E47010000000000}
    Master = QTransaksi
    MasterFields = 'NO_REG_BA'
    DetailFields = 'NO_REG_BA'
    ...
    object QDetailNO_REG_BA: TIntegerField
      FieldName = 'NO_REG_BA'
    end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select no_reg_ba, kd_transaksi, keterangan, no_nota, tanggal, pp' +
        '_jasa, no_jasa, kd_rekanan, rekanan, tgl_jth_tempo, '
      
        'to_date(decode(tgl_jth_tempo,tgl_jadwal_bayar,null,tgl_jadwal_ba' +
        'yar),'#39'dd-mm-yyyy'#39') as tgl_jadwal_bayar,ispost, mu, '
      'kd_perk_bayar,nilai,dibayar, sisa, qty'
      'from pmtx02.vba_jasa :myparam')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      4152010000000000050000004E494C41490100000000000A0000004B45544552
      414E47414E0100000000000700000050505F4A41534101000000000009000000
      4E4F5F5245475F4241010000000000070000004E4F5F4A415341010000000000
    ...
    object QBrowseNO_REG_BA: TIntegerField
      FieldName = 'NO_REG_BA'
    end
    ...
    object QBrowsePP_JASA: TStringField
      FieldName = 'PP_JASA'
    end
    ...
    object QBrowseNO_JASA: TStringField
      FieldName = 'NO_JASA'
      Size = 15
    end
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      'begin'
      '  delete pmtx02.ba_jasa_detail where no_reg_ba=:no_reg_ba;'
      '  insert into pmtx02.ba_jasa_detail'
      '  ('
      
        '   no_reg_ba, no_reg_jasa, kd_item, keterangan, qty, harga, tgl_' +
        'start, tgl_selesai, id_bag, id_sub_bag, kd_jasa, jenis,'
      '   tanggal2, no_nota2, kd_aset, diskripsi, no_reg_jasa_d'
      '  )'
      '  (select'
      
        '   :no_reg_ba, b.no_reg_jasa, kd_item, a.keterangan, qty, biaya,' +
        ' trunc(tgl_start), trunc(terakhir_jasa), id_bag, id_sub_bag, kd_' +
        'jasa, a.jenis,'
      
        '   trunc(b.tanggal2), :no_nota, kd_aset, diskripsi, a.no_reg_jas' +
        'a_d'
      '   from pmtx02.po_jasa_detail a, pmtx02.po_jasa b'
      
        '   where (a.no_reg_jasa=b.no_reg_jasa and b.no_nota2 = :no_nota ' +
        'and b.status='#39'OPEN'#39' AND b.kd_transaksi = '#39'305'#39') '
      '  );'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      03000000020000000A0000003A4E4F5F5245475F424103000000000000000000
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      '')
    Variables.Data = {
      03000000020000000A0000003A4E4F5F5245475F4241010000000E0000006E6F
      5F7265675F687574616E670000000000080000003A4D59504152414D01000000
      0000000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowseDetail: TOracleDataSet
    SQL.Strings = (
      ...
      'where no_reg_hutang=:no_reg_ba'
      'order by a.tgl_insert'
      '')
    Variables.Data = {
      03000000010000000A0000003A4E4F5F5245475F424103000000000000000000
      0000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QJurnal: TOracleDataSet
    SQL.Strings = (
      ...
      'where a.no_reg_hutang = :no_reg_ba and a.kredit=0 and a.isll='#39'1'#39)
    Variables.Data = {
      03000000010000000A0000003A4E4F5F5245475F424103000000000000000000
      0000}
  ...
  object QJurnal2: TOracleDataSet
    SQL.Strings = (
      ...
      'where no_reg_hutang=:no_reg_ba')
    Variables.Data = {
      03000000010000000A0000003A4E4F5F5245475F424103000000040000006500
      000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QPO: TOracleDataSet
    SQL.Strings = (
      'select a.kd_rekanan2 as kd_rekanan'
      'from pmtx02.po_jasa a'
      'where a.no_nota2 = :no_nota')
    Variables.Data = {
  ...
  object QCekPPN: TOracleDataSet
    SQL.Strings = (
      'select a.ppn, a.ispjk, um, status from pmtx02.po_jasa a'
      'where a.no_nota2=:no_nota')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F5441050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000004000000050000004953504A4B0100000000000300000050504E0100
      0000000002000000554D01000000000006000000535441545553010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 540
    ...
    object QCekPPNSTATUS: TStringField
      FieldName = 'STATUS'
      Size = 6
    end
  end
  object QTransaksi: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.ba_jasa a'
      'where a.no_reg_ba=:no_reg_ba')
    ReadBuffer = 1
    Variables.Data = {
      03000000010000000A0000003A4E4F5F5245475F424103000000000000000000
      0000}
    SequenceField.Field = 'NO_REG_BA'
    SequenceField.Sequence = 'PMTX02.NO_REG_JASA'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      }
    QueryAllRecords = False
    CountAllRecords = True
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    Session = DMFrm.OS
    ...
    Left = 140
    Top = 185
    object QTransaksiNO_REG_BA: TIntegerField
      FieldName = 'NO_REG_BA'
      Required = True
    end
    ...
    object QTransaksiKURS_BAYAR: TFloatField
      FieldName = 'KURS_BAYAR'
    end
  ...
  object Qbrowse2: TOracleDataSet
    SQL.Strings = (
      'select * from pmtx02.vrealisasi_po_jasa :MYPARAM')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000F0000004F524445
      52204259204E4F5F504F0000000000}
    QBEDefinition.QBEFieldDefs = {
      
      414E0100000000000A0000005355425F42414749414E010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 884
    ...
    object Qbrowse2NO_BA: TStringField
      FieldName = 'NO_BA'
      Size = 15
    end
    ...
    object Qbrowse2REKANAN2: TStringField
      FieldName = 'REKANAN2'
      Size = 255
    end
    ...
    object Qbrowse2ITEM_JASA: TStringField
      FieldName = 'ITEM_JASA'
      Size = 255
    end
    ...
    object Qbrowse2SELISIH: TFloatField
      FieldName = 'SELISIH'
    end
  ...
  object QAmbilNota2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  pmtx02.PROC_AMBIL_POJASA(:NO_NOTA, :NO_REG_BA);'
      'end;'
      ''
      '/*begin'
      '  delete pmtx02.ba_jasa_detail where no_reg_ba=:no_reg_ba;'
      ...
      '  ('
        ...
        '   no_reg_ba, no_reg_jasa, kd_item, keterangan, qty, harga, tgl_' +
        'start, tgl_selesai, id_bag, id_sub_bag, kd_jasa, jenis,'
      '   tanggal2, no_nota2, kd_aset, diskripsi'
      '  )'
      '  (select'
        ...
        ' trunc(tgl_start), trunc(terakhir_jasa), id_bag, id_sub_bag, kd_' +
        'jasa, a.jenis,'
      '   trunc(b.tanggal2), :no_nota, kd_aset, diskripsi'
      '   from pmtx02.po_jasa_detail a, pmtx02.po_jasa b'
  ...
  object QBrowse3: TOracleDataSet
    SQL.Strings = (
      'select * from (select * from pmtx02.vba_jasa_barang)'
      ':myparam'
      '')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000110000006F726465
    ...
    QBEDefinition.QBEFieldDefs = {
      
      010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    ...
    Left = 292
    Top = 393
    object QBrowse3NO_REG_BA_JB: TFloatField
      FieldName = 'NO_REG_BA_JB'
      Required = True
    end
    ...
    object QBrowse3NO_NOTA_PO_JB: TStringField
      FieldName = 'NO_NOTA_PO_JB'
      Size = 15
    end
    object QBrowse3NO_NOTA_JB: TStringField
  ...
  object QDetail3: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.ba_jasa_barang_d a'
      'where no_reg_ba_jb = :no_reg_ba_jb')
    ReadBuffer = 10
    Variables.Data = {
      03000000010000000D0000003A4E4F5F5245475F42415F4A4204000000000000
      0000000000}
    QBEDefinition.QBEFieldDefs = {
      040000000900000003000000515459010000000000060000004E4F5F52454701
      ...
      420100000000000C0000004E4F5F5245475F42415F4A420100000000000D0000
      004E4F5F4E4F54415F504F5F4A42010000000000}
    Master = QTransaksi3
    MasterFields = 'NO_REG_BA_JB'
    DetailFields = 'NO_REG_BA_JB'
    QueryAllRecords = False
    CountAllRecords = True
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    Session = DMFrm.OS
    Left = 284
    Top = 344
    object QDetail3NO_REG: TFloatField
      FieldName = 'NO_REG'
      Required = True
    end
    object QDetail3NO_REG_JB: TFloatField
      FieldName = 'NO_REG_JB'
    end
    object QDetail3NAMA_BARANG: TStringField
      FieldName = 'NAMA_BARANG'
      Size = 225
    end
    object QDetail3QTY: TFloatField
      FieldName = 'QTY'
    end
    object QDetail3SATUAN: TStringField
      FieldName = 'SATUAN'
    end
    object QDetail3NO_REG_PO_JB: TFloatField
      FieldName = 'NO_REG_PO_JB'
    end
    object QDetail3NO_NOTA_JB: TStringField
      FieldName = 'NO_NOTA_JB'
      Size = 15
    end
    object QDetail3NO_REG_BA_JB: TFloatField
      FieldName = 'NO_REG_BA_JB'
    end
    object QDetail3NO_NOTA_PO_JB: TStringField
      FieldName = 'NO_NOTA_PO_JB'
      Size = 15
    end
  end
  ...
  object dsQTransaksi3: TwwDataSource
    DataSet = QTransaksi3
    Left = 364
    Top = 313
  end
  object QTransaksi3: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.ba_jasa_barang a'
      'where no_reg_ba_jb=:no_reg_ba_jb'
      '')
    ReadBuffer = 1
    Variables.Data = {
      03000000010000000D0000003A4E4F5F5245475F42415F4A4203000000000000
      0000000000}
    SequenceField.Field = 'NO_REG_BA_JB'
    SequenceField.Sequence = 'PMTX02.NO_REG_BA_JB'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      ...
      000000000C0000004E4F5F5245475F504F5F4A420100000000000C0000004E4F
      5F5245475F42415F4A42010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    Session = DMFrm.OS
    BeforeEdit = QTransaksi3BeforeEdit
    BeforePost = QTransaksi3BeforePost
    AfterScroll = QTransaksi3AfterScroll
    OnNewRecord = QTransaksi3NewRecord
    Left = 436
    Top = 296
    object QTransaksi3TANGGAL: TDateTimeField
      FieldName = 'TANGGAL'
    end
    object QTransaksi3KD_REKANAN: TStringField
      FieldName = 'KD_REKANAN'
      Size = 5
    end
    object QTransaksi3REKANAN: TStringField
      FieldName = 'REKANAN'
      Size = 255
    end
    object QTransaksi3NO_REFF: TStringField
      FieldName = 'NO_REFF'
    end
    object QTransaksi3ISPOST: TStringField
      FieldName = 'ISPOST'
      Size = 1
    end
    object QTransaksi3NO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Size = 15
    end
    object QTransaksi3KETERANGAN: TStringField
      FieldName = 'KETERANGAN'
      Size = 255
    end
    object QTransaksi3TGL_INSERT: TDateTimeField
      FieldName = 'TGL_INSERT'
    end
    object QTransaksi3OPR_INSERT: TStringField
      FieldName = 'OPR_INSERT'
      Size = 30
    end
    object QTransaksi3TTD1: TStringField
      FieldName = 'TTD1'
      Size = 50
    end
    object QTransaksi3TTD2: TStringField
      FieldName = 'TTD2'
      Size = 50
    end
    object QTransaksi3TTD3: TStringField
      FieldName = 'TTD3'
      Size = 50
    end
    object QTransaksi3TTD4: TStringField
      FieldName = 'TTD4'
      Size = 50
    end
    object QTransaksi3NO_REG_BA_JB: TFloatField
      FieldName = 'NO_REG_BA_JB'
      Required = True
    end
  end
  object QAmbilNota3: TOracleQuery
    SQL.Strings = (
      'begin'
      '  insert into pmtx02.ba_jasa_barang_d'
      '  ('
      
        '    NO_REG_JB, NO_REG_BA_JB, NO_REG, NAMA_BARANG, QTY, SATUAN, N' +
        'O_REG_PO_JB, NO_REG_PO_JB_D, NO_NOTA_JB, NO_NOTA_PO_JB '
      '  )'
      
        '  (select NO_REG_JB, :no_reg_ba_jb, pmtx02.NO_REG_BA_JB.nextval,' +
        ' NAMA_BARANG, QTY_SISA_PO, SATUAN, NO_REG_PO_JB, NO_REG_PO_JB_D,' +
        ' NO_NOTA_JB, :NO_NOTA_PO_JB'
      
        '   from pmtx02.vpo_jasa_barang t where t.no_nota = :no_nota_po_j' +
        'b and QTY_SISA_PO>0'
      '  );'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      03000000020000000D0000003A4E4F5F5245475F42415F4A4203000000000000
      00000000000E0000003A4E4F5F4E4F54415F504F5F4A42050000000000000000
      000000}
    Left = 436
    Top = 369
  end
  object QPOJB: TOracleDataSet
    SQL.Strings = (
      'select a.kd_rekanan'
      'from pmtx02.po_jasa_barang a'
      'where a.no_nota = :no_nota')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F5441050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {04000000010000000A0000004B445F52454B414E414E010000000000}
    Session = DMFrm.OS
    Left = 84
    Top = 161
    object QPOJBKD_REKANAN: TStringField
      FieldName = 'KD_REKANAN'
      Size = 5
    end
  end
