unit RekapNotaPemakaianPerMesin;
...
type
  TRekapNotaPemakaianPerMesinFrm = class(TForm)
    Panel1: TPanel;
...
var
  RekapNotaPemakaianPerMesinFrm: TRekapNotaPemakaianPerMesinFrm;
...
procedure TRekapNotaPemakaianPerMesinFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  RekapNotaPemakaianPerMesinFrm:=Nil;
end;

procedure TRekapNotaPemakaianPerMesinFrm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TRekapNotaPemakaianPerMesinFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TRekapNotaPemakaianPerMesinFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TRekapNotaPemakaianPerMesinFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TRekapNotaPemakaianPerMesinFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TRekapNotaPemakaianPerMesinFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.LookItemEnter(Sender: TObject);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_kebutuhan',vkd_jns_kebutuhan);
end;

procedure TRekapNotaPemakaianPerMesinFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TRekapNotaPemakaianPerMesinFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TRekapNotaPemakaianPerMesinFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TRekapNotaPemakaianPerMesinFrm.ECariChange(Sender: TObject);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TRekapNotaPemakaianPerMesinFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
end;

procedure TRekapNotaPemakaianPerMesinFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi','%');
end;

procedure TRekapNotaPemakaianPerMesinFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=Caption;
end;

procedure TRekapNotaPemakaianPerMesinFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
    QRLTitle2.Caption:=UpperCase(Caption)
    else
    QRLTitle2.Caption:='DRAFT';    
end;

procedure TRekapNotaPemakaianPerMesinFrm.FormCloseQuery(Sender: TObject;
...
procedure TRekapNotaPemakaianPerMesinFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TRekapNotaPemakaianPerMesinFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TRekapNotaPemakaianPerMesinFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TRekapNotaPemakaianPerMesinFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TRekapNotaPemakaianPerMesinFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TRekapNotaPemakaianPerMesinFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TRekapNotaPemakaianPerMesinFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TRekapNotaPemakaianPerMesinFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TRekapNotaPemakaianPerMesinFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TRekapNotaPemakaianPerMesinFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TRekapNotaPemakaianPerMesinFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem.Close;
  QLookItem.Open;
...
procedure TRekapNotaPemakaianPerMesinFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
  DMFrm.QSisdur.SetVariable('kd_transaksi',Caption);
  DMFrm.QSisdur.Open;
...
procedure TRekapNotaPemakaianPerMesinFrm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  Inc(vnomer);
...
procedure TRekapNotaPemakaianPerMesinFrm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vnomer:=0;
end;
