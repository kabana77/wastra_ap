...
type
  TMasterJASAFrm = class(TForm)
    ...
    dsQLookUpKel: TwwDataSource;
    QLookUpKel: TOracleDataSet;
    QLookUpKelKD_KEL: TStringField;
    QLookUpKelKELOMPOK: TStringField;
    QLookUpKelKD_JNS_ITEM: TStringField;
    BitBtn4: TBitBtn;
    BitBtn6: TBitBtn;
    Label2: TLabel;
    ...
    QHak: TOracleDataSet;
    QHakHAK: TFloatField;
    QMaster2KD_JASA: TStringField;
    QMaster2JENIS: TStringField;
    QMaster2NAMA_JASA: TStringField;
    QMasterNO_REG_CEK_HARGA: TIntegerField;
    QMasterKD_TRANSAKSI: TStringField;
    QMasterKD_ITEM: TStringField;
    QMasterKD_REKANAN: TStringField;
    QMasterCONTACT: TStringField;
    QMasterTANGGAL_CEK: TDateTimeField;
    QMasterHARGA: TFloatField;
    ...
    procedure LookJenisJasaEnter(Sender: TObject);
    ...
    procedure LookJenisJasaCloseUp(Sender: TObject; LookupTable,
      FillTable: TDataSet; modified: Boolean);
...
var
  MasterJASAFrm: TMasterJASAFrm;

implementation

uses DM, MainBrowse, Main, Menus, CekHargaSuplier;

{$R *.dfm}

procedure TMasterJASAFrm.FormClose(Sender: TObject;
...
procedure TMasterJASAFrm.BtnSimpanClick(Sender: TObject);
begin
...
procedure TMasterJASAFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  BtnSimpan.Enabled:=True;
end;

procedure TMasterJASAFrm.BtnEditingClick(Sender: TObject);
begin
...
procedure TMasterJASAFrm.BtnBrowseClick(Sender: TObject);
begin
...
procedure TMasterJASAFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TMasterJASAFrm.FormCreate(Sender: TObject);
begin
//  DMFrm.QSatuan.Close;
...
procedure TMasterJASAFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TMasterJASAFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TMasterJASAFrm.BitBtn5Click(Sender: TObject);
var
  vtitle : String;
begin
  case PageControl1.ActivePageIndex of
...
procedure TMasterJASAFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.SetVariable('kd_item',CekHargaSuplierFrm.QTransaksiKD_ITEM.AsString);
  QMaster.Open;
end;

procedure TMasterJASAFrm.BtnEditing2Click(Sender: TObject);
begin
...
procedure TMasterJASAFrm.BtnBrowse2Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TMasterJASAFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TMasterJASAFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TMasterJASAFrm.TabSheet2Show(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TMasterJASAFrm.FormShow(Sender: TObject);
begin
//  Height:=600;
//  Width:=716;
  TabSheet2.TabVisible:=False;
...
procedure TMasterJASAFrm.LookMesinEnter(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TMasterJASAFrm.LookJenisJasaEnter(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TMasterJASAFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TMasterJASAFrm.QMasterNewRecord(DataSet: TDataSet);
begin
QMasterKD_ITEM.AsString:=' ';
//  QMasterKD_KEL.AsString:='01';
//   QMasterICC.AsString:='0';
//  QMasterQty.AsString:='0';
end;

procedure TMasterJASAFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
  QMaster2JENIS.AsString:='JASA';
end;

procedure TMasterJASAFrm.FormCloseQuery(Sender: TObject;
...
procedure TMasterJASAFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TMasterJASAFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TMasterJASAFrm.LookSatuanEnter(Sender: TObject);
begin
  DMFrm.QSatuan.Open;
end;

procedure TMasterJASAFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TMasterJASAFrm.ECariChange(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TMasterJASAFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TMasterJASAFrm.QMasterBeforePost(DataSet: TDataSet);
begin
// QMasterOPR_EDIT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TMasterJASAFrm.BitBtn6Click(Sender: TObject);
begin
{azmi}
...
procedure TMasterJASAFrm.BitBtn4Click(Sender: TObject);
begin
{azmi}
if QLookUpKelKD_KEL.AsString='' then
begin
...
procedure TMasterJASAFrm.wwDBLookupCombo1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{azmi}
...
procedure TMasterJASAFrm.wwDBLookupCombo1Enter(Sender: TObject);
begin
{azmi}
QLookUpKel.Open;
{azmi}
...
procedure TMasterJASAFrm.BitBtn2Click(Sender: TObject);
{azmi}
var
  vuser, vpwd : string;
begin
...
procedure TMasterJASAFrm.LookJenisJasaCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  {QMasterKD_JASA.AsString:=QMaster2KD_JASA.AsString;
  QMasterJENIS.AsString:=QMaster2JENIS.AsString;
  QMasterKD_SATUAN.AsString:='99';}
end;

procedure TMasterJASAFrm.LookSatuanCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  //QMasterSATUAN.AsString:=DMFrm.QSatuanSAT1.AsString;
end;
