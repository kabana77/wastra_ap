...
var
  ValidasiKMNBBFrm: TValidasiKMNBBFrm;
...
procedure TValidasiKMNBBFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  ValidasiKMNBBFrm:=Nil;
end;

procedure TValidasiKMNBBFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TValidasiKMNBBFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TValidasiKMNBBFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TValidasiKMNBBFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TValidasiKMNBBFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TValidasiKMNBBFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TValidasiKMNBBFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
...
procedure TValidasiKMNBBFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TValidasiKMNBBFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TValidasiKMNBBFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailOPR_INSERT.AsString:=DMFrm.QUserNAMA_USER.AsString;
end;

procedure TValidasiKMNBBFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TValidasiKMNBBFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiKMNBBFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TValidasiKMNBBFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TValidasiKMNBBFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TValidasiKMNBBFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TValidasiKMNBBFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TValidasiKMNBBFrm.ECariChange(Sender: TObject);
begin
...
procedure TValidasiKMNBBFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TValidasiKMNBBFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TValidasiKMNBBFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TValidasiKMNBBFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TValidasiKMNBBFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TValidasiKMNBBFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TValidasiKMNBBFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TValidasiKMNBBFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TValidasiKMNBBFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TValidasiKMNBBFrm.FormCloseQuery(Sender: TObject;
...
procedure TValidasiKMNBBFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiKMNBBFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TValidasiKMNBBFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TValidasiKMNBBFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TValidasiKMNBBFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TValidasiKMNBBFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TValidasiKMNBBFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TValidasiKMNBBFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TValidasiKMNBBFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TValidasiKMNBBFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TValidasiKMNBBFrm.BtnExportClick(Sender: TObject);
begin
{azmi}
...
procedure TValidasiKMNBBFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TValidasiKMNBBFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TValidasiKMNBBFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TValidasiKMNBBFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TValidasiKMNBBFrm.QLookLokasiBeforeOpen(DataSet: TDataSet);
begin
  QLookLokasi.SetVariable('kd_jns_item',QDetailKD_JNS_ITEM.AsString);
end;

procedure TValidasiKMNBBFrm.LookLokasiCloseUp(Sender: TObject;
...
procedure TValidasiKMNBBFrm.LookLokasiEnter(Sender: TObject);
begin
  QLookLokasi.Close;
  QLookLokasi.Open;
end;

procedure TValidasiKMNBBFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TValidasiKMNBBFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TValidasiKMNBBFrm.LookSuplierCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
var
  vkota : string;
begin
...
procedure TValidasiKMNBBFrm.LookSuplierEnter(Sender: TObject);
begin
  DMFrm.QSuplier.Open;
end;

procedure TValidasiKMNBBFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailSUB_TOTAL.AsFloat:=QDetailHARGA.AsFloat*QDetailQTY.AsFloat;
end;

procedure TValidasiKMNBBFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QSubTotal.Close;
