...
var
  KartuStokNBB4Frm: TKartuStokNBB4Frm;
...
procedure TKartuStokNBB4Frm.FormCreate(Sender: TObject);
begin
  DMFrm.QLookSubBagian.Close;
  QLookItem.Close;
end;

procedure TKartuStokNBB4Frm.wwDBGrid1kuTitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKartuStokNBB4Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TKartuStokNBB4Frm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TKartuStokNBB4Frm.TabSheet2Show(Sender: TObject);
begin
...
procedure TKartuStokNBB4Frm.QLookItemBeforeOpen(DataSet: TDataSet);
begin
  QLookItem.SetVariable('kd_jns_item',vkd_jns_item);
end;

procedure TKartuStokNBB4Frm.wwDBGrid1kuDblClick(Sender: TObject);
var
...
procedure TKartuStokNBB4Frm.ECariChange(Sender: TObject);
begin
...
procedure TKartuStokNBB4Frm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TKartuStokNBB4Frm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TKartuStokNBB4Frm.FormShow(Sender: TObject);
begin
...
procedure TKartuStokNBB4Frm.QBrowseBeforeOpen(DataSet: TDataSet);
var
  vdd,vmm,vyy : word;
  vtgl_awal : TDate;
begin
...
procedure TKartuStokNBB4Frm.BitBtn5Click(Sender: TObject);
begin
...
procedure TKartuStokNBB4Frm.QLookSubBagianBeforeOpen(DataSet: TDataSet);
begin
  QLookSubBagian.SetVariable('kd_bag',vkd_bag);
end;

procedure TKartuStokNBB4Frm.TabSheet1Show(Sender: TObject);
begin
...
procedure TKartuStokNBB4Frm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TKartuStokNBB4Frm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TKartuStokNBB4Frm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TKartuStokNBB4Frm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TKartuStokNBB4Frm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TKartuStokNBB4Frm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TKartuStokNBB4Frm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TKartuStokNBB4Frm.BtnExportClick(Sender: TObject);
begin
{//qbrowse.Active:=true;
   if QBrowse.Active then
  begin
...
procedure TKartuStokNBB4Frm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TKartuStokNBB4Frm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TKartuStokNBB4Frm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TKartuStokNBB4Frm.BitBtn2Click(Sender: TObject);
begin
{  QBrowse.DisableControls;
  QBrowse.Close;
  QBrowse.Open;
...
procedure TKartuStokNBB4Frm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TKartuStokNBB4Frm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle2.Caption:='RIWAYAT TRANSAKSI';
end;

procedure TKartuStokNBB4Frm.BitBtn3Click(Sender: TObject);
begin
 QBrowse.DisableControls;
  QBrowse.Close;
  QBrowse.Open;
...
procedure TKartuStokNBB4Frm.BtnCloseClick(Sender: TObject);
begin
KartuStokNBB4Frm.Close;
end;

procedure TKartuStokNBB4Frm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseTOTAL.AsFloat:=
    QBrowseSTOK_BLIGO.AsFloat+
    QBrowseSTOK_SBY.AsFloat;//+
//    QBrowseSTOK_MITRA.AsFloat;
end;

procedure TKartuStokNBB4Frm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
Action:=caFree;
 KartuStokNBB4Frm:=nil;
end;
