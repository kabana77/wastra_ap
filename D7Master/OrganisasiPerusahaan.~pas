...
uses
  ...
  ComCtrls, ExtCtrls, wwrcdvw;

type
  TOrganisasiPerusahaanFrm = class(TForm)
    Panel1: TPanel;
    ...
    QMaster3ID_JAB: TStringField;
    QMaster3JABATAN: TStringField;
    QMaster3UMAKAN: TFloatField;
    QMaster3UTRANSPORT: TFloatField;
    DBText2: TDBText;
    wwDBNavigator2: TwwDBNavigator;
    wwNavButton1: TwwNavButton;
    wwNavButton2: TwwNavButton;
    Label10: TLabel;
    QMaster4KD_JNS_KAR: TStringField;
    QMaster4JNS_KARYAWAN: TStringField;
    QMaster5GRUP_SHIFT: TStringField;
    QMaster6KD_ABSEN: TStringField;
    QMaster6KETERANGAN: TStringField;
    QMaster6KELOMPOK: TStringField;
    QMaster6POT_GAPOK: TFloatField;
    QMaster6PREMI_GUGUR: TStringField;
    QMaster7KD_PEND: TStringField;
    QMaster7PENDIDIKAN: TStringField;
    cbAll: TCheckBox;
    cbPreview: TCheckBox;
    cbGaris: TCheckBox;
    ...
    QMaster2SUB_BAGIAN: TStringField;
    QMaster2XID_BAG: TStringField;
    QMaster2XBAGIAN: TStringField;
    QMaster2XID_SUB_BAG: TStringField;
    QMaster2XSUB_BAGIAN: TStringField;
    QMaster3X: TOracleDataSet;
    QMasterID_BAG: TStringField;
    QMaster2ID_BAG: TStringField;
    QMaster2ID_SUB_BAG: TStringField;
...
var
  OrganisasiPerusahaanFrm: TOrganisasiPerusahaanFrm;
...
Procedure TOrganisasiPerusahaanFrm.Proc_Isi_Tabel(pMaster : TOracleDataset; pfilename : String);
var
i, vncol : Integer;
begin
  pMaster.Open;
...
procedure TOrganisasiPerusahaanFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  OrganisasiPerusahaanFrm:=Nil;
end;

procedure TOrganisasiPerusahaanFrm.BtnSimpanClick(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  BtnSimpan.Enabled:=True;
end;

procedure TOrganisasiPerusahaanFrm.BtnEditingClick(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.BtnBrowseClick(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TOrganisasiPerusahaanFrm.FormCreate(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TOrganisasiPerusahaanFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TOrganisasiPerusahaanFrm.BitBtn5Click(Sender: TObject);
var
  vtitle : String;
begin
  ...
  begin
      ...
      MyFile.Parent:=OrganisasiPerusahaanFrm;
      MyFile.Width:=500;
      MyFile.Visible:=False;
      vtitle:='Organisasi Perusahaan';
      MyFile.Clear;
      ...
      MyFile.Items.Add('<h1>ORGANISASI PERUSAHAAN</h1>');
      MyFile.Items.Add('<br>');
      Proc_Isi_Tabel(QMaster, '1. DAFTAR BAGIAN');
      QMaster2X.Close;
      Proc_Isi_Tabel(QMaster2X,'2. DAFTAR SUB BAGIAN');
      QMaster3X.Close;
      Proc_Isi_Tabel(QMaster3X,'3. DAFTAR JABATAN');
      Proc_Isi_Tabel(QMaster4,'4. DAFTAR JENIS KARYAWAN');
      Proc_Isi_Tabel(QMaster5,'5. DAFTAR GRUP SHIFT');
      Proc_Isi_Tabel(QMaster6,'6. DAFTAR ABSEN');
      Proc_Isi_Tabel(QMaster7,'7. DAFTAR PENDIDIKAN');
      Proc_Isi_Tabel(QMaster8,'8. DAFTAR KURSUS');
  ...
  1 : begin
        vtitle:='Sub Bagian di '+QMasterBAGIAN.AsString;
        DMFrm.SaveDialog1.FileName:=vtitle;
        if DMFrm.SaveDialog1.Execute then
        begin
  ...
  2 : begin
        vtitle:='Jabatan di '+QMasterBAGIAN.AsString;
        DMFrm.SaveDialog1.FileName:=vtitle;
        if DMFrm.SaveDialog1.Execute then
        begin
...
procedure TOrganisasiPerusahaanFrm.BtnEditing2Click(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.BtnBrowse2Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TOrganisasiPerusahaanFrm.BitBtn2Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TOrganisasiPerusahaanFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TOrganisasiPerusahaanFrm.TabSheet2Show(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TOrganisasiPerusahaanFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TOrganisasiPerusahaanFrm.BtnEditing3Click(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.BtnBrowse3Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TOrganisasiPerusahaanFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TOrganisasiPerusahaanFrm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TOrganisasiPerusahaanFrm.TabSheet3Show(Sender: TObject);
begin
  QMaster3.Open;
end;

procedure TOrganisasiPerusahaanFrm.BtnEditing4Click(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.BtnBrowse4Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TOrganisasiPerusahaanFrm.BitBtn4Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TOrganisasiPerusahaanFrm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TOrganisasiPerusahaanFrm.BtnEditing5Click(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.BtnBrowse5Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TOrganisasiPerusahaanFrm.BitBtn6Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TOrganisasiPerusahaanFrm.wwDBGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TOrganisasiPerusahaanFrm.BtnEditing6Click(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.BtnBrowse6Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TOrganisasiPerusahaanFrm.BitBtn7Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TOrganisasiPerusahaanFrm.wwDBGrid6TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TOrganisasiPerusahaanFrm.BtnEditing7Click(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.BtnBrowse7Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TOrganisasiPerusahaanFrm.BitBtn8Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TOrganisasiPerusahaanFrm.wwDBGrid7TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TOrganisasiPerusahaanFrm.BtnEditing8Click(Sender: TObject);
begin
...
procedure TOrganisasiPerusahaanFrm.BtnBrowse8Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TOrganisasiPerusahaanFrm.BitBtn9Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TOrganisasiPerusahaanFrm.wwDBGrid8TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TOrganisasiPerusahaanFrm.TabSheet4Show(Sender: TObject);
begin
  QMaster4.Open;
end;

procedure TOrganisasiPerusahaanFrm.TabSheet5Show(Sender: TObject);
begin
  QMaster5.Open;
end;

procedure TOrganisasiPerusahaanFrm.TabSheet6Show(Sender: TObject);
begin
  QMaster6.Open;
end;

procedure TOrganisasiPerusahaanFrm.TabSheet7Show(Sender: TObject);
begin
  QMaster7.Open;
end;

procedure TOrganisasiPerusahaanFrm.TabSheet8Show(Sender: TObject);
begin
  QMaster8.Open;
end;

procedure TOrganisasiPerusahaanFrm.FormShow(Sender: TObject);
begin
  Width:=415;
  Height:=614;
end;

procedure TOrganisasiPerusahaanFrm.FormCloseQuery(Sender: TObject;
...
procedure TOrganisasiPerusahaanFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TOrganisasiPerusahaanFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TOrganisasiPerusahaanFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
