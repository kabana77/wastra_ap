object BonPermintaanCelupFrm: TBonPermintaanCelupFrm
  Left = 359
  Top = 138
  Width = 825
  Height = 611
  Caption = 'Bon Pemakaian Celup'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = '&Daftar Permintaan Proses WO Celup'
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          'NO_NOTA'#9'15'#9'KODE ITEM~DOUBLING'#9'F'
          'TANGGAL'#9'11'#9'TANGGAL'#9'F'
          'SUB_BAGIAN'#9'13'#9'SUB BAGIAN'#9'F'
          'KD_ITEM'#9'10'#9'KODE'#9'F'#9'BAHAN'
          'NAMA_ITEM'#9'32'#9'NAMA  BARANG'#9'F'#9'BAHAN'
          'KD_ITEM2'#9'7'#9'KODE'#9'F'#9'HASIL DOUBELING'
          'NAMA_ITEM2'#9'30'#9'NAMA BENANG'#9'F'#9'HASIL DOUBELING'
          'QTY'#9'7'#9'KG'#9'F'#9'BON'
          'QTY2'#9'10'#9'BALE'#9'F'#9'BON'
          'QTY_VALIDASI'#9'7'#9'KG'#9'F'#9'VALIDASI'
          'QTY_VALIDASI2'#9'9'#9'BALE'#9'F'#9'VALIDASI'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'KD_ITEM2;CustomEdit;LookItem2;F')
        PictureMasks.Strings = (
          'ID_BAG'#9'*2{#,&}'#9'T'#9'T'
          'KD_JNS_ITEM'#9'#,&'#9'T'#9'T'
          'KD_SATUAN'#9'#,&'#9'T'#9'T'
        ...
        Selected.Strings = (
          ...
          'KD_ITEM2'#9'10'#9'KODE'#9'F'#9'BENANG HASIL CELUP'
          'NAMA_ITEM2'#9'23'#9'NAMA'#9'T'#9'BENANG HASIL CELUP'
          'KD_WARNA'#9'10'#9'KODE'#9'F'#9'WARNA'
          'WARNA'#9'30'#9'WARNA'#9'F'#9'WARNA'
          'QTY'#9'8'#9'KG'#9'F'#9'JUMLAH DIMINTA'
          'QTY2'#9'8'#9'BALE'#9'F'#9'JUMLAH DIMINTA'
          'QTY_STOK'#9'10'#9'KG'#9'T'#9'STOK SAAT INI'
          'QTY_STOK2'#9'10'#9'BALE'#9'T'#9'STOK SAAT INI'
          'QTY_BON'#9'10'#9'KG'#9'T'#9'PERMINTAAN BULAN INI'
          'QTY_BON2'#9'10'#9'BALE'#9'T'#9'PERMINTAAN BULAN INI')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
      ...
      object LookItem2: TwwDBLookupComboDlg
        ...
        MaxHeight = 209
        Selected.Strings = (
          'NAMA_ITEM'#9'40'#9'NAMA_ITEM'#9#9
  ...
  object QTransaksi: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.bon_barang2X a'
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from pmtx02.bon_barang_detail2X a'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      54454D32010000000000080000004E4D5F484153494C010000000000}
    Master = QTransaksi
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select * from pmtx02.vbon_bb_benang2X where kd_tr' +
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      5245475F424F4E0100000000000C0000005154595F56414C4944415349010000
      0000000B0000004B445F4A4E535F4954454D010000000000050000004D455349
      4E010000000000080000004B445F4954454D320100000000000A0000004E414D
      415F4954454D32010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    ...
    object QBrowseQTY_VALIDASI2: TFloatField
      FieldKind = fkCalculated
      FieldName = 'QTY_VALIDASI2'
      DisplayFormat = '#,##0.###;(#,##0.###); '
      Calculated = True
    end
    object QBrowseKD_ITEM2: TStringField
      Alignment = taCenter
      FieldName = 'KD_ITEM2'
      Size = 16
    end
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from pmtx02.vbon_bb_benang2X'
  ...
  object QLookItem2: TOracleDataSet
    ...
    object QLookItem2KD_WARNA: TStringField
      DisplayWidth = 5
      FieldName = 'KD_WARNA'
      Size = 5
    end
    object QLookItem2WARNA: TStringField
      DisplayWidth = 50
      FieldName = 'WARNA'
      Size = 50
    end
