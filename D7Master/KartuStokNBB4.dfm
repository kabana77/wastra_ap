object KartuStokNBB4Frm: TKartuStokNBB4Frm
  Left = 299
  Top = 72
  Width = 907
  Height = 618
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1ku: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'STOK_BLIGO'#9'10'#9'Pekalongan~(Bligo)'#9'F'#9'STOK'
          'STOK_SBY'#9'10'#9'Surabaya'#9'F'#9'STOK'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      ...
      '(nvl(t.berjalan4,0)) as stok_mitra'
        ...
        '      where a.kd_jns_item='#39'8'#39' and a.kd_item=b.kd_item and ((a.kd' +
        ...
        'rjalan from pmtx02.stok_gd v where v.kd_lokasi='#39'06'#39' and v.kd_sub' +
        ...
        'left outer join (select v.kd_item, sum(v.qty_in-v.qty_out) as be' +
        'rjalan2 from pmtx02.stok_gd v where v.kd_lokasi='#39'06'#39' and v.kd_su' +
        ...
        'left outer join (select v.kd_item, sum(v.qty_in-v.qty_out) as be' +
        'rjalan4 from pmtx02.stok_gd v where v.kd_lokasi='#39'06'#39' and v.kd_su' +
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      000000000A00000053544F4B5F424C49474F0100000000000600000053415455
      414E0100000000000A00000053544F4B5F4D4954524101000000000008000000
      53544F4B5F534259010000000000}
    ...
    object QBrowseSTOK_SBY: TFloatField
      FieldName = 'STOK_SBY'
      DisplayFormat = '#.#,#;(#.#,#)'
    end
