...
type
  TValidasiReturBBMFrm = class(TForm)
    Panel1: TPanel;
...
var
  ValidasiReturBBMFrm: TValidasiReturBBMFrm;
...
procedure TValidasiReturBBMFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  ValidasiReturBBMFrm:=Nil;
end;

procedure TValidasiReturBBMFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TValidasiReturBBMFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TValidasiReturBBMFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TValidasiReturBBMFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TValidasiReturBBMFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
  wwDBGrid2.SetFocus;
  TabSheet1.TabVisible:=QTransaksiISPOST.AsString='1';
end;

procedure TValidasiReturBBMFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TValidasiReturBBMFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
...
procedure TValidasiReturBBMFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TValidasiReturBBMFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TValidasiReturBBMFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TValidasiReturBBMFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TValidasiReturBBMFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiReturBBMFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TValidasiReturBBMFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TValidasiReturBBMFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TValidasiReturBBMFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TValidasiReturBBMFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TValidasiReturBBMFrm.ECariChange(Sender: TObject);
begin
...
procedure TValidasiReturBBMFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TValidasiReturBBMFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TValidasiReturBBMFrm.FormShow(Sender: TObject);
begin
  VTglAwal.Date:=Trunc(DMFrm.QDateTimeVNOW.AsDateTime);
  QJnsTransaksi.Open;
end;

procedure TValidasiReturBBMFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TValidasiReturBBMFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=UpperCase(QJnsTransaksiNAMA_TRANSAKSI.AsString);
end;

procedure TValidasiReturBBMFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TValidasiReturBBMFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TValidasiReturBBMFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TValidasiReturBBMFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TValidasiReturBBMFrm.FormCloseQuery(Sender: TObject;
...
procedure TValidasiReturBBMFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TValidasiReturBBMFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
  if QTransaksi.IsEmpty then
    TabSheet1.TabVisible:=True;
end;

procedure TValidasiReturBBMFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
...
procedure TValidasiReturBBMFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TValidasiReturBBMFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TValidasiReturBBMFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TValidasiReturBBMFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TValidasiReturBBMFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TValidasiReturBBMFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TValidasiReturBBMFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TValidasiReturBBMFrm.BtnExportClick(Sender: TObject);
begin
{azmi}
...
procedure TValidasiReturBBMFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TValidasiReturBBMFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TValidasiReturBBMFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TValidasiReturBBMFrm.Label3Click(Sender: TObject);
begin
  DMFrm.QSisdur.Close;
...
procedure TValidasiReturBBMFrm.QLookLokasiBeforeOpen(DataSet: TDataSet);
begin
  QLookLokasi.SetVariable('kd_jns_item',QDetailKD_JNS_ITEM.AsString);
end;

procedure TValidasiReturBBMFrm.LookLokasiCloseUp(Sender: TObject;
...
procedure TValidasiReturBBMFrm.LookLokasiEnter(Sender: TObject);
begin
  QLookLokasi.Close;
  QLookLokasi.Open;
end;

procedure TValidasiReturBBMFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TValidasiReturBBMFrm.LookKoreksiEnter(Sender: TObject);
begin
  QJnsKoreksi.Open;
end;

procedure TValidasiReturBBMFrm.LookSuplierCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
var
  vkota : string;
begin
...
procedure TValidasiReturBBMFrm.LookSuplierEnter(Sender: TObject);
begin
  DMFrm.QSuplier.Open;
end;

procedure TValidasiReturBBMFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailSUB_TOTAL.AsFloat:=QDetailHARGA.AsFloat*QDetailQTY.AsFloat;
end;

procedure TValidasiReturBBMFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QSubTotal.Close;
