...
procedure TKomputerFrm.FormClose(Sender: TObject;
...
procedure TKomputerFrm.BtnSimpanClick(Sender: TObject);
begin
...
procedure TKomputerFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  BtnSimpan.Enabled:=True;
end;

procedure TKomputerFrm.BtnEditingClick(Sender: TObject);
begin
...
procedure TKomputerFrm.BtnBrowseClick(Sender: TObject);
begin
...
procedure TKomputerFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TKomputerFrm.FormCreate(Sender: TObject);
begin
  wwDBGrid1.IniAttributes.SectionName:=Name+' '+wwDBGrid1.Name;
  wwDBGrid2.IniAttributes.SectionName:=Name+' '+wwDBGrid2.Name;
end;

procedure TKomputerFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKomputerFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TKomputerFrm.BitBtn5Click(Sender: TObject);
var
  vtitle : String;
begin
  case PageControl1.ActivePageIndex of
  0 : begin
        vtitle:='Daftar ATK, Komputer dan Asesoris';
  ...
  1 : begin
        vtitle:='Jenis ATK, Komputer dan Asesoris';
        DMFrm.SaveDialog1.FileName:=vtitle;
        if DMFrm.SaveDialog1.Execute then
        begin
...
procedure TKomputerFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TKomputerFrm.BtnEditing2Click(Sender: TObject);
begin
...
procedure TKomputerFrm.BtnBrowse2Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
...
procedure TKomputerFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TKomputerFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TKomputerFrm.TabSheet2Show(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TKomputerFrm.FormShow(Sender: TObject);
begin
  Height:=600;
  Width:=767;
end;

procedure TKomputerFrm.LookMesinEnter(Sender: TObject);
begin
  QMaster.Open;
end;

procedure TKomputerFrm.LookJenisEnter(Sender: TObject);
begin
  QMaster2.Open;
end;

procedure TKomputerFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TKomputerFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QMasterKELOMPOK.AsString:='ATK';
end;

procedure TKomputerFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
  QMaster2KELOMPOK.AsString:='ATK';
end;

procedure TKomputerFrm.FormCloseQuery(Sender: TObject;
...
procedure TKomputerFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TKomputerFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TKomputerFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TKomputerFrm.ECariChange(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TKomputerFrm.LTitleClick(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
